...
| deepseek-harness-ux | [ayuanwong/deepseek-harness-ux](https://github.com/ayuanwong/deepseek-harness-ux) | 面向长任务的 DeepSeek Harness Web UX 社区源码版：保留上游 agent/runtime 与插件架构，强化任务进度、运行详情、会话恢复、长文阅读、工作区与交付物体验；当前从源码运行，非独立 npm 插件 | 待测 |

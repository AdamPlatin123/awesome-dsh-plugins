...
| dsh-vision-proxy | [Flyvhidbwo/dsh-vision-proxy](https://github.com/Flyvhidbwo/dsh-vision-proxy) | DeepSeek 大脑 + 自动识图：GUI 附加的每张图片自动经 OpenAI 兼容 VLM（默认 qwen3.7-flash）转译成文字，再交给纯文本的 DeepSeek 作答 | ✅ |
...
| dsh-rss | [STARDUSTLC666/dsh-rss](https://github.com/STARDUSTLC666/dsh-rss) | RSS/Atom è®¢éå·¥å·æä»¶ï¼è®¢éç®¡ç + æåè§£æï¼rss_list/add/remove/fetch/checkï¼ï¼RSS 0.9x/1.0/2.0 ä¸ Atom å½ä¸åï¼è®¢éåè¡¨æä¹åå° settingsï¼proxyUrl ç¹æ®ä»£çï¼çº¯ Node å¨å¹³å° | å¾æµ || logicprobe | [AmethystLuna/logicprobe](https://github.com/AmethystLuna/logicprobe) | è®¾è®¡ææ¡£ä¸éæè®¡åå£°ææ ¸æ¥ï¼claim æä¸¾ + ä»£ç åºäºå®æ ¸å¯¹ + é»è¾åè¯­éªè¯ï¼7 ç»æ + 7 å¯¹ææ¢éï¼ï¼dsh åç bundle æ³¨å¥æ ¸æ¥çºªå¾é¨ | â || embedded-workbench | [AmethystLuna/embedded-workbench](https://github.com/AmethystLuna/embedded-workbench) | åµå¥å¼ C/C++ åºä»¶å·¥ç¨æä»¶ï¼8 skillsï¼FreeRTOS/Keil/ARMCLANG/HardFault/ç¶ææº/LVGL/æ¶æï¼ï¼dsh åç bundle æ³¨å¥ä¼è¯å¯å¨çºªå¾é¨ï¼1% Rule / Red Flags / Plan Verification Gateï¼ | â |
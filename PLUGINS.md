...
| dsh-email | [STARDUSTLC666/dsh-email](https://github.com/STARDUSTLC666/dsh-email) | 邮件工具插件：IMAP/SMTP 收/发/搜（email_list/read/search/send），内置 QQ/163/126/新浪/阿里/Gmail/Outlook/iCloud 预设，发信默认走审批门；纯 Node 全平台 | 待测 |

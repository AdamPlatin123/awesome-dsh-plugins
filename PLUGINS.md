...
| dsh-vision-router | [ysr666/dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 为纯文本 Agent 提供视觉能力：内置免 Key 视觉链 + 像素级视觉工具（看图问答、定位、裁剪、像素对比、取色、OCR、矢量化、抠图、截图）；粘贴图片即可用，无 Python，一条命令安装；dsh-plugin-verify 实测 7/7 waterfall + tools/result（isError:false，捕获 16 事件） | ✅ || dsh-pixel-ui | [zhang66633/dsh-pixel-ui](https://github.com/zhang66633/dsh-pixel-ui) | åç´ é£ç®è¤ï¼Agent Xi é£æ ¼ï¼ï¼æ¨å±/ç¾ç®çº¸/æé³/ç»ç«¯ç»¿åä¸»é¢ä¸é®åæ¢ï¼fusion-pixel + Press Start 2P åç´ å­ä½ãCRT æ«æçº¿ãåç´ åæ ï¼è®¾ç½®è¡éæ¶ååç°ä»£é»è®¤ UI | â || dsh-plugin-installer | [zhang66633/dsh-plugin-installer](https://github.com/zhang66633/dsh-plugin-installer) | DSH æä»¶ååº + å®è£å©æï¼Web GUI ä¼è¯ç¯ãæä»¶ååºãé¡µç­¾æµè§/æç´¢æä»¶ç®å½ï¼319 æ¬¾ï¼ï¼ä¸é®ç¡®è®¤åäº¤ç» agent å®æå®è£ï¼åç½®å®è£æè½è¦ç npm ç´è£ / GitHub clone æ³¨åä¸ 18 ä¸ªå·²ç¥åéæ¹ | â || dsh-malong-bridge | [wulun811/LiuHe](https://github.com/wulun811/LiuHe) | å­åå·¥å·é DSH bundleï¼44 ä¸ª MCP ä»£ç æä½å·¥å· + å¨æ workspace æ³¨å¥ï¼npm å®è£ @jieai/dsh-malong-bridge | å¾æµ || dsh-oai-oauth | [werifu/dsh-oai-oauth](https://github.com/werifu/dsh-oai-oauth) | LLM ééå¨æä»¶ï¼éè¿ OpenAI ChatGPT è®¢éï¼OAuthï¼ä½¿ç¨æ¨¡åï¼GPT-5.6-Sol / GPT-5.5 ç­ï¼ï¼æ é API Keyï¼å¤ç¨æ¬æº Codex CLI ç»å½ | â || dsh-lark-link | [amlyczz/dsh-lark-link](https://github.com/amlyczz/dsh-lark-link) | High-reliability Feishu/Lark bridge â QR one-click auth, CardKit streaming, zero-loss persistent outbox (at-least-once), per-conversation DSH sessions, self-healing connection, media in/out, reusable DSH Web GUI | å¾æµ || dsh-whale-animation | [LeemanCheung/dsh-whale-animation](https://github.com/LeemanCheung/dsh-whale-animation) | DSH Web ååç¶ææçé­ç¯é²¸é±¼æ½è¡å¨ç»ï¼èµæºååµãè¿è¡æ¶ç¦»çº¿ï¼å¹¶ä¸º `prefers-reduced-motion` ç¨æ·æä¾éæ PNG åé | å¾æµ || dsh-token-usage | [LeemanCheung/dsh-token-usage](https://github.com/LeemanCheung/dsh-token-usage) | æä¹å Token ç¨éè®°å½ä¸è®¾ç½®é¡µä»ªè¡¨çï¼ææ¨¡åãä¼è¯åæ¥æèåï¼å±ç¤º 52 å¨ç­åå¾ãç¼å­å½ä¸­çåå®æ´è¾å¥è¾åº bucketï¼ä¸ä¿å­æç¤ºè¯æåå¤æ­£æ | å¾æµ || dsh-task-dag | [LeemanCheung/dsh-task-dag](https://github.com/LeemanCheung/dsh-task-dag) | DSH Web æä¹å®æ¶ä»»å¡ DAGï¼ç»ä¸å±ç¤ºä¼è¯ãå­ä»£çä¸ workflow é¶æ®µï¼æ¯æç¶æèå¨åèç¹å¯¼èªï¼ä¸ç»´æ¤å¹¶è¡æ°æ®åºæè½®è¯¢ Host | å¾æµ |
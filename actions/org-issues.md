...
## 事件：dsh 最后内测版发布公告（2026-08-12）

官方公告要点：
- 今晚推送 dsh **最后一个内测版本**
- 插件作者修改兼容后仓库带 **#dsh topic**
- **0813 计划发布公测版**
- 插件可移到自己的账号下，先保持 private

对本监控的影响：
- 今晚 02:00 cron 全量将抓取最后内测版快照 → 产出"最后内测版兼容性快照"
- 公测后 mainline 是否继续在 dsh2026 私有仓库更新？需跟踪（可能迁移仓库）
- 插件迁移到个人账号后，dsh-external org 仓库数可能下降——动态发现会自然跟随

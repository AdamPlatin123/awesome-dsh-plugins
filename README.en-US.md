...
[![confirmed](https://img.shields.io/badge/confirmed-941-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-13334-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_9069-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1722-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2656-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **941 plugin repos indexed** (manifest-level classification, v2 engine), **13334 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260905T200001Z` (2026-09-06 04:00:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 18450 · age 146m"]
    ...
    B1 -->|"plugins 941"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 13334"}
    D1 -->|"9069 / 2656"| E1["aggregate + README stats"]
...
- **🔌 Web UI 增强**（2779）— OK 1360 · incompatible 396 · pending 250 · untested 17 · watching 756 — [details](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2153）— OK 940 · incompatible 352 · pending 180 · untested 19 · watching 662 — [details](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2244）— OK 826 · incompatible 265 · pending 160 · untested 11 · watching 982 — [details](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（719）— OK 259 · incompatible 115 · pending 55 · untested 4 · watching 286 — [details](catalog/all/消息通讯.md)
- **🗂 文件数据**（677）— OK 273 · incompatible 94 · pending 55 · untested 9 · watching 246 — [details](catalog/all/文件数据.md)
- **🎮 娱乐生活**（451）— OK 175 · incompatible 33 · pending 30 · untested 0 · watching 213 — [details](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1356）— OK 443 · incompatible 131 · pending 124 · untested 4 · watching 654 — [details](catalog/all/基建部署.md)
- **📚 学习研究**（156）— OK 37 · incompatible 8 · pending 8 · untested 2 · watching 101 — [details](catalog/all/学习研究.md)
- **❓ 其他**（7192）— OK 1852 · incompatible 358 · pending 248 · untested 21 · watching 4713 — [details](catalog/all/其他.md)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260905T200001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260905T200001Z（2026-09-06 04:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 9069 可用 · 2656 不兼容 · 1609 待定（共 13334 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-8396-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-11778-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_7872-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1357-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2655-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8396 plugin repos indexed** (manifest-level classification, v2 engine), **11778 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260831T013001Z` (2026-08-31 09:30:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 16796 · age 27m"]
    ...
    B1 -->|"plugins 8396"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 11778"}
    D1 -->|"7872 / 2655"| E1["aggregate + README stats"]
...
- **🛒 市场与管理**（239）— OK 93 · incompatible 20 · pending 15 · untested 7 · watching 104 — [details](PLUGINS-ALL.md#-市场与管理239)
- **🔌 Web UI 增强**（2202）— OK 1211 · incompatible 388 · pending 198 · untested 16 · watching 389 — [details](PLUGINS-ALL.md#-web-ui-增强2202)
- **💻 编码开发**（1683）— OK 837 · incompatible 324 · pending 153 · untested 18 · watching 351 — [details](PLUGINS-ALL.md#-编码开发1683)
- **🤖 Agent 能力**（1633）— OK 730 · incompatible 302 · pending 145 · untested 10 · watching 446 — [details](PLUGINS-ALL.md#-agent-能力1633)
- **📡 消息通讯**（552）— OK 225 · incompatible 123 · pending 45 · untested 3 · watching 156 — [details](PLUGINS-ALL.md#-消息通讯552)
- **🗂 文件数据**（493）— OK 232 · incompatible 85 · pending 46 · untested 9 · watching 121 — [details](PLUGINS-ALL.md#-文件数据493)
- **🎮 娱乐生活**（328）— OK 154 · incompatible 28 · pending 29 · untested 0 · watching 117 — [details](PLUGINS-ALL.md#-娱乐生活328)
- **🛠 基建部署**（1035）— OK 407 · incompatible 127 · pending 126 · untested 3 · watching 372 — [details](PLUGINS-ALL.md#-基建部署1035)
- **📚 学习研究**（107）— OK 29 · incompatible 9 · pending 8 · untested 2 · watching 59 — [details](PLUGINS-ALL.md#-学习研究107)
- **❓ 其他**（4327）— OK 1546 · incompatible 292 · pending 223 · untested 20 · watching 2246 — [details](PLUGINS-ALL.md#-其他4327)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260831T013001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260831T013001Z（2026-08-31 09:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 7872 可用 · 2655 不兼容 · 1251 待定（共 11778 个，k8s agent 口径）|

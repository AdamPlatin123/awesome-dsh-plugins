...
[![confirmed](https://img.shields.io/badge/confirmed-3034-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-3169-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-2075-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-697-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-397-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **3034 plugin repos indexed** (manifest-level classification, v2 engine), **3169 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T011501Z` (2026-08-28 09:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15484 · age 13m"]
    ...
    B1 -->|"plugins 3034"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 3169"}
    D1 -->|"2075 / 697"| E1["aggregate + README stats"]
    D1 -->|"397 env retries"| C1
...
- **🛒 市场与管理**（107）— OK 45 · incompatible 16 · pending 8 · untested 10 · watching 28 — [details](PLUGINS-ALL.md#-市场与管理107)
- **🔌 Web UI 增强**（742）— OK 412 · incompatible 146 · pending 81 · untested 26 · watching 77 — [details](PLUGINS-ALL.md#-web-ui-增强742)
- **💻 编码开发**（588）— OK 297 · incompatible 109 · pending 80 · untested 27 · watching 75 — [details](PLUGINS-ALL.md#-编码开发588)
- **🤖 Agent 能力**（475）— OK 221 · incompatible 103 · pending 73 · untested 14 · watching 64 — [details](PLUGINS-ALL.md#-agent-能力475)
- **📡 消息通讯**（193）— OK 85 · incompatible 52 · pending 28 · untested 3 · watching 25 — [details](PLUGINS-ALL.md#-消息通讯193)
- **🗂 文件数据**（162）— OK 69 · incompatible 31 · pending 28 · untested 12 · watching 22 — [details](PLUGINS-ALL.md#-文件数据162)
- **🎮 娱乐生活**（99）— OK 55 · incompatible 9 · pending 13 · untested 1 · watching 21 — [details](PLUGINS-ALL.md#-娱乐生活99)
- **🛠 基建部署**（425）— OK 180 · incompatible 73 · pending 70 · untested 4 · watching 98 — [details](PLUGINS-ALL.md#-基建部署425)
- **📚 学习研究**（34）— OK 12 · incompatible 4 · pending 2 · untested 2 · watching 14 — [details](PLUGINS-ALL.md#-学习研究34)
- **❓ 其他**（1150）— OK 433 · incompatible 172 · pending 115 · untested 26 · watching 404 — [details](PLUGINS-ALL.md#-其他1150)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T011501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T011501Z（2026-08-28 09:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 2075 可用 · 697 不兼容 · 397 待定（共 3169 个，k8s agent 口径）|

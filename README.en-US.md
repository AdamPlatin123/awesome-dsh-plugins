...
[![confirmed](https://img.shields.io/badge/confirmed-8654-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12159-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8170-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1499-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2598-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8654 plugin repos indexed** (manifest-level classification, v2 engine), **12159 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260902T004501Z` (2026-09-02 08:45:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17411 · age 209m"]
    ...
    B1 -->|"plugins 8654"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12159"}
    D1 -->|"8170 / 2598"| E1["aggregate + README stats"]
    D1 -->|"1391 env retries"| C1
...
- **🔌 Web UI 增强**（2258）— OK 1245 · incompatible 373 · pending 220 · untested 16 · watching 404 — [details](PLUGINS-ALL.md#-web-ui-增强2258)
- **💻 编码开发**（1730）— OK 850 · incompatible 325 · pending 171 · untested 19 · watching 365 — [details](PLUGINS-ALL.md#-编码开发1730)
- **🤖 Agent 能力**（1686）— OK 758 · incompatible 291 · pending 160 · untested 10 · watching 467 — [details](PLUGINS-ALL.md#-agent-能力1686)
- **📡 消息通讯**（561）— OK 233 · incompatible 119 · pending 49 · untested 3 · watching 157 — [details](PLUGINS-ALL.md#-消息通讯561)
- **🗂 文件数据**（509）— OK 242 · incompatible 81 · pending 48 · untested 9 · watching 129 — [details](PLUGINS-ALL.md#-文件数据509)
- **🎮 娱乐生活**（339）— OK 160 · incompatible 25 · pending 28 · untested 0 · watching 126 — [details](PLUGINS-ALL.md#-娱乐生活339)
- **🛠 基建部署**（1053）— OK 415 · incompatible 126 · pending 132 · untested 3 · watching 377 — [details](PLUGINS-ALL.md#-基建部署1053)
- **📚 学习研究**（113）— OK 31 · incompatible 9 · pending 8 · untested 2 · watching 63 — [details](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4653）— OK 1675 · incompatible 293 · pending 236 · untested 21 · watching 2428 — [details](PLUGINS-ALL.md#-其他4653)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260902T004501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260902T004501Z（2026-09-02 08:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8170 可用 · 2598 不兼容 · 1391 待定（共 12159 个，k8s agent 口径）|

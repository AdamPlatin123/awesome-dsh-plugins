...
**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **333 plugin repos indexed** (manifest-level classification, v2 engine), **12605 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260903T090001Z` (2026-09-03 17:00:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17667 · age 213m"]
    ...
    B1 -->|"plugins 333"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
...
- **🔌 Web UI 增强**（2648）— OK 1294 · incompatible 387 · pending 227 · untested 16 · watching 724 — [details](PLUGINS-ALL.md#-web-ui-增强2648)
- **💻 编码开发**（2062）— OK 900 · incompatible 341 · pending 166 · untested 19 · watching 636 — [details](PLUGINS-ALL.md#-编码开发2062)
- **🤖 Agent 能力**（2145）— OK 778 · incompatible 262 · pending 155 · untested 10 · watching 940 — [details](PLUGINS-ALL.md#-agent-能力2145)
- **📡 消息通讯**（690）— OK 233 · incompatible 125 · pending 53 · untested 3 · watching 276 — [details](PLUGINS-ALL.md#-消息通讯690)
- **🗂 文件数据**（647）— OK 264 · incompatible 90 · pending 47 · untested 9 · watching 237 — [details](PLUGINS-ALL.md#-文件数据647)
- **🎮 娱乐生活**（439）— OK 173 · incompatible 29 · pending 29 · untested 0 · watching 208 — [details](PLUGINS-ALL.md#-娱乐生活439)
- **🛠 基建部署**（1321）— OK 432 · incompatible 131 · pending 120 · untested 3 · watching 635 — [details](PLUGINS-ALL.md#-基建部署1321)
- **📚 学习研究**（147）— OK 33 · incompatible 9 · pending 7 · untested 2 · watching 96 — [details](PLUGINS-ALL.md#-学习研究147)
- **❓ 其他**（6860）— OK 1761 · incompatible 310 · pending 241 · untested 21 · watching 4527 — [details](PLUGINS-ALL.md#-其他6860)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260903T090001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260903T090001Z（2026-09-03 17:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

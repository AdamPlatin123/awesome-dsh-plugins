...
[![confirmed](https://img.shields.io/badge/confirmed-8601-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12117-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8146-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1448-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2631-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8601 plugin repos indexed** (manifest-level classification, v2 engine), **12117 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260901T083001Z` (2026-09-01 16:30:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17159 · age 435m"]
    ...
    B1 -->|"plugins 8601"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12117"}
    D1 -->|"8146 / 2631"| E1["aggregate + README stats"]
    D1 -->|"1340 env retries"| C1
...
- **🔌 Web UI 增强**（2250）— OK 1241 · incompatible 381 · pending 214 · untested 16 · watching 398 — [details](PLUGINS-ALL.md#-web-ui-增强2250)
- **💻 编码开发**（1721）— OK 854 · incompatible 323 · pending 162 · untested 19 · watching 363 — [details](PLUGINS-ALL.md#-编码开发1721)
- **🤖 Agent 能力**（1679）— OK 756 · incompatible 298 · pending 154 · untested 10 · watching 461 — [details](PLUGINS-ALL.md#-agent-能力1679)
...
- **❓ 其他**（4591）— OK 1666 · incompatible 293 · pending 230 · untested 21 · watching 2381 — [details](PLUGINS-ALL.md#-其他4591)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260901T083001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260901T083001Z（2026-09-01 16:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8146 可用 · 2631 不兼容 · 1340 待定（共 12117 个，k8s agent 口径）|

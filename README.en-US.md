...
[![confirmed](https://img.shields.io/badge/confirmed-3028-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-3066-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1997-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-685-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-384-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **3028 plugin repos indexed** (manifest-level classification, v2 engine), **3066 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T010001Z` (2026-08-28 09:00:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15459 · age 232m"]
    ...
    B1 -->|"plugins 3028"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 3066"}
    D1 -->|"1997 / 685"| E1["aggregate + README stats"]
    D1 -->|"384 env retries"| C1
...
- **🛒 市场与管理**（106）— OK 44 · incompatible 16 · pending 8 · untested 10 · watching 28 — [details](PLUGINS-ALL.md#-市场与管理106)
- **🔌 Web UI 增强**（719）— OK 401 · incompatible 146 · pending 80 · untested 26 · watching 66 — [details](PLUGINS-ALL.md#-web-ui-增强719)
- **💻 编码开发**（579）— OK 293 · incompatible 108 · pending 80 · untested 27 · watching 71 — [details](PLUGINS-ALL.md#-编码开发579)
- **🤖 Agent 能力**（470）— OK 216 · incompatible 103 · pending 72 · untested 15 · watching 64 — [details](PLUGINS-ALL.md#-agent-能力470)
- **📡 消息通讯**（185）— OK 81 · incompatible 51 · pending 27 · untested 3 · watching 23 — [details](PLUGINS-ALL.md#-消息通讯185)
- **🗂 文件数据**（155）— OK 65 · incompatible 29 · pending 28 · untested 12 · watching 21 — [details](PLUGINS-ALL.md#-文件数据155)
- **🎮 娱乐生活**（92）— OK 53 · incompatible 8 · pending 12 · untested 1 · watching 18 — [details](PLUGINS-ALL.md#-娱乐生活92)
- **🛠 基建部署**（414）— OK 175 · incompatible 73 · pending 69 · untested 4 · watching 93 — [details](PLUGINS-ALL.md#-基建部署414)
- **📚 学习研究**（32）— OK 11 · incompatible 4 · pending 2 · untested 2 · watching 13 — [details](PLUGINS-ALL.md#-学习研究32)
- **❓ 其他**（1121）— OK 430 · incompatible 172 · pending 114 · untested 26 · watching 379 — [details](PLUGINS-ALL.md#-其他1121)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T010001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T010001Z（2026-08-28 09:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 1997 可用 · 685 不兼容 · 384 待定（共 3066 个，k8s agent 口径）|

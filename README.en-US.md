...
[![confirmed](https://img.shields.io/badge/confirmed-2996-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2131-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1389-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-491-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-251-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **2996 plugin repos indexed** (manifest-level classification, v2 engine), **2131 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260827T221501Z` (2026-08-28 06:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15459 · age 67m"]
    ...
    C1 --> D1{"verdict · total 2131"}
    D1 -->|"1389 / 491"| E1["aggregate + README stats"]
    D1 -->|"251 env retries"| C1
...
- **🎓 技能包**（29）— OK 6 · incompatible 1 · pending 3 · untested 16 · watching 3 — [details](PLUGINS-ALL.md#-技能包29)
...
- **🛒 市场与管理**（73）— OK 32 · incompatible 14 · pending 6 · untested 11 · watching 10 — [details](PLUGINS-ALL.md#-市场与管理73)
- **🔌 Web UI 增强**（551）— OK 306 · incompatible 113 · pending 67 · untested 29 · watching 36 — [details](PLUGINS-ALL.md#-web-ui-增强551)
- **💻 编码开发**（459）— OK 231 · incompatible 82 · pending 70 · untested 31 · watching 45 — [details](PLUGINS-ALL.md#-编码开发459)
- **🤖 Agent 能力**（376）— OK 176 · incompatible 86 · pending 62 · untested 15 · watching 37 — [details](PLUGINS-ALL.md#-agent-能力376)
- **📡 消息通讯**（146）— OK 69 · incompatible 41 · pending 20 · untested 3 · watching 13 — [details](PLUGINS-ALL.md#-消息通讯146)
- **🗂 文件数据**（125）— OK 53 · incompatible 23 · pending 25 · untested 12 · watching 12 — [details](PLUGINS-ALL.md#-文件数据125)
- **🎮 娱乐生活**（67）— OK 40 · incompatible 8 · pending 9 · untested 1 · watching 9 — [details](PLUGINS-ALL.md#-娱乐生活67)
- **🛠 基建部署**（306）— OK 134 · incompatible 63 · pending 60 · untested 4 · watching 45 — [details](PLUGINS-ALL.md#-基建部署306)
- **📚 学习研究**（24）— OK 10 · incompatible 4 · pending 1 · untested 2 · watching 7 — [details](PLUGINS-ALL.md#-学习研究24)
- **❓ 其他**（823）— OK 366 · incompatible 147 · pending 99 · untested 28 · watching 183 — [details](PLUGINS-ALL.md#-其他823)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T221501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260827T221501Z（2026-08-28 06:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

...
[![confirmed](https://img.shields.io/badge/confirmed-415-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12960-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8785-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1564-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2720-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **415 plugin repos indexed** (manifest-level classification, v2 engine), **12960 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260903T191501Z` (2026-09-04 03:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17870 · age 106m"]
    ...
    B1 -->|"plugins 415"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12960"}
    D1 -->|"8785 / 2720"| E1["aggregate + README stats"]
    D1 -->|"1455 env retries"| C1
...
- **🔌 Web UI 增强**（2715）— OK 1324 · incompatible 403 · pending 228 · untested 16 · watching 744 — [details](PLUGINS-ALL.md#-web-ui-增强2715)
- **💻 编码开发**（2099）— OK 921 · incompatible 352 · pending 163 · untested 19 · watching 644 — [details](PLUGINS-ALL.md#-编码开发2099)
- **🤖 Agent 能力**（2193）— OK 803 · incompatible 269 · pending 154 · untested 10 · watching 957 — [details](PLUGINS-ALL.md#-agent-能力2193)
- **📡 消息通讯**（703）— OK 242 · incompatible 129 · pending 50 · untested 3 · watching 279 — [details](PLUGINS-ALL.md#-消息通讯703)
- **🗂 文件数据**（660）— OK 271 · incompatible 93 · pending 48 · untested 9 · watching 239 — [details](PLUGINS-ALL.md#-文件数据660)
- **🎮 娱乐生活**（449）— OK 177 · incompatible 31 · pending 30 · untested 0 · watching 211 — [details](PLUGINS-ALL.md#-娱乐生活449)
- **🛠 基建部署**（1334）— OK 442 · incompatible 130 · pending 119 · untested 3 · watching 640 — [details](PLUGINS-ALL.md#-基建部署1334)
- **📚 学习研究**（151）— OK 34 · incompatible 9 · pending 7 · untested 2 · watching 99 — [details](PLUGINS-ALL.md#-学习研究151)
- **❓ 其他**（6998）— OK 1824 · incompatible 316 · pending 249 · untested 21 · watching 4588 — [details](PLUGINS-ALL.md#-其他6998)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260903T191501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260903T191501Z（2026-09-04 03:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8785 可用 · 2720 不兼容 · 1455 待定（共 12960 个，k8s agent 口径）|

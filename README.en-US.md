...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2129-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1155-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-824-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-150-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **2129 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260826T161502Z` (2026-08-27 00:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 14834 · age 173m"]
    ...
    C1 --> D1{"verdict · total 2129"}
    D1 -->|"1155 / 824"| E1["aggregate + README stats"]
    D1 -->|"150 env retries"| C1
...
- **🧠 记忆增强**（19）— OK 6 · incompatible 4 · pending 2 · untested 6 · watching 1 — [details](PLUGINS-ALL.md#-记忆增强19)
- **🎨 主题皮肤**（12）— OK 2 · incompatible 1 · pending 1 · untested 8 · watching 0 — [details](PLUGINS-ALL.md#-主题皮肤12)
- **🛒 市场与管理**（64）— OK 24 · incompatible 13 · pending 2 · untested 11 · watching 14 — [details](PLUGINS-ALL.md#-市场与管理64)
- **🔌 Web UI 增强**（491）— OK 254 · incompatible 112 · pending 44 · untested 38 · watching 43 — [details](PLUGINS-ALL.md#-web-ui-增强491)
- **💻 编码开发**（414）— OK 183 · incompatible 88 · pending 44 · untested 51 · watching 48 — [details](PLUGINS-ALL.md#-编码开发414)
- **🤖 Agent 能力**（351）— OK 144 · incompatible 87 · pending 39 · untested 27 · watching 54 — [details](PLUGINS-ALL.md#-agent-能力351)
- **📡 消息通讯**（132）— OK 59 · incompatible 37 · pending 16 · untested 6 · watching 14 — [details](PLUGINS-ALL.md#-消息通讯132)
- **🗂 文件数据**（105）— OK 48 · incompatible 21 · pending 16 · untested 13 · watching 7 — [details](PLUGINS-ALL.md#-文件数据105)
- **🎮 娱乐生活**（61）— OK 31 · incompatible 13 · pending 7 · untested 2 · watching 8 — [details](PLUGINS-ALL.md#-娱乐生活61)
- **🛠 基建部署**（265）— OK 94 · incompatible 91 · pending 25 · untested 8 · watching 47 — [details](PLUGINS-ALL.md#-基建部署265)
- **📚 学习研究**（20）— OK 5 · incompatible 4 · pending 0 · untested 3 · watching 8 — [details](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（727）— OK 285 · incompatible 138 · pending 47 · untested 56 · watching 201 — [details](PLUGINS-ALL.md#-其他727)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260826T161502Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.

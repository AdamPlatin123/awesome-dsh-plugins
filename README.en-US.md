...
[![confirmed](https://img.shields.io/badge/confirmed-8556-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12076-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8124-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1432-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2628-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8556 plugin repos indexed** (manifest-level classification, v2 engine), **12076 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260831T231501Z` (2026-09-01 07:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17120 · age 120m"]
    ...
    B1 -->|"plugins 8556"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12076"}
    D1 -->|"8124 / 2628"| E1["aggregate + README stats"]
    D1 -->|"1324 env retries"| C1
...
- **🔌 Web UI 增强**（2242）— OK 1237 · incompatible 383 · pending 211 · untested 16 · watching 395 — [details](PLUGINS-ALL.md#-web-ui-增强2242)
- **💻 编码开发**（1717）— OK 854 · incompatible 321 · pending 162 · untested 19 · watching 361 — [details](PLUGINS-ALL.md#-编码开发1717)
- **🤖 Agent 能力**（1668）— OK 751 · incompatible 295 · pending 152 · untested 10 · watching 460 — [details](PLUGINS-ALL.md#-agent-能力1668)
- **📡 消息通讯**（561）— OK 231 · incompatible 124 · pending 47 · untested 3 · watching 156 — [details](PLUGINS-ALL.md#-消息通讯561)
- **🗂 文件数据**（509）— OK 244 · incompatible 82 · pending 47 · untested 9 · watching 127 — [details](PLUGINS-ALL.md#-文件数据509)
...
- **❓ 其他**（4580）— OK 1664 · incompatible 291 · pending 231 · untested 21 · watching 2373 — [details](PLUGINS-ALL.md#-其他4580)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260831T231501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260831T231501Z（2026-09-01 07:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8124 可用 · 2628 不兼容 · 1324 待定（共 12076 个，k8s agent 口径）|

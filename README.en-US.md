...
[![confirmed](https://img.shields.io/badge/confirmed-2996-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2222-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1448-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-513-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-261-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **2996 plugin repos indexed** (manifest-level classification, v2 engine), **2222 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260827T223001Z` (2026-08-28 06:30:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15459 · age 82m"]
    ...
    C1 --> D1{"verdict · total 2222"}
    D1 -->|"1448 / 513"| E1["aggregate + README stats"]
    D1 -->|"261 env retries"| C1
...
- **🛒 市场与管理**（75）— OK 32 · incompatible 14 · pending 7 · untested 11 · watching 11 — [details](PLUGINS-ALL.md#-市场与管理75)
- **🔌 Web UI 增强**（569）— OK 316 · incompatible 118 · pending 67 · untested 29 · watching 39 — [details](PLUGINS-ALL.md#-web-ui-增强569)
- **💻 编码开发**（469）— OK 235 · incompatible 84 · pending 72 · untested 31 · watching 47 — [details](PLUGINS-ALL.md#-编码开发469)
- **🤖 Agent 能力**（384）— OK 179 · incompatible 87 · pending 63 · untested 15 · watching 40 — [details](PLUGINS-ALL.md#-agent-能力384)
- **📡 消息通讯**（148）— OK 70 · incompatible 41 · pending 20 · untested 3 · watching 14 — [details](PLUGINS-ALL.md#-消息通讯148)
- **🗂 文件数据**（130）— OK 55 · incompatible 23 · pending 26 · untested 12 · watching 14 — [details](PLUGINS-ALL.md#-文件数据130)
- **🎮 娱乐生活**（69）— OK 41 · incompatible 8 · pending 9 · untested 1 · watching 10 — [details](PLUGINS-ALL.md#-娱乐生活69)
- **🛠 基建部署**（320）— OK 139 · incompatible 65 · pending 60 · untested 4 · watching 52 — [details](PLUGINS-ALL.md#-基建部署320)
- **📚 学习研究**（25）— OK 10 · incompatible 4 · pending 1 · untested 2 · watching 8 — [details](PLUGINS-ALL.md#-学习研究25)
- **❓ 其他**（850）— OK 374 · incompatible 150 · pending 99 · untested 27 · watching 200 — [details](PLUGINS-ALL.md#-其他850)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T223001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260827T223001Z（2026-08-28 06:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 1448 可用 · 513 不兼容 · 261 待定（共 2222 个，k8s agent 口径）|

...
> Data as of snapshot `20260827T073001Z` (2026-08-27 15:30:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15158 · age 11m"]
...
- **🧠 记忆增强**（19）— OK 7 · incompatible 5 · pending 2 · untested 5 · watching 0 — [details](PLUGINS-ALL.md#-记忆增强19)
...
- **🔌 Web UI 增强**（504）— OK 272 · incompatible 124 · pending 51 · untested 32 · watching 25 — [details](PLUGINS-ALL.md#-web-ui-增强504)
- **💻 编码开发**（420）— OK 192 · incompatible 99 · pending 52 · untested 43 · watching 34 — [details](PLUGINS-ALL.md#-编码开发420)
- **🤖 Agent 能力**（355）— OK 147 · incompatible 108 · pending 48 · untested 23 · watching 29 — [details](PLUGINS-ALL.md#-agent-能力355)
- **📡 消息通讯**（130）— OK 61 · incompatible 44 · pending 15 · untested 4 · watching 6 — [details](PLUGINS-ALL.md#-消息通讯130)
- **🗂 文件数据**（110）— OK 51 · incompatible 23 · pending 17 · untested 13 · watching 6 — [details](PLUGINS-ALL.md#-文件数据110)
- **🎮 娱乐生活**（61）— OK 33 · incompatible 14 · pending 7 · untested 1 · watching 6 — [details](PLUGINS-ALL.md#-娱乐生活61)
- **🛠 基建部署**（277）— OK 97 · incompatible 112 · pending 35 · untested 6 · watching 27 — [details](PLUGINS-ALL.md#-基建部署277)
- **📚 学习研究**（19）— OK 7 · incompatible 7 · pending 0 · untested 2 · watching 3 — [details](PLUGINS-ALL.md#-学习研究19)
- **❓ 其他**（737）— OK 324 · incompatible 192 · pending 60 · untested 51 · watching 110 — [details](PLUGINS-ALL.md#-其他737)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T073001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260827T073001Z（2026-08-27 15:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1179 可用 · 874 不兼容 · 222 待定（共 2275 个，k8s agent 口径）|

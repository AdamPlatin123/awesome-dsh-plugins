...
[![confirmed](https://img.shields.io/badge/confirmed-5282-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-6375-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-4248-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-1406-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-721-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **5282 plugin repos indexed** (manifest-level classification, v2 engine), **6375 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T104501Z` (2026-08-28 18:45:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15618 · age 102m"]
    ...
    B1 -->|"plugins 5282"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 6375"}
    D1 -->|"4248 / 1406"| E1["aggregate + README stats"]
    D1 -->|"721 env retries"| C1
...
- **🔌 Web UI 增强**（1349）— OK 754 · incompatible 237 · pending 130 · untested 22 · watching 206 — [details](PLUGINS-ALL.md#-web-ui-增强1349)
- **💻 编码开发**（1011）— OK 524 · incompatible 187 · pending 114 · untested 20 · watching 166 — [details](PLUGINS-ALL.md#-编码开发1011)
- **🤖 Agent 能力**（860）— OK 397 · incompatible 145 · pending 100 · untested 12 · watching 206 — [details](PLUGINS-ALL.md#-agent-能力860)
- **📡 消息通讯**（331）— OK 143 · incompatible 71 · pending 33 · untested 3 · watching 81 — [details](PLUGINS-ALL.md#-消息通讯331)
- **🗂 文件数据**（292）— OK 134 · incompatible 54 · pending 36 · untested 9 · watching 59 — [details](PLUGINS-ALL.md#-文件数据292)
- **🎮 娱乐生活**（177）— OK 92 · incompatible 13 · pending 20 · untested 0 · watching 52 — [details](PLUGINS-ALL.md#-娱乐生活177)
- **🛠 基建部署**（677）— OK 279 · incompatible 87 · pending 96 · untested 3 · watching 212 — [details](PLUGINS-ALL.md#-基建部署677)
- **📚 学习研究**（64）— OK 20 · incompatible 5 · pending 3 · untested 2 · watching 34 — [details](PLUGINS-ALL.md#-学习研究64)
- **❓ 其他**（2085）— OK 684 · incompatible 188 · pending 145 · untested 21 · watching 1047 — [details](PLUGINS-ALL.md#-其他2085)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T104501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T104501Z（2026-08-28 18:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 4248 可用 · 1406 不兼容 · 721 待定（共 6375 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-8364-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-11757-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_7857-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1356-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2650-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8364 plugin repos indexed** (manifest-level classification, v2 engine), **11757 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260830T223001Z` (2026-08-31 06:30:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 16768 · age 82m"]
    ...
    B1 -->|"plugins 8364"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 11757"}
    D1 -->|"7857 / 2650"| E1["aggregate + README stats"]
...
- **🛒 市场与管理**（238）— OK 94 · incompatible 20 · pending 14 · untested 7 · watching 103 — [details](PLUGINS-ALL.md#-市场与管理238)
- **🔌 Web UI 增强**（2204）— OK 1212 · incompatible 390 · pending 198 · untested 16 · watching 388 — [details](PLUGINS-ALL.md#-web-ui-增强2204)
- **💻 编码开发**（1677）— OK 832 · incompatible 323 · pending 154 · untested 18 · watching 350 — [details](PLUGINS-ALL.md#-编码开发1677)
- **🤖 Agent 能力**（1628）— OK 726 · incompatible 302 · pending 145 · untested 10 · watching 445 — [details](PLUGINS-ALL.md#-agent-能力1628)
- **📡 消息通讯**（549）— OK 223 · incompatible 123 · pending 44 · untested 3 · watching 156 — [details](PLUGINS-ALL.md#-消息通讯549)
...
- **🛠 基建部署**（1033）— OK 408 · incompatible 125 · pending 126 · untested 3 · watching 371 — [details](PLUGINS-ALL.md#-基建部署1033)
- **📚 学习研究**（107）— OK 29 · incompatible 9 · pending 8 · untested 2 · watching 59 — [details](PLUGINS-ALL.md#-学习研究107)
- **❓ 其他**（4315）— OK 1545 · incompatible 291 · pending 223 · untested 20 · watching 2236 — [details](PLUGINS-ALL.md#-其他4315)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260830T223001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260830T223001Z（2026-08-31 06:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 7857 可用 · 2650 不兼容 · 1250 待定（共 11757 个，k8s agent 口径）|

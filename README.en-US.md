...
[![confirmed](https://img.shields.io/badge/confirmed-5441-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-6559-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-4368-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-1445-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-746-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **5441 plugin repos indexed** (manifest-level classification, v2 engine), **6559 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T111501Z` (2026-08-28 19:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15618 · age 132m"]
    ...
    B1 -->|"plugins 5441"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 6559"}
    D1 -->|"4368 / 1445"| E1["aggregate + README stats"]
    D1 -->|"746 env retries"| C1
...
- **🔌 Web UI 增强**（1379）— OK 772 · incompatible 240 · pending 133 · untested 22 · watching 212 — [details](PLUGINS-ALL.md#-web-ui-增强1379)
- **💻 编码开发**（1033）— OK 539 · incompatible 190 · pending 114 · untested 20 · watching 170 — [details](PLUGINS-ALL.md#-编码开发1033)
- **🤖 Agent 能力**（881）— OK 408 · incompatible 146 · pending 101 · untested 12 · watching 214 — [details](PLUGINS-ALL.md#-agent-能力881)
- **📡 消息通讯**（352）— OK 151 · incompatible 77 · pending 35 · untested 3 · watching 86 — [details](PLUGINS-ALL.md#-消息通讯352)
- **🗂 文件数据**（294）— OK 134 · incompatible 55 · pending 36 · untested 9 · watching 60 — [details](PLUGINS-ALL.md#-文件数据294)
- **🎮 娱乐生活**（182）— OK 94 · incompatible 14 · pending 20 · untested 0 · watching 54 — [details](PLUGINS-ALL.md#-娱乐生活182)
- **🛠 基建部署**（696）— OK 283 · incompatible 90 · pending 99 · untested 3 · watching 221 — [details](PLUGINS-ALL.md#-基建部署696)
- **📚 学习研究**（65）— OK 20 · incompatible 5 · pending 3 · untested 2 · watching 35 — [details](PLUGINS-ALL.md#-学习研究65)
- **❓ 其他**（2147）— OK 694 · incompatible 194 · pending 150 · untested 21 · watching 1088 — [details](PLUGINS-ALL.md#-其他2147)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T111501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T111501Z（2026-08-28 19:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 4368 可用 · 1445 不兼容 · 746 待定（共 6559 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-781-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-13110-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8936-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1743-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2540-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **781 plugin repos indexed** (manifest-level classification, v2 engine), **13110 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260904T181501Z` (2026-09-05 02:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 18184 · age 271m"]
    ...
    C1 --> D1{"verdict · total 13110"}
    D1 -->|"8936 / 2540"| E1["aggregate + README stats"]
    D1 -->|"1634 env retries"| C1
    E1 --> E2["cadence deliver<br/>delta this cycle —/100<br/>dual-repo bot PRs (idempotent)"]
    M["radar-probe every 15 min self-heal<br/>7 metric streams × 60s · done 17"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🛒 市场与管理**（304）— OK 98 · incompatible 21 · pending 17 · untested 8 · watching 160 — [details](PLUGINS-ALL.md#-市场与管理304)
- **🔌 Web UI 增强**（2743）— OK 1346 · incompatible 387 · pending 249 · untested 16 · watching 745 — [details](PLUGINS-ALL.md#-web-ui-增强2743)
- **💻 编码开发**（2123）— OK 930 · incompatible 340 · pending 182 · untested 19 · watching 652 — [details](PLUGINS-ALL.md#-编码开发2123)
- **🤖 Agent 能力**（2214）— OK 813 · incompatible 262 · pending 161 · untested 10 · watching 968 — [details](PLUGINS-ALL.md#-agent-能力2214)
- **📡 消息通讯**（709）— OK 257 · incompatible 118 · pending 49 · untested 3 · watching 282 — [details](PLUGINS-ALL.md#-消息通讯709)
- **🗂 文件数据**（667）— OK 270 · incompatible 92 · pending 55 · untested 9 · watching 241 — [details](PLUGINS-ALL.md#-文件数据667)
- **🎮 娱乐生活**（450）— OK 175 · incompatible 31 · pending 32 · untested 0 · watching 212 — [details](PLUGINS-ALL.md#-娱乐生活450)
- **🛠 基建部署**（1340）— OK 444 · incompatible 129 · pending 121 · untested 3 · watching 643 — [details](PLUGINS-ALL.md#-基建部署1340)
- **📚 学习研究**（152）— OK 35 · incompatible 8 · pending 8 · untested 2 · watching 99 — [details](PLUGINS-ALL.md#-学习研究152)
- **❓ 其他**（7068）— OK 1831 · incompatible 318 · pending 257 · untested 21 · watching 4641 — [details](PLUGINS-ALL.md#-其他7068)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260904T181501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260904T181501Z（2026-09-05 02:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8936 可用 · 2540 不兼容 · 1634 待定（共 13110 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-9077-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12584-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8468-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1549-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2675-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **9077 plugin repos indexed** (manifest-level classification, v2 engine), **12584 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260902T131502Z` (2026-09-02 21:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17578 · age 248m"]
    ...
    B1 -->|"plugins 9077"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12584"}
    D1 -->|"8468 / 2675"| E1["aggregate + README stats"]
    D1 -->|"1441 env retries"| C1
...
- **🔌 Web UI 增强**（2340）— OK 1292 · incompatible 383 · pending 227 · untested 16 · watching 422 — [details](PLUGINS-ALL.md#-web-ui-增强2340)
- **💻 编码开发**（1805）— OK 890 · incompatible 340 · pending 176 · untested 19 · watching 380 — [details](PLUGINS-ALL.md#-编码开发1805)
- **🤖 Agent 能力**（1694）— OK 752 · incompatible 276 · pending 167 · untested 10 · watching 489 — [details](PLUGINS-ALL.md#-agent-能力1694)
- **📡 消息通讯**（573）— OK 238 · incompatible 122 · pending 51 · untested 3 · watching 159 — [details](PLUGINS-ALL.md#-消息通讯573)
- **🗂 文件数据**（544）— OK 255 · incompatible 97 · pending 48 · untested 9 · watching 135 — [details](PLUGINS-ALL.md#-文件数据544)
- **🎮 娱乐生活**（358）— OK 172 · incompatible 28 · pending 28 · untested 0 · watching 130 — [details](PLUGINS-ALL.md#-娱乐生活358)
- **🛠 基建部署**（1077）— OK 423 · incompatible 126 · pending 134 · untested 3 · watching 391 — [details](PLUGINS-ALL.md#-基建部署1077)
- **📚 学习研究**（116）— OK 32 · incompatible 9 · pending 7 · untested 2 · watching 66 — [details](PLUGINS-ALL.md#-学习研究116)
- **❓ 其他**（4888）— OK 1757 · incompatible 304 · pending 238 · untested 21 · watching 2568 — [details](PLUGINS-ALL.md#-其他4888)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260902T131502Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260902T131502Z（2026-09-02 21:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8468 可用 · 2675 不兼容 · 1441 待定（共 12584 个，k8s agent 口径）|

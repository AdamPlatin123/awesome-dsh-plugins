...
[![confirmed](https://img.shields.io/badge/confirmed-5362-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-6468-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-4308-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-1427-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-733-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **5362 plugin repos indexed** (manifest-level classification, v2 engine), **6468 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T110001Z` (2026-08-28 19:00:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15618 · age 117m"]
    ...
    B1 -->|"plugins 5362"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 6468"}
    D1 -->|"4308 / 1427"| E1["aggregate + README stats"]
    D1 -->|"733 env retries"| C1
...
- **🧠 记忆增强**（25）— OK 14 · incompatible 1 · pending 3 · untested 3 · watching 4 — [details](PLUGINS-ALL.md#-记忆增强25)
- **🎨 主题皮肤**（17）— OK 6 · incompatible 0 · pending 2 · untested 7 · watching 2 — [details](PLUGINS-ALL.md#-主题皮肤17)
- **🛒 市场与管理**（167）— OK 67 · incompatible 16 · pending 12 · untested 8 · watching 64 — [details](PLUGINS-ALL.md#-市场与管理167)
- **🔌 Web UI 增强**（1365）— OK 766 · incompatible 237 · pending 132 · untested 22 · watching 208 — [details](PLUGINS-ALL.md#-web-ui-增强1365)
- **💻 编码开发**（1024）— OK 531 · incompatible 189 · pending 114 · untested 20 · watching 170 — [details](PLUGINS-ALL.md#-编码开发1024)
- **🤖 Agent 能力**（871）— OK 403 · incompatible 146 · pending 100 · untested 12 · watching 210 — [details](PLUGINS-ALL.md#-agent-能力871)
- **📡 消息通讯**（341）— OK 146 · incompatible 74 · pending 34 · untested 3 · watching 84 — [details](PLUGINS-ALL.md#-消息通讯341)
- **🗂 文件数据**（294）— OK 134 · incompatible 55 · pending 36 · untested 9 · watching 60 — [details](PLUGINS-ALL.md#-文件数据294)
- **🎮 娱乐生活**（179）— OK 92 · incompatible 14 · pending 20 · untested 0 · watching 53 — [details](PLUGINS-ALL.md#-娱乐生活179)
- **🛠 基建部署**（683）— OK 281 · incompatible 87 · pending 97 · untested 3 · watching 215 — [details](PLUGINS-ALL.md#-基建部署683)
- **📚 学习研究**（65）— OK 20 · incompatible 5 · pending 3 · untested 2 · watching 35 — [details](PLUGINS-ALL.md#-学习研究65)
- **❓ 其他**（2117）— OK 689 · incompatible 190 · pending 147 · untested 21 · watching 1070 — [details](PLUGINS-ALL.md#-其他2117)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T110001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T110001Z（2026-08-28 19:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 4308 可用 · 1427 不兼容 · 733 待定（共 6468 个，k8s agent 口径）|

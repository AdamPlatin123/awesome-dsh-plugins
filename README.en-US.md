...
[![confirmed](https://img.shields.io/badge/confirmed-9168-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12558-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8451-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1547-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2668-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **9168 plugin repos indexed** (manifest-level classification, v2 engine), **12558 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260902T111501Z` (2026-09-02 19:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17578 · age 129m"]
    ...
    B1 -->|"plugins 9168"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12558"}
    D1 -->|"8451 / 2668"| E1["aggregate + README stats"]
    D1 -->|"1439 env retries"| C1
    E1 --> E2["cadence deliver<br/>delta this cycle —/100<br/>dual-repo bot PRs (idempotent)"]
    M["radar-probe every 15 min self-heal<br/>7 metric streams × 60s · done 48"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🔌 Web UI 增强**（2331）— OK 1286 · incompatible 383 · pending 226 · untested 16 · watching 420 — [details](PLUGINS-ALL.md#-web-ui-增强2331)
- **💻 编码开发**（1802）— OK 889 · incompatible 339 · pending 175 · untested 19 · watching 380 — [details](PLUGINS-ALL.md#-编码开发1802)
- **🤖 Agent 能力**（1692）— OK 750 · incompatible 276 · pending 167 · untested 10 · watching 489 — [details](PLUGINS-ALL.md#-agent-能力1692)
- **📡 消息通讯**（570）— OK 237 · incompatible 121 · pending 50 · untested 3 · watching 159 — [details](PLUGINS-ALL.md#-消息通讯570)
- **🗂 文件数据**（542）— OK 254 · incompatible 95 · pending 49 · untested 9 · watching 135 — [details](PLUGINS-ALL.md#-文件数据542)
- **🎮 娱乐生活**（357）— OK 171 · incompatible 28 · pending 28 · untested 0 · watching 130 — [details](PLUGINS-ALL.md#-娱乐生活357)
- **🛠 基建部署**（1076）— OK 422 · incompatible 126 · pending 134 · untested 3 · watching 391 — [details](PLUGINS-ALL.md#-基建部署1076)
- **📚 学习研究**（116）— OK 32 · incompatible 9 · pending 7 · untested 2 · watching 66 — [details](PLUGINS-ALL.md#-学习研究116)
- **❓ 其他**（4883）— OK 1757 · incompatible 303 · pending 238 · untested 21 · watching 2564 — [details](PLUGINS-ALL.md#-其他4883)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260902T111501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260902T111501Z（2026-09-02 19:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8451 可用 · 2668 不兼容 · 1439 待定（共 12558 个，k8s agent 口径）|

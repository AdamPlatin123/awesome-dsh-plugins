...
[![confirmed](https://img.shields.io/badge/confirmed-8980-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12496-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8403-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1539-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2662-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8980 plugin repos indexed** (manifest-level classification, v2 engine), **12496 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260902T071501Z` (2026-09-02 15:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17572 · age 111m"]
    ...
    B1 -->|"plugins 8980"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12496"}
    D1 -->|"8403 / 2662"| E1["aggregate + README stats"]
    D1 -->|"1431 env retries"| C1
...
- **🔌 Web UI 增强**（2315）— OK 1276 · incompatible 379 · pending 226 · untested 16 · watching 418 — [details](PLUGINS-ALL.md#-web-ui-增强2315)
- **💻 编码开发**（1782）— OK 882 · incompatible 333 · pending 172 · untested 19 · watching 376 — [details](PLUGINS-ALL.md#-编码开发1782)
- **🤖 Agent 能力**（1734）— OK 776 · incompatible 298 · pending 166 · untested 10 · watching 484 — [details](PLUGINS-ALL.md#-agent-能力1734)
- **📡 消息通讯**（568）— OK 235 · incompatible 120 · pending 51 · untested 3 · watching 159 — [details](PLUGINS-ALL.md#-消息通讯568)
- **🗂 文件数据**（523）— OK 247 · incompatible 85 · pending 49 · untested 9 · watching 133 — [details](PLUGINS-ALL.md#-文件数据523)
- **🎮 娱乐生活**（344）— OK 162 · incompatible 25 · pending 28 · untested 0 · watching 129 — [details](PLUGINS-ALL.md#-娱乐生活344)
- **🛠 基建部署**（1072）— OK 419 · incompatible 127 · pending 135 · untested 3 · watching 388 — [details](PLUGINS-ALL.md#-基建部署1072)
- **📚 学习研究**（114）— OK 32 · incompatible 9 · pending 7 · untested 2 · watching 64 — [details](PLUGINS-ALL.md#-学习研究114)
- **❓ 其他**（4794）— OK 1727 · incompatible 300 · pending 238 · untested 21 · watching 2508 — [details](PLUGINS-ALL.md#-其他4794)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260902T071501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.

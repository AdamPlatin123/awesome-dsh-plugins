...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2393-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1631-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-526-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-236-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **2393 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260827T201501Z` (2026-08-28 04:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15443 · age 29m"]
    ...
    C1 --> D1{"verdict · total 2393"}
    D1 -->|"1631 / 526"| E1["aggregate + README stats"]
    D1 -->|"236 env retries"| C1
...
- **🛒 市场与管理**（67）— OK 30 · incompatible 13 · pending 4 · untested 11 · watching 9 — [details](PLUGINS-ALL.md#-市场与管理67)
- **🔌 Web UI 增强**（535）— OK 308 · incompatible 108 · pending 56 · untested 30 · watching 33 — [details](PLUGINS-ALL.md#-web-ui-增强535)
- **💻 编码开发**（441）— OK 231 · incompatible 82 · pending 56 · untested 32 · watching 40 — [details](PLUGINS-ALL.md#-编码开发441)
- **🤖 Agent 能力**（367）— OK 178 · incompatible 88 · pending 51 · untested 15 · watching 35 — [details](PLUGINS-ALL.md#-agent-能力367)
- **📡 消息通讯**（139）— OK 68 · incompatible 39 · pending 18 · untested 3 · watching 11 — [details](PLUGINS-ALL.md#-消息通讯139)
- **🗂 文件数据**（123）— OK 55 · incompatible 23 · pending 22 · untested 12 · watching 11 — [details](PLUGINS-ALL.md#-文件数据123)
- **🎮 娱乐生活**（64）— OK 39 · incompatible 11 · pending 6 · untested 1 · watching 7 — [details](PLUGINS-ALL.md#-娱乐生活64)
- **🛠 基建部署**（292）— OK 140 · incompatible 63 · pending 48 · untested 4 · watching 37 — [details](PLUGINS-ALL.md#-基建部署292)
- **📚 学习研究**（21）— OK 11 · incompatible 4 · pending 0 · untested 2 · watching 4 — [details](PLUGINS-ALL.md#-学习研究21)
- **❓ 其他**（794）— OK 376 · incompatible 155 · pending 71 · untested 30 · watching 162 — [details](PLUGINS-ALL.md#-其他794)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T201501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260827T201501Z（2026-08-28 04:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1631 可用 · 526 不兼容 · 236 待定（共 2393 个，k8s agent 口径）|

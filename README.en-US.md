...
[![confirmed](https://img.shields.io/badge/confirmed-8554-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12076-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8117-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1422-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2645-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8554 plugin repos indexed** (manifest-level classification, v2 engine), **12076 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260831T223001Z` (2026-09-01 06:30:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17120 · age 75m"]
    ...
    B1 -->|"plugins 8554"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12076"}
    D1 -->|"8117 / 2645"| E1["aggregate + README stats"]
    D1 -->|"1314 env retries"| C1
    E1 --> E2["cadence deliver<br/>delta this cycle —/100<br/>dual-repo bot PRs (idempotent)"]
    M["radar-probe every 15 min self-heal<br/>7 metric streams × 60s · done 24"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🔌 Web UI 增强**（2242）— OK 1236 · incompatible 387 · pending 208 · untested 16 · watching 395 — [details](PLUGINS-ALL.md#-web-ui-增强2242)
- **💻 编码开发**（1717）— OK 851 · incompatible 327 · pending 159 · untested 19 · watching 361 — [details](PLUGINS-ALL.md#-编码开发1717)
- **🤖 Agent 能力**（1668）— OK 749 · incompatible 296 · pending 153 · untested 10 · watching 460 — [details](PLUGINS-ALL.md#-agent-能力1668)
- **📡 消息通讯**（561）— OK 231 · incompatible 124 · pending 47 · untested 3 · watching 156 — [details](PLUGINS-ALL.md#-消息通讯561)
- **🗂 文件数据**（509）— OK 243 · incompatible 83 · pending 47 · untested 9 · watching 127 — [details](PLUGINS-ALL.md#-文件数据509)
- **🎮 娱乐生活**（333）— OK 157 · incompatible 28 · pending 28 · untested 0 · watching 120 — [details](PLUGINS-ALL.md#-娱乐生活333)
- **🛠 基建部署**（1050）— OK 411 · incompatible 130 · pending 128 · untested 3 · watching 378 — [details](PLUGINS-ALL.md#-基建部署1050)
- **📚 学习研究**（113）— OK 31 · incompatible 9 · pending 8 · untested 2 · watching 63 — [details](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4580）— OK 1664 · incompatible 293 · pending 229 · untested 21 · watching 2373 — [details](PLUGINS-ALL.md#-其他4580)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260831T223001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260831T223001Z（2026-09-01 06:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8117 可用 · 2645 不兼容 · 1314 待定（共 12076 个，k8s agent 口径）|

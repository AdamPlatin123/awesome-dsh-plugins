...
> Data as of snapshot `20260829T233001Z` (2026-08-30 07:30:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 16357 · age 141m"]
    ...
    B1 -->|"plugins 7966"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 11160"}
    D1 -->|"7445 / 2462"| E1["aggregate + README stats"]
...
- **🛒 市场与管理**（226）— OK 89 · incompatible 19 · pending 15 · untested 7 · watching 96 — [details](PLUGINS-ALL.md#-市场与管理226)
- **🔌 Web UI 增强**（2107）— OK 1158 · incompatible 366 · pending 199 · untested 16 · watching 368 — [details](PLUGINS-ALL.md#-web-ui-增强2107)
- **💻 编码开发**（1584）— OK 788 · incompatible 297 · pending 157 · untested 18 · watching 324 — [details](PLUGINS-ALL.md#-编码开发1584)
- **🤖 Agent 能力**（1559）— OK 704 · incompatible 276 · pending 146 · untested 10 · watching 423 — [details](PLUGINS-ALL.md#-agent-能力1559)
- **📡 消息通讯**（535）— OK 218 · incompatible 119 · pending 43 · untested 3 · watching 152 — [details](PLUGINS-ALL.md#-消息通讯535)
- **🗂 文件数据**（474）— OK 222 · incompatible 77 · pending 47 · untested 9 · watching 119 — [details](PLUGINS-ALL.md#-文件数据474)
- **🎮 娱乐生活**（305）— OK 145 · incompatible 27 · pending 29 · untested 0 · watching 104 — [details](PLUGINS-ALL.md#-娱乐生活305)
- **🛠 基建部署**（991）— OK 390 · incompatible 115 · pending 129 · untested 3 · watching 354 — [details](PLUGINS-ALL.md#-基建部署991)
- **📚 学习研究**（104）— OK 28 · incompatible 9 · pending 8 · untested 2 · watching 57 — [details](PLUGINS-ALL.md#-学习研究104)
- **❓ 其他**（4035）— OK 1437 · incompatible 276 · pending 220 · untested 20 · watching 2082 — [details](PLUGINS-ALL.md#-其他4035)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260829T233001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.

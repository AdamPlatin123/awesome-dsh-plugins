...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2146-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1409-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-436-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-301-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **2146 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260827T164501Z` (2026-08-28 00:45:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15312 · age 197m"]
    ...
    C1 --> D1{"verdict · total 2146"}
    D1 -->|"1409 / 436"| E1["aggregate + README stats"]
    D1 -->|"301 env retries"| C1
...
- **🧠 记忆增强**（20）— OK 10 · incompatible 2 · pending 3 · untested 5 · watching 0 — [details](PLUGINS-ALL.md#-记忆增强20)
- **🎨 主题皮肤**（14）— OK 3 · incompatible 0 · pending 2 · untested 8 · watching 1 — [details](PLUGINS-ALL.md#-主题皮肤14)
- **🛒 市场与管理**（66）— OK 29 · incompatible 14 · pending 4 · untested 11 · watching 8 — [details](PLUGINS-ALL.md#-市场与管理66)
- **🔌 Web UI 增强**（511）— OK 293 · incompatible 106 · pending 54 · untested 32 · watching 26 — [details](PLUGINS-ALL.md#-web-ui-增强511)
- **💻 编码开发**（426）— OK 213 · incompatible 74 · pending 65 · untested 39 · watching 35 — [details](PLUGINS-ALL.md#-编码开发426)
- **🤖 Agent 能力**（355）— OK 164 · incompatible 90 · pending 53 · untested 19 · watching 29 — [details](PLUGINS-ALL.md#-agent-能力355)
- **📡 消息通讯**（134）— OK 70 · incompatible 36 · pending 16 · untested 4 · watching 8 — [details](PLUGINS-ALL.md#-消息通讯134)
- **🗂 文件数据**（110）— OK 52 · incompatible 21 · pending 19 · untested 12 · watching 6 — [details](PLUGINS-ALL.md#-文件数据110)
- **🎮 娱乐生活**（63）— OK 38 · incompatible 11 · pending 6 · untested 1 · watching 7 — [details](PLUGINS-ALL.md#-娱乐生活63)
- **🛠 基建部署**（278）— OK 132 · incompatible 64 · pending 48 · untested 6 · watching 28 — [details](PLUGINS-ALL.md#-基建部署278)
- **📚 学习研究**（19）— OK 8 · incompatible 6 · pending 0 · untested 2 · watching 3 — [details](PLUGINS-ALL.md#-学习研究19)
- **❓ 其他**（739）— OK 356 · incompatible 157 · pending 64 · untested 45 · watching 117 — [details](PLUGINS-ALL.md#-其他739)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T164501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260827T164501Z（2026-08-28 00:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1409 可用 · 436 不兼容 · 301 待定（共 2146 个，k8s agent 口径）|

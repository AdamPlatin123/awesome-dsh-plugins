...
[![confirmed](https://img.shields.io/badge/confirmed-5118-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-6151-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-4100-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-1345-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-706-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **5118 plugin repos indexed** (manifest-level classification, v2 engine), **6151 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T101502Z` (2026-08-28 18:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15618 · age 72m"]
    ...
    B1 -->|"plugins 5118"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 6151"}
    D1 -->|"4100 / 1345"| E1["aggregate + README stats"]
    D1 -->|"706 env retries"| C1
...
- **🛒 市场与管理**（163）— OK 66 · incompatible 16 · pending 11 · untested 8 · watching 62 — [details](PLUGINS-ALL.md#-市场与管理163)
- **🔌 Web UI 增强**（1306）— OK 735 · incompatible 226 · pending 129 · untested 22 · watching 194 — [details](PLUGINS-ALL.md#-web-ui-增强1306)
- **💻 编码开发**（967）— OK 498 · incompatible 177 · pending 114 · untested 21 · watching 157 — [details](PLUGINS-ALL.md#-编码开发967)
- **🤖 Agent 能力**（838）— OK 388 · incompatible 141 · pending 100 · untested 12 · watching 197 — [details](PLUGINS-ALL.md#-agent-能力838)
- **📡 消息通讯**（323）— OK 140 · incompatible 67 · pending 33 · untested 3 · watching 80 — [details](PLUGINS-ALL.md#-消息通讯323)
- **🗂 文件数据**（286）— OK 130 · incompatible 54 · pending 36 · untested 9 · watching 57 — [details](PLUGINS-ALL.md#-文件数据286)
- **🎮 娱乐生活**（172）— OK 89 · incompatible 13 · pending 20 · untested 0 · watching 50 — [details](PLUGINS-ALL.md#-娱乐生活172)
- **🛠 基建部署**（660）— OK 272 · incompatible 86 · pending 95 · untested 3 · watching 204 — [details](PLUGINS-ALL.md#-基建部署660)
- **📚 学习研究**（63）— OK 19 · incompatible 5 · pending 3 · untested 2 · watching 34 — [details](PLUGINS-ALL.md#-学习研究63)
- **❓ 其他**（2012）— OK 668 · incompatible 182 · pending 143 · untested 21 · watching 998 — [details](PLUGINS-ALL.md#-其他2012)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T101502Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T101502Z（2026-08-28 18:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 4100 可用 · 1345 不兼容 · 706 待定（共 6151 个，k8s agent 口径）|

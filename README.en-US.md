...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-1871-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1079-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-663-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-129-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **1871 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260819T021501Z` (2026-08-19 10:15:01 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 9322 · age 97m"]
    ...
    C1 --> D1{"verdict · total 1871"}
    D1 -->|"1079 / 663"| E1["aggregate + README stats"]
    D1 -->|"129 env retries"| C1
...
- **🎓 技能包**（27）— OK 6 · incompatible 1 · pending 1 · untested 18 · watching 1 — [details](PLUGINS-ALL.md#-技能包27)
- **🧠 记忆增强**（19）— OK 7 · incompatible 4 · pending 2 · untested 6 · watching 0 — [details](PLUGINS-ALL.md#-记忆增强19)
- **🎨 主题皮肤**（13）— OK 2 · incompatible 1 · pending 2 · untested 8 · watching 0 — [details](PLUGINS-ALL.md#-主题皮肤13)
- **🛒 市场与管理**（57）— OK 22 · incompatible 12 · pending 2 · untested 11 · watching 10 — [details](PLUGINS-ALL.md#-市场与管理57)
- **🔌 Web UI 增强**（445）— OK 243 · incompatible 86 · pending 43 · untested 38 · watching 35 — [details](PLUGINS-ALL.md#-web-ui-增强445)
- **💻 编码开发**（388）— OK 179 · incompatible 72 · pending 39 · untested 55 · watching 43 — [details](PLUGINS-ALL.md#-编码开发388)
- **🤖 Agent 能力**（328）— OK 139 · incompatible 75 · pending 31 · untested 31 · watching 52 — [details](PLUGINS-ALL.md#-agent-能力328)
- **📡 消息通讯**（118）— OK 61 · incompatible 26 · pending 14 · untested 8 · watching 9 — [details](PLUGINS-ALL.md#-消息通讯118)
- **🗂 文件数据**（102）— OK 47 · incompatible 18 · pending 15 · untested 15 · watching 7 — [details](PLUGINS-ALL.md#-文件数据102)
- **🎮 娱乐生活**（56）— OK 31 · incompatible 10 · pending 7 · untested 2 · watching 6 — [details](PLUGINS-ALL.md#-娱乐生活56)
- **🛠 基建部署**（228）— OK 89 · incompatible 77 · pending 22 · untested 8 · watching 32 — [details](PLUGINS-ALL.md#-基建部署228)
- **📚 学习研究**（18）— OK 5 · incompatible 4 · pending 1 · untested 3 · watching 5 — [details](PLUGINS-ALL.md#-学习研究18)
- **❓ 其他**（658）— OK 276 · incompatible 123 · pending 42 · untested 63 · watching 154 — [details](PLUGINS-ALL.md#-其他658)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260819T021501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260819T021501Z（2026-08-19 10:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1079 可用 · 663 不兼容 · 129 待定（共 1871 个，k8s agent 口径）|

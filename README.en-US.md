...
[![confirmed](https://img.shields.io/badge/confirmed-8144-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-11401-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_7609-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1328-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2570-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8144 plugin repos indexed** (manifest-level classification, v2 engine), **11401 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260830T003001Z` (2026-08-30 08:30:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 16357 · age 201m"]
    ...
    B1 -->|"plugins 8144"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 11401"}
    D1 -->|"7609 / 2570"| E1["aggregate + README stats"]
    D1 -->|"1222 env retries"| C1
...
- **🛒 市场与管理**（230）— OK 92 · incompatible 20 · pending 14 · untested 7 · watching 97 — [details](PLUGINS-ALL.md#-市场与管理230)
- **🔌 Web UI 增强**（2140）— OK 1177 · incompatible 381 · pending 192 · untested 16 · watching 374 — [details](PLUGINS-ALL.md#-web-ui-增强2140)
- **💻 编码开发**（1625）— OK 810 · incompatible 313 · pending 151 · untested 18 · watching 333 — [details](PLUGINS-ALL.md#-编码开发1625)
- **🤖 Agent 能力**（1582）— OK 712 · incompatible 290 · pending 140 · untested 10 · watching 430 — [details](PLUGINS-ALL.md#-agent-能力1582)
- **📡 消息通讯**（543）— OK 221 · incompatible 122 · pending 43 · untested 3 · watching 154 — [details](PLUGINS-ALL.md#-消息通讯543)
- **🗂 文件数据**（482）— OK 227 · incompatible 81 · pending 45 · untested 9 · watching 120 — [details](PLUGINS-ALL.md#-文件数据482)
- **🎮 娱乐生活**（314）— OK 147 · incompatible 28 · pending 28 · untested 0 · watching 111 — [details](PLUGINS-ALL.md#-娱乐生活314)
- **🛠 基建部署**（1011）— OK 399 · incompatible 119 · pending 128 · untested 3 · watching 362 — [details](PLUGINS-ALL.md#-基建部署1011)
- **📚 学习研究**（106）— OK 29 · incompatible 9 · pending 8 · untested 2 · watching 58 — [details](PLUGINS-ALL.md#-学习研究106)
- **❓ 其他**（4121）— OK 1478 · incompatible 288 · pending 221 · untested 20 · watching 2114 — [details](PLUGINS-ALL.md#-其他4121)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260830T003001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260830T003001Z（2026-08-30 08:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 7609 可用 · 2570 不兼容 · 1222 待定（共 11401 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-8444-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-11935-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_7987-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1359-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2695-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8444 plugin repos indexed** (manifest-level classification, v2 engine), **11935 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260831T120001Z` (2026-08-31 20:00:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 16959 · age 168m"]
    ...
    B1 -->|"plugins 8444"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 11935"}
    D1 -->|"7987 / 2695"| E1["aggregate + README stats"]
    D1 -->|"1253 env retries"| C1
    E1 --> E2["cadence deliver<br/>delta this cycle —/100<br/>dual-repo bot PRs (idempotent)"]
    M["radar-probe every 15 min self-heal<br/>7 metric streams × 60s · done 13"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🛒 市场与管理**（239）— OK 93 · incompatible 19 · pending 15 · untested 7 · watching 105 — [details](PLUGINS-ALL.md#-市场与管理239)
- **🔌 Web UI 增强**（2229）— OK 1225 · incompatible 396 · pending 198 · untested 16 · watching 394 — [details](PLUGINS-ALL.md#-web-ui-增强2229)
- **💻 编码开发**（1693）— OK 842 · incompatible 326 · pending 154 · untested 18 · watching 353 — [details](PLUGINS-ALL.md#-编码开发1693)
- **🤖 Agent 能力**（1659）— OK 744 · incompatible 306 · pending 144 · untested 10 · watching 455 — [details](PLUGINS-ALL.md#-agent-能力1659)
- **📡 消息通讯**（555）— OK 226 · incompatible 125 · pending 45 · untested 3 · watching 156 — [details](PLUGINS-ALL.md#-消息通讯555)
- **🗂 文件数据**（502）— OK 237 · incompatible 88 · pending 46 · untested 9 · watching 122 — [details](PLUGINS-ALL.md#-文件数据502)
- **🎮 娱乐生活**（333）— OK 156 · incompatible 28 · pending 29 · untested 0 · watching 120 — [details](PLUGINS-ALL.md#-娱乐生活333)
- **🛠 基建部署**（1044）— OK 410 · incompatible 128 · pending 127 · untested 3 · watching 376 — [details](PLUGINS-ALL.md#-基建部署1044)
- **📚 学习研究**（109）— OK 30 · incompatible 9 · pending 8 · untested 2 · watching 60 — [details](PLUGINS-ALL.md#-学习研究109)
- **❓ 其他**（4444）— OK 1605 · incompatible 296 · pending 224 · untested 20 · watching 2299 — [details](PLUGINS-ALL.md#-其他4444)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260831T120001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.

...
[![confirmed](https://img.shields.io/badge/confirmed-396-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12914-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8754-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1554-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2716-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **396 plugin repos indexed** (manifest-level classification, v2 engine), **12914 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260903T183001Z` (2026-09-04 02:30:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17870 · age 61m"]
    ...
    B1 -->|"plugins 396"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12914"}
    D1 -->|"8754 / 2716"| E1["aggregate + README stats"]
...
- **🛒 市场与管理**（304）— OK 100 · incompatible 21 · pending 15 · untested 8 · watching 160 — [details](PLUGINS-ALL.md#-市场与管理304)
- **🔌 Web UI 增强**（2705）— OK 1319 · incompatible 402 · pending 227 · untested 16 · watching 741 — [details](PLUGINS-ALL.md#-web-ui-增强2705)
- **💻 编码开发**（2093）— OK 918 · incompatible 350 · pending 163 · untested 19 · watching 643 — [details](PLUGINS-ALL.md#-编码开发2093)
- **🤖 Agent 能力**（2187）— OK 797 · incompatible 269 · pending 154 · untested 10 · watching 957 — [details](PLUGINS-ALL.md#-agent-能力2187)
- **📡 消息通讯**（702）— OK 240 · incompatible 129 · pending 51 · untested 3 · watching 279 — [details](PLUGINS-ALL.md#-消息通讯702)
- **🗂 文件数据**（658）— OK 271 · incompatible 92 · pending 47 · untested 9 · watching 239 — [details](PLUGINS-ALL.md#-文件数据658)
- **🎮 娱乐生活**（448）— OK 176 · incompatible 31 · pending 30 · untested 0 · watching 211 — [details](PLUGINS-ALL.md#-娱乐生活448)
- **🛠 基建部署**（1330）— OK 438 · incompatible 131 · pending 119 · untested 3 · watching 639 — [details](PLUGINS-ALL.md#-基建部署1330)
- **📚 学习研究**（150）— OK 34 · incompatible 9 · pending 7 · untested 2 · watching 98 — [details](PLUGINS-ALL.md#-学习研究150)
- **❓ 其他**（6983）— OK 1820 · incompatible 317 · pending 244 · untested 21 · watching 4581 — [details](PLUGINS-ALL.md#-其他6983)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260903T183001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260903T183001Z（2026-09-04 02:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8754 可用 · 2716 不兼容 · 1444 待定（共 12914 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-3734-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-4001-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-2631-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-889-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-481-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **3734 plugin repos indexed** (manifest-level classification, v2 engine), **4001 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T034501Z` (2026-08-28 11:45:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15484 · age 163m"]
    ...
    B1 -->|"plugins 3734"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 4001"}
    D1 -->|"2631 / 889"| E1["aggregate + README stats"]
    D1 -->|"481 env retries"| C1
...
- **🛒 市场与管理**（123）— OK 50 · incompatible 17 · pending 9 · untested 9 · watching 38 — [details](PLUGINS-ALL.md#-市场与管理123)
- **🔌 Web UI 增强**（900）— OK 489 · incompatible 176 · pending 88 · untested 26 · watching 121 — [details](PLUGINS-ALL.md#-web-ui-增强900)
- **💻 编码开发**（715）— OK 360 · incompatible 133 · pending 87 · untested 25 · watching 110 — [details](PLUGINS-ALL.md#-编码开发715)
- **🤖 Agent 能力**（573）— OK 263 · incompatible 113 · pending 81 · untested 14 · watching 102 — [details](PLUGINS-ALL.md#-agent-能力573)
- **📡 消息通讯**（225）— OK 96 · incompatible 59 · pending 30 · untested 3 · watching 37 — [details](PLUGINS-ALL.md#-消息通讯225)
- **🗂 文件数据**（190）— OK 79 · incompatible 40 · pending 28 · untested 11 · watching 32 — [details](PLUGINS-ALL.md#-文件数据190)
- **🎮 娱乐生活**（121）— OK 65 · incompatible 10 · pending 15 · untested 1 · watching 30 — [details](PLUGINS-ALL.md#-娱乐生活121)
- **🛠 基建部署**（498）— OK 205 · incompatible 79 · pending 77 · untested 4 · watching 133 — [details](PLUGINS-ALL.md#-基建部署498)
- **📚 学习研究**（38）— OK 12 · incompatible 4 · pending 2 · untested 2 · watching 18 — [details](PLUGINS-ALL.md#-学习研究38)
- **❓ 其他**（1417）— OK 480 · incompatible 193 · pending 120 · untested 26 · watching 598 — [details](PLUGINS-ALL.md#-其他1417)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T034501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T034501Z（2026-08-28 11:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 2631 可用 · 889 不兼容 · 481 待定（共 4001 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-9082-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12600-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8482-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1551-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2675-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **9082 plugin repos indexed** (manifest-level classification, v2 engine), **12600 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260902T133001Z` (2026-09-02 21:30:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17578 · age 264m"]
    ...
    B1 -->|"plugins 9082"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12600"}
    D1 -->|"8482 / 2675"| E1["aggregate + README stats"]
    D1 -->|"1443 env retries"| C1
    E1 --> E2["cadence deliver<br/>delta this cycle —/100<br/>dual-repo bot PRs (idempotent)"]
    M["radar-probe every 15 min self-heal<br/>7 metric streams × 60s · done 46"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
> 人工策展 56 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-02 19:27（UTC+8）。

### 🚀 智力增强 Booster（7）

- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7025★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[ouroboros](https://github.com/Q00/ouroboros)** · 5752★ — Agent OS：agent 自我变强、人只守底线——自进化运行时（5.7k★；rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[superpowers-dsh](https://github.com/LayneChai/superpowers-dsh)** · 115★ — TDD/调试/计划等开发技能集
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui)** · 6712★ — Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar)** · 3236★ — 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-genui](https://github.com/omdsh-dev/dsh-genui)** · 389★ — GenUI 内联组件：图表/表单/测验/3D 场景 + action 事件环
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-annotation](https://github.com/omdsh-dev/dsh-annotation)** · 106★ — 划选文字→批注→随消息发送，回复逐条对照
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 22932★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop)** · 1569★ — Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[modlens](https://github.com/liustack/modlens)** · 3834★ — 生态第一个视觉插件，视觉工作流的基准方案
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit)** · 1135★ — 通用 agent 视觉工具箱：多图理解/图片问答/前端 UI 还原/GUI 自动化（dsh-vision-toolkit 同作者）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-vision-router](https://github.com/ysr666/dsh-vision-router)** · 1051★ — 内置免费视觉模型路由，给文本 agent 装眼睛
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[distilly](https://github.com/titanwings/distilly)** · 24266★ — 把专家思维蒸馏为可复用 Skills 的平台（24k★，Agent 域之最，原名 colleague-skill；雷达判可用）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams)** · 1279★ — 多代理团队编排
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[rea](https://github.com/morluto/rea)** · 390★ — 用 agent 逆向工程任何东西：从应用行为到原生二进制
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[TokenTracker](https://github.com/xiufengsun/TokenTracker)** · 1494★ — 本地优先的 31 种编码工具 token 用量与成本追踪
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[EverOS](https://github.com/EverMind-AI/EverOS)** · 12642★ — 全 agent 便携记忆层：本地优先、Markdown-native（12.4k★ 记忆域之最；rc.8 实测 ✅）
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[mnemon](https://github.com/mnemon-dev/mnemon)** · 546★ — 跨 agent、本地优先的持久记忆
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-browser](https://github.com/Lum1104/dsh-browser)** · 556★ — Chrome 侧栏扩展，让 DSH 直接操作浏览器
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil)** · 160★ — OpenPencil 设计稿预览与编辑
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-market](https://github.com/dsh-market/dsh-market)** · 3040★ — 持续收录 1000+ 插件的市场：中文搜索 + 五维评分
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[petdex](https://github.com/crafter-station/petdex)** · 4026★ — 生态最高星桌宠图鉴
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale)** · 1882★ — 深海鲸鱼养成
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[openpets](https://github.com/alvinunreal/openpets)** · 1152★ — 本地优先桌面伴侣平台：动画宠物 + 插件 SDK（娱乐域第二位）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-ads](https://github.com/Nagi-ovo/dsh-ads)** · 598★ — 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[whale-girl](https://github.com/vlln/whale-girl)** · 304★ — QQ 宠物形态桌宠：可拖拽/投喂/玩耍
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-02 19:27（UTC+8）。
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7025★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + P1-P23 任务感知推理模式路由（rc.8 实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard)** · 3820★ — 两阶段预设：极简模式对齐启动 → 全量装载（rc.8 实测 ✅）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[DeepSec](https://github.com/Unclecheng-li/DeepSec)** · 374★ — AI 安全攻防一体化合集：Android · Web · Native · 协议 · 恶意代码 · AI 六域
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[superpowers-dsh](https://github.com/LayneChai/superpowers-dsh)** · 115★ — TDD/调试/计划等开发技能集（rc.8 实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill)** · 113★ — 完整逆向工程技能合集（85 个 SKILL.md）
...
- **🎓 技能包**（26）— OK 7 · incompatible 1 · pending 4 · untested 11 · watching 3 — [details](PLUGINS-ALL.md#-技能包26)
- **🧠 记忆增强**（35）— OK 14 · incompatible 4 · pending 5 · untested 2 · watching 10 — [details](PLUGINS-ALL.md#-记忆增强35)
- **🎨 主题皮肤**（18）— OK 8 · incompatible 0 · pending 2 · untested 5 · watching 3 — [details](PLUGINS-ALL.md#-主题皮肤18)
- **🛒 市场与管理**（246）— OK 96 · incompatible 19 · pending 16 · untested 7 · watching 108 — [details](PLUGINS-ALL.md#-市场与管理246)
- **🔌 Web UI 增强**（2341）— OK 1293 · incompatible 383 · pending 227 · untested 16 · watching 422 — [details](PLUGINS-ALL.md#-web-ui-增强2341)
- **💻 编码开发**（1809）— OK 891 · incompatible 340 · pending 177 · untested 19 · watching 382 — [details](PLUGINS-ALL.md#-编码开发1809)
- **🤖 Agent 能力**（1694）— OK 752 · incompatible 276 · pending 167 · untested 10 · watching 489 — [details](PLUGINS-ALL.md#-agent-能力1694)
- **📡 消息通讯**（574）— OK 238 · incompatible 122 · pending 51 · untested 3 · watching 160 — [details](PLUGINS-ALL.md#-消息通讯574)
- **🗂 文件数据**（545）— OK 256 · incompatible 97 · pending 48 · untested 9 · watching 135 — [details](PLUGINS-ALL.md#-文件数据545)
- **🎮 娱乐生活**（358）— OK 172 · incompatible 28 · pending 28 · untested 0 · watching 130 — [details](PLUGINS-ALL.md#-娱乐生活358)
- **🛠 基建部署**（1077）— OK 424 · incompatible 126 · pending 133 · untested 3 · watching 391 — [details](PLUGINS-ALL.md#-基建部署1077)
- **📚 学习研究**（117）— OK 33 · incompatible 9 · pending 7 · untested 2 · watching 66 — [details](PLUGINS-ALL.md#-学习研究117)
- **❓ 其他**（4895）— OK 1759 · incompatible 304 · pending 238 · untested 21 · watching 2573 — [details](PLUGINS-ALL.md#-其他4895)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260902T133001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260902T133001Z（2026-09-02 21:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8482 可用 · 2675 不兼容 · 1443 待定（共 12600 个，k8s agent 口径）|

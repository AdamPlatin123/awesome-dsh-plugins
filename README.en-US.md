...
[![confirmed](https://img.shields.io/badge/confirmed-3159-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-3364-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-2200-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-741-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-423-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **3159 plugin repos indexed** (manifest-level classification, v2 engine), **3364 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T014501Z` (2026-08-28 09:45:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15484 · age 42m"]
    ...
    B1 -->|"plugins 3159"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 3364"}
    D1 -->|"2200 / 741"| E1["aggregate + README stats"]
    D1 -->|"423 env retries"| C1
...
- **🔌 Web UI 增强**（771）— OK 426 · incompatible 149 · pending 83 · untested 26 · watching 87 — [details](PLUGINS-ALL.md#-web-ui-增强771)
- **💻 编码开发**（624）— OK 314 · incompatible 114 · pending 81 · untested 27 · watching 88 — [details](PLUGINS-ALL.md#-编码开发624)
- **🤖 Agent 能力**（498）— OK 230 · incompatible 105 · pending 75 · untested 14 · watching 74 — [details](PLUGINS-ALL.md#-agent-能力498)
- **📡 消息通讯**（200）— OK 88 · incompatible 54 · pending 30 · untested 3 · watching 25 — [details](PLUGINS-ALL.md#-消息通讯200)
- **🗂 文件数据**（169）— OK 72 · incompatible 34 · pending 28 · untested 11 · watching 24 — [details](PLUGINS-ALL.md#-文件数据169)
- **🎮 娱乐生活**（103）— OK 56 · incompatible 9 · pending 13 · untested 1 · watching 24 — [details](PLUGINS-ALL.md#-娱乐生活103)
- **🛠 基建部署**（438）— OK 184 · incompatible 76 · pending 72 · untested 4 · watching 102 — [details](PLUGINS-ALL.md#-基建部署438)
- **📚 学习研究**（35）— OK 12 · incompatible 4 · pending 2 · untested 2 · watching 15 — [details](PLUGINS-ALL.md#-学习研究35)
- **❓ 其他**（1215）— OK 437 · incompatible 176 · pending 118 · untested 26 · watching 458 — [details](PLUGINS-ALL.md#-其他1215)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T014501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.

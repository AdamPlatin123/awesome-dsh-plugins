...
[![confirmed](https://img.shields.io/badge/confirmed-8523-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12036-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8062-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1363-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2717-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8523 plugin repos indexed** (manifest-level classification, v2 engine), **12036 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260831T123001Z` (2026-08-31 20:30:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 16959 · age 198m"]
    ...
    B1 -->|"plugins 8523"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12036"}
    D1 -->|"8062 / 2717"| E1["aggregate + README stats"]
    D1 -->|"1257 env retries"| C1
    E1 --> E2["cadence deliver<br/>delta this cycle —/100<br/>dual-repo bot PRs (idempotent)"]
    M["radar-probe every 15 min self-heal<br/>7 metric streams × 60s · done 23"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🛒 市场与管理**（240）— OK 93 · incompatible 19 · pending 15 · untested 7 · watching 106 — [details](PLUGINS-ALL.md#-市场与管理240)
- **🔌 Web UI 增强**（2239）— OK 1231 · incompatible 399 · pending 199 · untested 16 · watching 394 — [details](PLUGINS-ALL.md#-web-ui-增强2239)
- **💻 编码开发**（1703）— OK 847 · incompatible 328 · pending 154 · untested 18 · watching 356 — [details](PLUGINS-ALL.md#-编码开发1703)
- **🤖 Agent 能力**（1665）— OK 745 · incompatible 308 · pending 144 · untested 10 · watching 458 — [details](PLUGINS-ALL.md#-agent-能力1665)
- **📡 消息通讯**（560）— OK 229 · incompatible 126 · pending 46 · untested 3 · watching 156 — [details](PLUGINS-ALL.md#-消息通讯560)
...
- **📚 学习研究**（111）— OK 30 · incompatible 9 · pending 8 · untested 2 · watching 62 — [details](PLUGINS-ALL.md#-学习研究111)
- **❓ 其他**（4499）— OK 1644 · incompatible 296 · pending 225 · untested 20 · watching 2314 — [details](PLUGINS-ALL.md#-其他4499)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260831T123001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260831T123001Z（2026-08-31 20:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8062 可用 · 2717 不兼容 · 1257 待定（共 12036 个，k8s agent 口径）|

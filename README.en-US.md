...
[![confirmed](https://img.shields.io/badge/confirmed-4601-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-5134-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-3402-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-1119-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-613-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **4601 plugin repos indexed** (manifest-level classification, v2 engine), **5134 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T080001Z` (2026-08-28 16:00:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15576 · age 153m"]
    ...
    C1 --> D1{"verdict · total 5134"}
    D1 -->|"3402 / 1119"| E1["aggregate + README stats"]
...
- **🔌 Web UI 增强**（1133）— OK 613 · incompatible 219 · pending 114 · untested 25 · watching 162 — [details](PLUGINS-ALL.md#-web-ui-增强1133)
- **💻 编码开发**（871）— OK 435 · incompatible 169 · pending 103 · untested 22 · watching 142 — [details](PLUGINS-ALL.md#-编码开发871)
- **🤖 Agent 能力**（720）— OK 326 · incompatible 133 · pending 94 · untested 13 · watching 154 — [details](PLUGINS-ALL.md#-agent-能力720)
- **📡 消息通讯**（283）— OK 118 · incompatible 71 · pending 31 · untested 3 · watching 60 — [details](PLUGINS-ALL.md#-消息通讯283)
- **🗂 文件数据**（242）— OK 105 · incompatible 47 · pending 33 · untested 10 · watching 47 — [details](PLUGINS-ALL.md#-文件数据242)
- **🎮 娱乐生活**（146）— OK 75 · incompatible 12 · pending 17 · untested 1 · watching 41 — [details](PLUGINS-ALL.md#-娱乐生活146)
- **🛠 基建部署**（577）— OK 234 · incompatible 85 · pending 85 · untested 4 · watching 169 — [details](PLUGINS-ALL.md#-基建部署577)
- **📚 学习研究**（54）— OK 17 · incompatible 5 · pending 3 · untested 2 · watching 27 — [details](PLUGINS-ALL.md#-学习研究54)
- **❓ 其他**（1744）— OK 561 · incompatible 207 · pending 132 · untested 23 · watching 821 — [details](PLUGINS-ALL.md#-其他1744)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T080001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T080001Z（2026-08-28 16:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 3402 可用 · 1119 不兼容 · 613 待定（共 5134 个，k8s agent 口径）|

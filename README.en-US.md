...
[![confirmed](https://img.shields.io/badge/confirmed-8779-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12285-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8264-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1510-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2619-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8779 plugin repos indexed** (manifest-level classification, v2 engine), **12285 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260902T030001Z` (2026-09-02 11:00:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17519 · age 113m"]
    ...
    B1 -->|"plugins 8779"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12285"}
    D1 -->|"8264 / 2619"| E1["aggregate + README stats"]
    D1 -->|"1402 env retries"| C1
...
- **🔌 Web UI 增强**（2283）— OK 1259 · incompatible 377 · pending 221 · untested 16 · watching 410 — [details](PLUGINS-ALL.md#-web-ui-增强2283)
- **💻 编码开发**（1749）— OK 862 · incompatible 329 · pending 170 · untested 19 · watching 369 — [details](PLUGINS-ALL.md#-编码开发1749)
- **🤖 Agent 能力**（1700）— OK 766 · incompatible 290 · pending 162 · untested 10 · watching 472 — [details](PLUGINS-ALL.md#-agent-能力1700)
- **📡 消息通讯**（565）— OK 233 · incompatible 120 · pending 50 · untested 3 · watching 159 — [details](PLUGINS-ALL.md#-消息通讯565)
- **🗂 文件数据**（515）— OK 242 · incompatible 83 · pending 49 · untested 9 · watching 132 — [details](PLUGINS-ALL.md#-文件数据515)
- **🎮 娱乐生活**（340）— OK 160 · incompatible 25 · pending 28 · untested 0 · watching 127 — [details](PLUGINS-ALL.md#-娱乐生活340)
- **🛠 基建部署**（1059）— OK 416 · incompatible 125 · pending 133 · untested 3 · watching 382 — [details](PLUGINS-ALL.md#-基建部署1059)
- **📚 学习研究**（113）— OK 32 · incompatible 9 · pending 7 · untested 2 · watching 63 — [details](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4703）— OK 1702 · incompatible 293 · pending 235 · untested 21 · watching 2452 — [details](PLUGINS-ALL.md#-其他4703)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260902T030001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260902T030001Z（2026-09-02 11:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8264 可用 · 2619 不兼容 · 1402 待定（共 12285 个，k8s agent 口径）|

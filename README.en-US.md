...
[![confirmed](https://img.shields.io/badge/confirmed-3022-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2803-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1828-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-631-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-344-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **3022 plugin repos indexed** (manifest-level classification, v2 engine), **2803 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T001501Z` (2026-08-28 08:15:01 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15459 · age 187m"]
    ...
    B1 -->|"plugins 3022"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 2803"}
    D1 -->|"1828 / 631"| E1["aggregate + README stats"]
    D1 -->|"344 env retries"| C1
...
- **🎓 技能包**（27）— OK 6 · incompatible 1 · pending 3 · untested 14 · watching 3 — [details](PLUGINS-ALL.md#-技能包27)
- **🧠 记忆增强**（22）— OK 11 · incompatible 2 · pending 3 · untested 4 · watching 2 — [details](PLUGINS-ALL.md#-记忆增强22)
- **🎨 主题皮肤**（14）— OK 4 · incompatible 0 · pending 2 · untested 7 · watching 1 — [details](PLUGINS-ALL.md#-主题皮肤14)
- **🛒 市场与管理**（99）— OK 43 · incompatible 14 · pending 7 · untested 10 · watching 25 — [details](PLUGINS-ALL.md#-市场与管理99)
- **🔌 Web UI 增强**（679）— OK 376 · incompatible 140 · pending 76 · untested 28 · watching 59 — [details](PLUGINS-ALL.md#-web-ui-增强679)
- **💻 编码开发**（541）— OK 276 · incompatible 100 · pending 77 · untested 27 · watching 61 — [details](PLUGINS-ALL.md#-编码开发541)
- **🤖 Agent 能力**（437）— OK 202 · incompatible 97 · pending 68 · untested 15 · watching 55 — [details](PLUGINS-ALL.md#-agent-能力437)
- **📡 消息通讯**（175）— OK 77 · incompatible 50 · pending 27 · untested 3 · watching 18 — [details](PLUGINS-ALL.md#-消息通讯175)
- **🗂 文件数据**（143）— OK 61 · incompatible 25 · pending 27 · untested 12 · watching 18 — [details](PLUGINS-ALL.md#-文件数据143)
- **🎮 娱乐生活**（87）— OK 51 · incompatible 8 · pending 10 · untested 1 · watching 17 — [details](PLUGINS-ALL.md#-娱乐生活87)
- **🛠 基建部署**（375）— OK 163 · incompatible 70 · pending 64 · untested 4 · watching 74 — [details](PLUGINS-ALL.md#-基建部署375)
- **📚 学习研究**（27）— OK 10 · incompatible 4 · pending 1 · untested 2 · watching 10 — [details](PLUGINS-ALL.md#-学习研究27)
- **❓ 其他**（1049）— OK 420 · incompatible 163 · pending 112 · untested 26 · watching 328 — [details](PLUGINS-ALL.md#-其他1049)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T001501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T001501Z（2026-08-28 08:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 1828 可用 · 631 不兼容 · 344 待定（共 2803 个，k8s agent 口径）|

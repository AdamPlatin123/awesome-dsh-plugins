...
[![confirmed](https://img.shields.io/badge/confirmed-8663-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12168-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8179-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1494-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2603-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8663 plugin repos indexed** (manifest-level classification, v2 engine), **12168 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260902T011501Z` (2026-09-02 09:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17519 · age 9m"]
    ...
    B1 -->|"plugins 8663"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12168"}
    D1 -->|"8179 / 2603"| E1["aggregate + README stats"]
    D1 -->|"1386 env retries"| C1
...
- **🔌 Web UI 增强**（2264）— OK 1248 · incompatible 376 · pending 220 · untested 16 · watching 404 — [details](PLUGINS-ALL.md#-web-ui-增强2264)
- **💻 编码开发**（1736）— OK 854 · incompatible 328 · pending 169 · untested 19 · watching 366 — [details](PLUGINS-ALL.md#-编码开发1736)
- **🤖 Agent 能力**（1687）— OK 759 · incompatible 290 · pending 161 · untested 10 · watching 467 — [details](PLUGINS-ALL.md#-agent-能力1687)
- **📡 消息通讯**（561）— OK 233 · incompatible 119 · pending 49 · untested 3 · watching 157 — [details](PLUGINS-ALL.md#-消息通讯561)
- **🗂 文件数据**（511）— OK 242 · incompatible 82 · pending 48 · untested 9 · watching 130 — [details](PLUGINS-ALL.md#-文件数据511)
- **🎮 娱乐生活**（338）— OK 159 · incompatible 25 · pending 28 · untested 0 · watching 126 — [details](PLUGINS-ALL.md#-娱乐生活338)
- **🛠 基建部署**（1053）— OK 415 · incompatible 125 · pending 132 · untested 3 · watching 378 — [details](PLUGINS-ALL.md#-基建部署1053)
- **📚 学习研究**（113）— OK 32 · incompatible 9 · pending 7 · untested 2 · watching 63 — [details](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4648）— OK 1672 · incompatible 292 · pending 233 · untested 21 · watching 2430 — [details](PLUGINS-ALL.md#-其他4648)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260902T011501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260902T011501Z（2026-09-02 09:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8179 可用 · 2603 不兼容 · 1386 待定（共 12168 个，k8s agent 口径）|

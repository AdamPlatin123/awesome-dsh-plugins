...
[![confirmed](https://img.shields.io/badge/confirmed-3080-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-3265-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-2135-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-720-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-410-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **3080 plugin repos indexed** (manifest-level classification, v2 engine), **3265 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T013001Z` (2026-08-28 09:30:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15484 · age 28m"]
    ...
    B1 -->|"plugins 3080"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 3265"}
    D1 -->|"2135 / 720"| E1["aggregate + README stats"]
    D1 -->|"410 env retries"| C1
...
- **🎓 技能包**（26）— OK 6 · incompatible 1 · pending 3 · untested 13 · watching 3 — [details](PLUGINS-ALL.md#-技能包26)
...
- **🛒 市场与管理**（112）— OK 47 · incompatible 16 · pending 8 · untested 10 · watching 31 — [details](PLUGINS-ALL.md#-市场与管理112)
- **🔌 Web UI 增强**（754）— OK 419 · incompatible 148 · pending 82 · untested 26 · watching 79 — [details](PLUGINS-ALL.md#-web-ui-增强754)
- **💻 编码开发**（609）— OK 306 · incompatible 111 · pending 80 · untested 27 · watching 85 — [details](PLUGINS-ALL.md#-编码开发609)
- **🤖 Agent 能力**（485）— OK 226 · incompatible 104 · pending 74 · untested 14 · watching 67 — [details](PLUGINS-ALL.md#-agent-能力485)
- **📡 消息通讯**（199）— OK 88 · incompatible 54 · pending 29 · untested 3 · watching 25 — [details](PLUGINS-ALL.md#-消息通讯199)
- **🗂 文件数据**（166）— OK 71 · incompatible 33 · pending 28 · untested 11 · watching 23 — [details](PLUGINS-ALL.md#-文件数据166)
- **🎮 娱乐生活**（101）— OK 55 · incompatible 9 · pending 13 · untested 1 · watching 23 — [details](PLUGINS-ALL.md#-娱乐生活101)
- **🛠 基建部署**（432）— OK 182 · incompatible 74 · pending 72 · untested 4 · watching 100 — [details](PLUGINS-ALL.md#-基建部署432)
- **📚 学习研究**（35）— OK 12 · incompatible 4 · pending 2 · untested 2 · watching 15 — [details](PLUGINS-ALL.md#-学习研究35)
- **❓ 其他**（1177）— OK 436 · incompatible 174 · pending 117 · untested 26 · watching 424 — [details](PLUGINS-ALL.md#-其他1177)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T013001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T013001Z（2026-08-28 09:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 2135 可用 · 720 不兼容 · 410 待定（共 3265 个，k8s agent 口径）|

...
> Data as of snapshot `20260827T000001Z` (2026-08-27 08:00:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 14975 · age 183m"]
...
- **🎓 技能包**（31）— OK 7 · incompatible 1 · pending 2 · untested 18 · watching 3 — [details](PLUGINS-ALL.md#-技能包31)
- **🧠 记忆增强**（18）— OK 6 · incompatible 5 · pending 2 · untested 5 · watching 0 — [details](PLUGINS-ALL.md#-记忆增强18)
- **🎨 主题皮肤**（13）— OK 3 · incompatible 1 · pending 1 · untested 8 · watching 0 — [details](PLUGINS-ALL.md#-主题皮肤13)
- **🛒 市场与管理**（65）— OK 26 · incompatible 18 · pending 3 · untested 11 · watching 7 — [details](PLUGINS-ALL.md#-市场与管理65)
- **🔌 Web UI 增强**（498）— OK 271 · incompatible 124 · pending 47 · untested 34 · watching 22 — [details](PLUGINS-ALL.md#-web-ui-增强498)
- **💻 编码开发**（414）— OK 192 · incompatible 99 · pending 46 · untested 44 · watching 33 — [details](PLUGINS-ALL.md#-编码开发414)
- **🤖 Agent 能力**（352）— OK 148 · incompatible 108 · pending 43 · untested 24 · watching 29 — [details](PLUGINS-ALL.md#-agent-能力352)
- **📡 消息通讯**（129）— OK 61 · incompatible 44 · pending 15 · untested 4 · watching 5 — [details](PLUGINS-ALL.md#-消息通讯129)
- **🗂 文件数据**（108）— OK 50 · incompatible 23 · pending 17 · untested 13 · watching 5 — [details](PLUGINS-ALL.md#-文件数据108)
- **🎮 娱乐生活**（62）— OK 34 · incompatible 14 · pending 7 · untested 1 · watching 6 — [details](PLUGINS-ALL.md#-娱乐生活62)
- **🛠 基建部署**（275）— OK 98 · incompatible 112 · pending 33 · untested 7 · watching 25 — [details](PLUGINS-ALL.md#-基建部署275)
- **📚 学习研究**（20）— OK 7 · incompatible 7 · pending 0 · untested 2 · watching 4 — [details](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（732）— OK 324 · incompatible 192 · pending 59 · untested 53 · watching 104 — [details](PLUGINS-ALL.md#-其他732)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T000001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260827T000001Z（2026-08-27 08:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1179 可用 · 874 不兼容 · 167 待定（共 2220 个，k8s agent 口径）|

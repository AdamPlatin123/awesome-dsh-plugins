...
[![confirmed](https://img.shields.io/badge/confirmed-8894-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12392-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8335-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1525-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2640-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8894 plugin repos indexed** (manifest-level classification, v2 engine), **12392 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260902T051501Z` (2026-09-02 13:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17519 · age 248m"]
    ...
    B1 -->|"plugins 8894"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12392"}
    D1 -->|"8335 / 2640"| E1["aggregate + README stats"]
    D1 -->|"1417 env retries"| C1
    E1 --> E2["cadence deliver<br/>delta this cycle —/100<br/>dual-repo bot PRs (idempotent)"]
    M["radar-probe every 15 min self-heal<br/>7 metric streams × 60s · done 39"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🛒 市场与管理**（244）— OK 95 · incompatible 19 · pending 16 · untested 7 · watching 107 — [details](PLUGINS-ALL.md#-市场与管理244)
- **🔌 Web UI 增强**（2300）— OK 1265 · incompatible 379 · pending 225 · untested 16 · watching 415 — [details](PLUGINS-ALL.md#-web-ui-增强2300)
- **💻 编码开发**（1766）— OK 873 · incompatible 330 · pending 172 · untested 19 · watching 372 — [details](PLUGINS-ALL.md#-编码开发1766)
- **🤖 Agent 能力**（1714）— OK 770 · incompatible 293 · pending 164 · untested 10 · watching 477 — [details](PLUGINS-ALL.md#-agent-能力1714)
- **📡 消息通讯**（566）— OK 234 · incompatible 120 · pending 50 · untested 3 · watching 159 — [details](PLUGINS-ALL.md#-消息通讯566)
- **🗂 文件数据**（519）— OK 246 · incompatible 83 · pending 49 · untested 9 · watching 132 — [details](PLUGINS-ALL.md#-文件数据519)
- **🎮 娱乐生活**（342）— OK 160 · incompatible 25 · pending 28 · untested 0 · watching 129 — [details](PLUGINS-ALL.md#-娱乐生活342)
- **🛠 基建部署**（1063）— OK 418 · incompatible 126 · pending 133 · untested 3 · watching 383 — [details](PLUGINS-ALL.md#-基建部署1063)
- **📚 学习研究**（113）— OK 32 · incompatible 9 · pending 7 · untested 2 · watching 63 — [details](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4750）— OK 1714 · incompatible 296 · pending 236 · untested 21 · watching 2483 — [details](PLUGINS-ALL.md#-其他4750)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260902T051501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260902T051501Z（2026-09-02 13:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8335 可用 · 2640 不兼容 · 1417 待定（共 12392 个，k8s agent 口径）|

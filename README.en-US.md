...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2093-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1146-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-806-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-141-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **2093 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260826T130001Z` (2026-08-26 21:00:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 14541 · age 965m"]
    ...
    C1 --> D1{"verdict · total 2093"}
    D1 -->|"1146 / 806"| E1["aggregate + README stats"]
    D1 -->|"141 env retries"| C1
...
- **🔌 Web UI 增强**（486）— OK 254 · incompatible 107 · pending 44 · untested 38 · watching 43 — [details](PLUGINS-ALL.md#-web-ui-增强486)
- **💻 编码开发**（410）— OK 184 · incompatible 86 · pending 41 · untested 52 · watching 47 — [details](PLUGINS-ALL.md#-编码开发410)
- **🤖 Agent 能力**（347）— OK 141 · incompatible 84 · pending 39 · untested 29 · watching 54 — [details](PLUGINS-ALL.md#-agent-能力347)
- **📡 消息通讯**（133）— OK 61 · incompatible 36 · pending 14 · untested 8 · watching 14 — [details](PLUGINS-ALL.md#-消息通讯133)
...
- **🛠 基建部署**（262）— OK 95 · incompatible 90 · pending 24 · untested 8 · watching 45 — [details](PLUGINS-ALL.md#-基建部署262)
- **📚 学习研究**（19）— OK 5 · incompatible 4 · pending 0 · untested 3 · watching 7 — [details](PLUGINS-ALL.md#-学习研究19)
- **❓ 其他**（723）— OK 283 · incompatible 136 · pending 45 · untested 60 · watching 199 — [details](PLUGINS-ALL.md#-其他723)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260826T130001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260826T130001Z（2026-08-26 21:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1146 可用 · 806 不兼容 · 141 待定（共 2093 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-8074-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-11326-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_7557-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1317-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2558-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8074 plugin repos indexed** (manifest-level classification, v2 engine), **11326 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260830T001501Z` (2026-08-30 08:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 16357 · age 186m"]
    ...
    B1 -->|"plugins 8074"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 11326"}
    D1 -->|"7557 / 2558"| E1["aggregate + README stats"]
    D1 -->|"1211 env retries"| C1
...
- **🛒 市场与管理**（229）— OK 91 · incompatible 20 · pending 14 · untested 7 · watching 97 — [details](PLUGINS-ALL.md#-市场与管理229)
- **🔌 Web UI 增强**（2130）— OK 1175 · incompatible 380 · pending 189 · untested 16 · watching 370 — [details](PLUGINS-ALL.md#-web-ui-增强2130)
- **💻 编码开发**（1612）— OK 803 · incompatible 311 · pending 151 · untested 18 · watching 329 — [details](PLUGINS-ALL.md#-编码开发1612)
- **🤖 Agent 能力**（1577）— OK 709 · incompatible 290 · pending 139 · untested 10 · watching 429 — [details](PLUGINS-ALL.md#-agent-能力1577)
- **📡 消息通讯**（537）— OK 218 · incompatible 121 · pending 43 · untested 3 · watching 152 — [details](PLUGINS-ALL.md#-消息通讯537)
- **🗂 文件数据**（478）— OK 225 · incompatible 79 · pending 45 · untested 9 · watching 120 — [details](PLUGINS-ALL.md#-文件数据478)
- **🎮 娱乐生活**（312）— OK 147 · incompatible 28 · pending 28 · untested 0 · watching 109 — [details](PLUGINS-ALL.md#-娱乐生活312)
- **🛠 基建部署**（1005）— OK 396 · incompatible 119 · pending 128 · untested 3 · watching 359 — [details](PLUGINS-ALL.md#-基建部署1005)
- **📚 学习研究**（106）— OK 29 · incompatible 9 · pending 8 · untested 2 · watching 58 — [details](PLUGINS-ALL.md#-学习研究106)
- **❓ 其他**（4095）— OK 1469 · incompatible 286 · pending 218 · untested 20 · watching 2102 — [details](PLUGINS-ALL.md#-其他4095)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260830T001501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260830T001501Z（2026-08-30 08:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 7557 可用 · 2558 不兼容 · 1211 待定（共 11326 个，k8s agent 口径）|

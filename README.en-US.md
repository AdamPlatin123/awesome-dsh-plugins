...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2265-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1179-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-874-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-212-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **2265 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260827T071502Z` (2026-08-27 15:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15095 · age 117m"]
    ...
    C1 --> D1{"verdict · total 2265"}
    D1 -->|"1179 / 874"| E1["aggregate + README stats"]
    D1 -->|"212 env retries"| C1
...
- **🔌 Web UI 增强**（502）— OK 272 · incompatible 124 · pending 49 · untested 33 · watching 24 — [details](PLUGINS-ALL.md#-web-ui-增强502)
- **💻 编码开发**（419）— OK 192 · incompatible 99 · pending 50 · untested 44 · watching 34 — [details](PLUGINS-ALL.md#-编码开发419)
- **🤖 Agent 能力**（354）— OK 147 · incompatible 108 · pending 47 · untested 23 · watching 29 — [details](PLUGINS-ALL.md#-agent-能力354)
...
- **❓ 其他**（735）— OK 324 · incompatible 192 · pending 59 · untested 51 · watching 109 — [details](PLUGINS-ALL.md#-其他735)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T071502Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.

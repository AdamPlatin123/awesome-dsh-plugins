...
[![confirmed](https://img.shields.io/badge/confirmed-8356-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-11788-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_7879-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1359-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2656-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **8356 plugin repos indexed** (manifest-level classification, v2 engine), **11788 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260831T014501Z` (2026-08-31 09:45:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 16796 · age 42m"]
    ...
    B1 -->|"plugins 8356"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 11788"}
    D1 -->|"7879 / 2656"| E1["aggregate + README stats"]
...
- **💻 编码开发**（1684）— OK 837 · incompatible 324 · pending 154 · untested 18 · watching 351 — [details](PLUGINS-ALL.md#-编码开发1684)
...
- **🗂 文件数据**（494）— OK 233 · incompatible 85 · pending 46 · untested 9 · watching 121 — [details](PLUGINS-ALL.md#-文件数据494)
- **🎮 娱乐生活**（329）— OK 154 · incompatible 28 · pending 29 · untested 0 · watching 118 — [details](PLUGINS-ALL.md#-娱乐生活329)
- **🛠 基建部署**（1037）— OK 408 · incompatible 127 · pending 126 · untested 3 · watching 373 — [details](PLUGINS-ALL.md#-基建部署1037)
- **📚 学习研究**（107）— OK 29 · incompatible 9 · pending 8 · untested 2 · watching 59 — [details](PLUGINS-ALL.md#-学习研究107)
- **❓ 其他**（4331）— OK 1549 · incompatible 292 · pending 223 · untested 20 · watching 2247 — [details](PLUGINS-ALL.md#-其他4331)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260831T014501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260831T014501Z（2026-08-31 09:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 7879 可用 · 2656 不兼容 · 1253 待定（共 11788 个，k8s agent 口径）|

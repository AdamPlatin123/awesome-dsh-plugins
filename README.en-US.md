...
[![confirmed](https://img.shields.io/badge/confirmed-321-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12798-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8674-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1540-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2694-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **321 plugin repos indexed** (manifest-level classification, v2 engine), **12798 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260903T181501Z` (2026-09-04 02:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17870 · age 46m"]
    ...
    B1 -->|"plugins 321"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12798"}
    D1 -->|"8674 / 2694"| E1["aggregate + README stats"]
    D1 -->|"1430 env retries"| C1
...
- **🛒 市场与管理**（300）— OK 97 · incompatible 21 · pending 15 · untested 8 · watching 159 — [details](PLUGINS-ALL.md#-市场与管理300)
- **🔌 Web UI 增强**（2688）— OK 1311 · incompatible 398 · pending 225 · untested 16 · watching 738 — [details](PLUGINS-ALL.md#-web-ui-增强2688)
- **💻 编码开发**（2089）— OK 916 · incompatible 349 · pending 163 · untested 19 · watching 642 — [details](PLUGINS-ALL.md#-编码开发2089)
- **🤖 Agent 能力**（2177）— OK 790 · incompatible 268 · pending 154 · untested 10 · watching 955 — [details](PLUGINS-ALL.md#-agent-能力2177)
- **📡 消息通讯**（698）— OK 239 · incompatible 128 · pending 51 · untested 3 · watching 277 — [details](PLUGINS-ALL.md#-消息通讯698)
- **🗂 文件数据**（656）— OK 271 · incompatible 91 · pending 47 · untested 9 · watching 238 — [details](PLUGINS-ALL.md#-文件数据656)
- **🎮 娱乐生活**（445）— OK 174 · incompatible 31 · pending 29 · untested 0 · watching 211 — [details](PLUGINS-ALL.md#-娱乐生活445)
- **🛠 基建部署**（1327）— OK 437 · incompatible 131 · pending 118 · untested 3 · watching 638 — [details](PLUGINS-ALL.md#-基建部署1327)
- **📚 学习研究**（149）— OK 33 · incompatible 9 · pending 7 · untested 2 · watching 98 — [details](PLUGINS-ALL.md#-学习研究149)
- **❓ 其他**（6915）— OK 1776 · incompatible 311 · pending 241 · untested 21 · watching 4566 — [details](PLUGINS-ALL.md#-其他6915)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260903T181501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260903T181501Z（2026-09-04 02:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8674 可用 · 2694 不兼容 · 1430 待定（共 12798 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-334-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-12605-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8523-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1556-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2634-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **334 plugin repos indexed** (manifest-level classification, v2 engine), **12605 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260903T094501Z` (2026-09-03 17:45:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 17736 · age 38m"]
    ...
    B1 -->|"plugins 334"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 12605"}
    D1 -->|"8523 / 2634"| E1["aggregate + README stats"]
    D1 -->|"1448 env retries"| C1
...
> 人工策展 56 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-03 19:24（UTC+8）。

### 🚀 智力增强 Booster（7）

- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7040★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[ouroboros](https://github.com/Q00/ouroboros)** · 5761★ — Agent OS：agent 自我变强、人只守底线——自进化运行时（5.7k★；rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui)** · 6769★ — Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar)** · 3284★ — 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 23243★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop)** · 1608★ — Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[modlens](https://github.com/liustack/modlens)** · 3850★ — 生态第一个视觉插件，视觉工作流的基准方案
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[distilly](https://github.com/titanwings/distilly)** · 24309★ — 把专家思维蒸馏为可复用 Skills 的平台（24k★，Agent 域之最，原名 colleague-skill；雷达判可用）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams)** · 1325★ — 多代理团队编排
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[TokenTracker](https://github.com/xiufengsun/TokenTracker)** · 1507★ — 本地优先的 31 种编码工具 token 用量与成本追踪
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-remote](https://github.com/flymysql/dsh-remote)** · 54★ — 多机远程工作区：SSH 连接管理、远程目录→本地镜像→原生工作区收养、SFTP 双向同步与 rw_* 工具族

### 🧠 记忆与上下文（3）

- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[EverOS](https://github.com/EverMind-AI/EverOS)** · 12672★ — 全 agent 便携记忆层：本地优先、Markdown-native（12.4k★ 记忆域之最；rc.8 实测 ✅）
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[mnemon](https://github.com/mnemon-dev/mnemon)** · 550★ — 跨 agent、本地优先的持久记忆
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve)** · 273★ — 五轨记忆 + git 分支托管 + 后台自我进化
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-browser](https://github.com/Lum1104/dsh-browser)** · 561★ — Chrome 侧栏扩展，让 DSH 直接操作浏览器
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-market](https://github.com/dsh-market/dsh-market)** · 3093★ — 持续收录 1000+ 插件的市场：中文搜索 + 五维评分
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale)** · 1899★ — 深海鲸鱼养成
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[openpets](https://github.com/alvinunreal/openpets)** · 1156★ — 本地优先桌面伴侣平台：动画宠物 + 插件 SDK（娱乐域第二位）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-ads](https://github.com/Nagi-ovo/dsh-ads)** · 602★ — 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[whale-girl](https://github.com/vlln/whale-girl)** · 307★ — QQ 宠物形态桌宠：可拖拽/投喂/玩耍
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet)** · 88★ — 小坤桌宠：随 Agent 工作状态切换 9 种动作
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-03 19:24（UTC+8）。
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7040★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + P1-P23 任务感知推理模式路由（rc.8 实测 ✅）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[DeepSec](https://github.com/Unclecheng-li/DeepSec)** · 386★ — AI 安全攻防一体化合集：Android · Web · Native · 协议 · 恶意代码 · AI 六域
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[superpowers-dsh](https://github.com/LayneChai/superpowers-dsh)** · 119★ — TDD/调试/计划等开发技能集（rc.8 实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill)** · 115★ — 完整逆向工程技能合集（85 个 SKILL.md）
...
- **🧠 记忆增强**（44）— OK 13 · incompatible 4 · pending 5 · untested 2 · watching 20 — [details](PLUGINS-ALL.md#-记忆增强44)
- **🎨 主题皮肤**（18）— OK 9 · incompatible 0 · pending 1 · untested 5 · watching 3 — [details](PLUGINS-ALL.md#-主题皮肤18)
- **🛒 市场与管理**（295）— OK 96 · incompatible 20 · pending 14 · untested 7 · watching 158 — [details](PLUGINS-ALL.md#-市场与管理295)
- **🔌 Web UI 增强**（2652）— OK 1296 · incompatible 389 · pending 227 · untested 16 · watching 724 — [details](PLUGINS-ALL.md#-web-ui-增强2652)
- **💻 编码开发**（2060）— OK 901 · incompatible 340 · pending 164 · untested 19 · watching 636 — [details](PLUGINS-ALL.md#-编码开发2060)
- **🤖 Agent 能力**（2144）— OK 776 · incompatible 262 · pending 156 · untested 10 · watching 940 — [details](PLUGINS-ALL.md#-agent-能力2144)
- **📡 消息通讯**（689）— OK 232 · incompatible 125 · pending 53 · untested 3 · watching 276 — [details](PLUGINS-ALL.md#-消息通讯689)
- **🗂 文件数据**（649）— OK 265 · incompatible 91 · pending 47 · untested 9 · watching 237 — [details](PLUGINS-ALL.md#-文件数据649)
- **🎮 娱乐生活**（438）— OK 172 · incompatible 29 · pending 29 · untested 0 · watching 208 — [details](PLUGINS-ALL.md#-娱乐生活438)
- **🛠 基建部署**（1322）— OK 434 · incompatible 130 · pending 120 · untested 3 · watching 635 — [details](PLUGINS-ALL.md#-基建部署1322)
- **📚 学习研究**（147）— OK 33 · incompatible 9 · pending 7 · untested 2 · watching 96 — [details](PLUGINS-ALL.md#-学习研究147)
- **❓ 其他**（6858）— OK 1759 · incompatible 309 · pending 242 · untested 21 · watching 4527 — [details](PLUGINS-ALL.md#-其他6858)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260903T094501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260903T094501Z（2026-09-03 17:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8523 可用 · 2634 不兼容 · 1448 待定（共 12605 个，k8s agent 口径）|

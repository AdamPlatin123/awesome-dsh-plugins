...
[![confirmed](https://img.shields.io/badge/confirmed-4601-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-5119-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-3390-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-1116-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-613-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **4601 plugin repos indexed** (manifest-level classification, v2 engine), **5119 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T071501Z` (2026-08-28 15:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15576 · age 108m"]
    ...
    B1 -->|"plugins 4601"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 5119"}
    D1 -->|"3390 / 1116"| E1["aggregate + README stats"]
    D1 -->|"613 env retries"| C1
...
- **🧠 记忆增强**（25）— OK 12 · incompatible 2 · pending 3 · untested 4 · watching 4 — [details](PLUGINS-ALL.md#-记忆增强25)
- **🎨 主题皮肤**（16）— OK 5 · incompatible 0 · pending 2 · untested 7 · watching 2 — [details](PLUGINS-ALL.md#-主题皮肤16)
- **🛒 市场与管理**（152）— OK 59 · incompatible 20 · pending 11 · untested 9 · watching 53 — [details](PLUGINS-ALL.md#-市场与管理152)
- **🔌 Web UI 增强**（1130）— OK 613 · incompatible 219 · pending 113 · untested 25 · watching 160 — [details](PLUGINS-ALL.md#-web-ui-增强1130)
- **💻 编码开发**（870）— OK 435 · incompatible 169 · pending 103 · untested 22 · watching 141 — [details](PLUGINS-ALL.md#-编码开发870)
- **🤖 Agent 能力**（716）— OK 326 · incompatible 132 · pending 94 · untested 12 · watching 152 — [details](PLUGINS-ALL.md#-agent-能力716)
- **📡 消息通讯**（281）— OK 117 · incompatible 71 · pending 31 · untested 3 · watching 59 — [details](PLUGINS-ALL.md#-消息通讯281)
- **🗂 文件数据**（243）— OK 105 · incompatible 47 · pending 33 · untested 11 · watching 47 — [details](PLUGINS-ALL.md#-文件数据243)
- **🎮 娱乐生活**（146）— OK 75 · incompatible 12 · pending 17 · untested 1 · watching 41 — [details](PLUGINS-ALL.md#-娱乐生活146)
- **🛠 基建部署**（576）— OK 233 · incompatible 85 · pending 85 · untested 4 · watching 169 — [details](PLUGINS-ALL.md#-基建部署576)
- **📚 学习研究**（54）— OK 17 · incompatible 5 · pending 3 · untested 2 · watching 27 — [details](PLUGINS-ALL.md#-学习研究54)
- **❓ 其他**（1739）— OK 560 · incompatible 207 · pending 132 · untested 23 · watching 817 — [details](PLUGINS-ALL.md#-其他1739)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T071501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T071501Z（2026-08-28 15:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 3390 可用 · 1116 不兼容 · 613 待定（共 5119 个，k8s agent 口径）|

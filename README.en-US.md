...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2220-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1515-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-482-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-223-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **2220 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260827T191501Z` (2026-08-28 03:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15312 · age 347m"]
    ...
    C1 --> D1{"verdict · total 2220"}
    D1 -->|"1515 / 482"| E1["aggregate + README stats"]
    D1 -->|"223 env retries"| C1
...
- **🔌 Web UI 增强**（513）— OK 298 · incompatible 103 · pending 54 · untested 32 · watching 26 — [details](PLUGINS-ALL.md#-web-ui-增强513)
- **💻 编码开发**（427）— OK 223 · incompatible 81 · pending 54 · untested 34 · watching 35 — [details](PLUGINS-ALL.md#-编码开发427)
- **🤖 Agent 能力**（357）— OK 176 · incompatible 89 · pending 46 · untested 17 · watching 29 — [details](PLUGINS-ALL.md#-agent-能力357)
- **📡 消息通讯**（135）— OK 71 · incompatible 36 · pending 16 · untested 4 · watching 8 — [details](PLUGINS-ALL.md#-消息通讯135)
- **🗂 文件数据**（113）— OK 51 · incompatible 23 · pending 21 · untested 12 · watching 6 — [details](PLUGINS-ALL.md#-文件数据113)
- **🎮 娱乐生活**（64）— OK 39 · incompatible 11 · pending 6 · untested 1 · watching 7 — [details](PLUGINS-ALL.md#-娱乐生活64)
- **🛠 基建部署**（278）— OK 134 · incompatible 61 · pending 50 · untested 5 · watching 28 — [details](PLUGINS-ALL.md#-基建部署278)
- **📚 学习研究**（20）— OK 11 · incompatible 4 · pending 0 · untested 2 · watching 3 — [details](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（737）— OK 364 · incompatible 149 · pending 66 · untested 37 · watching 121 — [details](PLUGINS-ALL.md#-其他737)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T191501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260827T191501Z（2026-08-28 03:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1515 可用 · 482 不兼容 · 223 待定（共 2220 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-5529-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-6658-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-4427-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-1471-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-760-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **5529 plugin repos indexed** (manifest-level classification, v2 engine), **6658 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260828T113001Z` (2026-08-28 19:30:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15618 · age 147m"]
    ...
    B1 -->|"plugins 5529"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 6658"}
    D1 -->|"4427 / 1471"| E1["aggregate + README stats"]
    D1 -->|"760 env retries"| C1
...
- **🛒 市场与管理**（168）— OK 68 · incompatible 16 · pending 12 · untested 8 · watching 64 — [details](PLUGINS-ALL.md#-市场与管理168)
- **🔌 Web UI 增强**（1401）— OK 781 · incompatible 246 · pending 135 · untested 22 · watching 217 — [details](PLUGINS-ALL.md#-web-ui-增强1401)
- **💻 编码开发**（1048）— OK 545 · incompatible 191 · pending 115 · untested 20 · watching 177 — [details](PLUGINS-ALL.md#-编码开发1048)
- **🤖 Agent 能力**（889）— OK 412 · incompatible 147 · pending 101 · untested 12 · watching 217 — [details](PLUGINS-ALL.md#-agent-能力889)
- **📡 消息通讯**（361）— OK 154 · incompatible 78 · pending 35 · untested 3 · watching 91 — [details](PLUGINS-ALL.md#-消息通讯361)
- **🗂 文件数据**（298）— OK 136 · incompatible 56 · pending 36 · untested 9 · watching 61 — [details](PLUGINS-ALL.md#-文件数据298)
- **🎮 娱乐生活**（183）— OK 94 · incompatible 14 · pending 20 · untested 0 · watching 55 — [details](PLUGINS-ALL.md#-娱乐生活183)
- **🛠 基建部署**（706）— OK 288 · incompatible 91 · pending 100 · untested 3 · watching 224 — [details](PLUGINS-ALL.md#-基建部署706)
- **📚 学习研究**（65）— OK 20 · incompatible 5 · pending 3 · untested 2 · watching 35 — [details](PLUGINS-ALL.md#-学习研究65)
- **❓ 其他**（2177）— OK 699 · incompatible 197 · pending 150 · untested 21 · watching 1110 — [details](PLUGINS-ALL.md#-其他2177)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260828T113001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260828T113001Z（2026-08-28 19:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 4427 可用 · 1471 不兼容 · 760 待定（共 6658 个，k8s agent 口径）|

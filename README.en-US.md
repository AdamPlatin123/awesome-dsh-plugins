...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2031-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1115-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-739-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-177-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **2031 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260825T123001Z` (2026-08-25 20:30:01 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 9584 · age 9028m"]
    ...
    C1 --> D1{"verdict · total 2031"}
    D1 -->|"1115 / 739"| E1["aggregate + README stats"]
    D1 -->|"177 env retries"| C1
...
- **🛒 市场与管理**（60）— OK 23 · incompatible 13 · pending 2 · untested 11 · watching 11 — [details](PLUGINS-ALL.md#-市场与管理60)
- **🔌 Web UI 增强**（484）— OK 249 · incompatible 97 · pending 59 · untested 38 · watching 41 — [details](PLUGINS-ALL.md#-web-ui-增强484)
- **💻 编码开发**（407）— OK 183 · incompatible 81 · pending 43 · untested 55 · watching 45 — [details](PLUGINS-ALL.md#-编码开发407)
- **🤖 Agent 能力**（340）— OK 141 · incompatible 80 · pending 34 · untested 31 · watching 54 — [details](PLUGINS-ALL.md#-agent-能力340)
- **📡 消息通讯**（131）— OK 63 · incompatible 34 · pending 14 · untested 8 · watching 12 — [details](PLUGINS-ALL.md#-消息通讯131)
- **🗂 文件数据**（110）— OK 49 · incompatible 21 · pending 17 · untested 15 · watching 8 — [details](PLUGINS-ALL.md#-文件数据110)
- **🎮 娱乐生活**（57）— OK 31 · incompatible 10 · pending 8 · untested 2 · watching 6 — [details](PLUGINS-ALL.md#-娱乐生活57)
- **🛠 基建部署**（246）— OK 92 · incompatible 82 · pending 23 · untested 8 · watching 41 — [details](PLUGINS-ALL.md#-基建部署246)
- **📚 学习研究**（20）— OK 5 · incompatible 4 · pending 1 · untested 3 · watching 7 — [details](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（701）— OK 283 · incompatible 131 · pending 46 · untested 63 · watching 178 — [details](PLUGINS-ALL.md#-其他701)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260825T123001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260825T123001Z（2026-08-25 20:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1115 可用 · 739 不兼容 · 177 待定（共 2031 个，k8s agent 口径）|

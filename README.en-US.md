...
[![confirmed](https://img.shields.io/badge/confirmed-3004-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2409-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1567-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-556-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-286-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **3004 plugin repos indexed** (manifest-level classification, v2 engine), **2409 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260827T230001Z` (2026-08-28 07:00:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 15459 · age 112m"]
    ...
    B1 -->|"plugins 3004"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 1064)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 2409"}
    D1 -->|"1567 / 556"| E1["aggregate + README stats"]
    D1 -->|"286 env retries"| C1
...
- **🧠 记忆增强**（22）— OK 11 · incompatible 2 · pending 2 · untested 5 · watching 2 — [details](PLUGINS-ALL.md#-记忆增强22)
- **🎨 主题皮肤**（14）— OK 4 · incompatible 0 · pending 2 · untested 7 · watching 1 — [details](PLUGINS-ALL.md#-主题皮肤14)
- **🛒 市场与管理**（83）— OK 36 · incompatible 14 · pending 7 · untested 10 · watching 16 — [details](PLUGINS-ALL.md#-市场与管理83)
- **🔌 Web UI 增强**（607）— OK 335 · incompatible 122 · pending 72 · untested 29 · watching 49 — [details](PLUGINS-ALL.md#-web-ui-增强607)
- **💻 编码开发**（493）— OK 249 · incompatible 89 · pending 75 · untested 30 · watching 50 — [details](PLUGINS-ALL.md#-编码开发493)
- **🤖 Agent 能力**（400）— OK 184 · incompatible 92 · pending 63 · untested 15 · watching 46 — [details](PLUGINS-ALL.md#-agent-能力400)
- **📡 消息通讯**（151）— OK 71 · incompatible 41 · pending 21 · untested 3 · watching 15 — [details](PLUGINS-ALL.md#-消息通讯151)
- **🗂 文件数据**（134）— OK 58 · incompatible 24 · pending 26 · untested 12 · watching 14 — [details](PLUGINS-ALL.md#-文件数据134)
- **🎮 娱乐生活**（74）— OK 45 · incompatible 8 · pending 9 · untested 1 · watching 11 — [details](PLUGINS-ALL.md#-娱乐生活74)
- **🛠 基建部署**（339）— OK 147 · incompatible 68 · pending 61 · untested 4 · watching 59 — [details](PLUGINS-ALL.md#-基建部署339)
- **📚 学习研究**（26）— OK 10 · incompatible 4 · pending 1 · untested 2 · watching 9 — [details](PLUGINS-ALL.md#-学习研究26)
- **❓ 其他**（916）— OK 393 · incompatible 156 · pending 104 · untested 26 · watching 237 — [details](PLUGINS-ALL.md#-其他916)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260827T230001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260827T230001Z（2026-08-28 07:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 1567 可用 · 556 不兼容 · 286 待定（共 2409 个，k8s agent 口径）|

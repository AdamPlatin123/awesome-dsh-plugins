...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-2064-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=en)](https://dshfind.com/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK-1139-brightgreen)](#2-understand-status-unified-4-tier-scale) [![incompatible](https://img.shields.io/badge/incompatible-786-red)](#2-understand-status-unified-4-tier-scale) [![pending](https://img.shields.io/badge/pending-139-yellow)](#2-understand-status-unified-4-tier-scale) [![untested](https://img.shields.io/badge/untested-0-lightgrey)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1258 plugin repos indexed** (manifest-level classification, v2 engine), **2064 runtime-tested on the k8s track**.

## How it works

> Data as of snapshot `20260826T111501Z` (2026-08-26 19:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 14541 · age 859m"]
    ...
    C1 --> D1{"verdict · total 2064"}
    D1 -->|"1139 / 786"| E1["aggregate + README stats"]
    D1 -->|"139 env retries"| C1
...
- **🎓 技能包**（29）— OK 6 · incompatible 1 · pending 1 · untested 18 · watching 3 — [details](PLUGINS-ALL.md#-技能包29)
- **🧠 记忆增强**（20）— OK 7 · incompatible 4 · pending 2 · untested 6 · watching 1 — [details](PLUGINS-ALL.md#-记忆增强20)
- **🎨 主题皮肤**（12）— OK 1 · incompatible 1 · pending 2 · untested 8 · watching 0 — [details](PLUGINS-ALL.md#-主题皮肤12)
- **🛒 市场与管理**（64）— OK 24 · incompatible 13 · pending 2 · untested 11 · watching 14 — [details](PLUGINS-ALL.md#-市场与管理64)
- **🔌 Web UI 增强**（483）— OK 255 · incompatible 105 · pending 43 · untested 38 · watching 42 — [details](PLUGINS-ALL.md#-web-ui-增强483)
- **💻 编码开发**（409）— OK 184 · incompatible 84 · pending 40 · untested 55 · watching 46 — [details](PLUGINS-ALL.md#-编码开发409)
- **🤖 Agent 能力**（345）— OK 142 · incompatible 81 · pending 37 · untested 31 · watching 54 — [details](PLUGINS-ALL.md#-agent-能力345)
- **📡 消息通讯**（133）— OK 62 · incompatible 35 · pending 14 · untested 8 · watching 14 — [details](PLUGINS-ALL.md#-消息通讯133)
- **🗂 文件数据**（108）— OK 48 · incompatible 23 · pending 15 · untested 15 · watching 7 — [details](PLUGINS-ALL.md#-文件数据108)
- **🎮 娱乐生活**（59）— OK 31 · incompatible 12 · pending 7 · untested 2 · watching 7 — [details](PLUGINS-ALL.md#-娱乐生活59)
- **🛠 基建部署**（259）— OK 95 · incompatible 88 · pending 23 · untested 8 · watching 45 — [details](PLUGINS-ALL.md#-基建部署259)
- **📚 学习研究**（19）— OK 5 · incompatible 4 · pending 0 · untested 3 · watching 7 — [details](PLUGINS-ALL.md#-学习研究19)
- **❓ 其他**（718）— OK 282 · incompatible 135 · pending 45 · untested 61 · watching 195 — [details](PLUGINS-ALL.md#-其他718)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260826T111501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260826T111501Z（2026-08-26 19:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 | 1258 个仓库 |
| 运行级实测 | 1139 可用 · 786 不兼容 · 139 待定（共 2064 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-3524-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-3766-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-2478-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-832-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-456-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T030002Z`（2026-08-28 11:00:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15484 · 龄 118m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 3524"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 3766"}
    D1 -->|"2478 / 832"| E1["聚合 + README 分类统计"]
    D1 -->|"456 环境类重试"| C1
...
- **🛒 市场与管理**（122）— 可用 49 · 不兼容 17 · 待定 9 · 未测 9 · 监测 38 — [明细](PLUGINS-ALL.md#-市场与管理122)
- **🔌 Web UI 增强**（857）— 可用 470 · 不兼容 169 · 待定 84 · 未测 26 · 监测 108 — [明细](PLUGINS-ALL.md#-web-ui-增强857)
- **💻 编码开发**（688）— 可用 346 · 不兼容 129 · 待定 86 · 未测 26 · 监测 101 — [明细](PLUGINS-ALL.md#-编码开发688)
- **🤖 Agent 能力**（547）— 可用 249 · 不兼容 111 · 待定 80 · 未测 14 · 监测 93 — [明细](PLUGINS-ALL.md#-agent-能力547)
- **📡 消息通讯**（215）— 可用 93 · 不兼容 57 · 待定 30 · 未测 3 · 监测 32 — [明细](PLUGINS-ALL.md#-消息通讯215)
- **🗂 文件数据**（183）— 可用 79 · 不兼容 37 · 待定 28 · 未测 11 · 监测 28 — [明细](PLUGINS-ALL.md#-文件数据183)
- **🎮 娱乐生活**（112）— 可用 61 · 不兼容 9 · 待定 15 · 未测 1 · 监测 26 — [明细](PLUGINS-ALL.md#-娱乐生活112)
- **🛠 基建部署**（478）— 可用 199 · 不兼容 77 · 待定 74 · 未测 4 · 监测 124 — [明细](PLUGINS-ALL.md#-基建部署478)
- **📚 学习研究**（36）— 可用 12 · 不兼容 4 · 待定 2 · 未测 2 · 监测 16 — [明细](PLUGINS-ALL.md#-学习研究36)
- **❓ 其他**（1330）— 可用 460 · 不兼容 187 · 待定 120 · 未测 26 · 监测 537 — [明细](PLUGINS-ALL.md#-其他1330)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T030002Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

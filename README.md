...
> 自动更新：2026-08-08_2335（cron 每 8 小时；源码见 scripts/update-readme.sh）

**兼容性汇总**（报告日 2026-08-07 · mainline `9d84ab4`）：兼容性：68/79 无需适配，10 需适配（dsh-my-rsi dsh-subagent-tree dsh-working-activity ex-setting plugin-registry Qwen-MM-Plugins sandbox-mxc turtle-ui web-components fabric）；其中关注 3、占位 4、不适用 2、已删除 1

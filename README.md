...
[![confirmed](https://img.shields.io/badge/confirmed-415-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12960-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8785-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1564-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2720-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260903T191501Z`（2026-09-04 03:15:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17870 · 龄 106m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 415"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12960"}
    D1 -->|"8785 / 2720"| E1["聚合 + README 分类统计"]
    D1 -->|"1455 环境类重试"| C1
...
- **🔌 Web UI 增强**（2715）— 可用 1324 · 不兼容 403 · 待定 228 · 未测 16 · 监测 744 — [明细](PLUGINS-ALL.md#-web-ui-增强2715)
- **💻 编码开发**（2099）— 可用 921 · 不兼容 352 · 待定 163 · 未测 19 · 监测 644 — [明细](PLUGINS-ALL.md#-编码开发2099)
- **🤖 Agent 能力**（2193）— 可用 803 · 不兼容 269 · 待定 154 · 未测 10 · 监测 957 — [明细](PLUGINS-ALL.md#-agent-能力2193)
- **📡 消息通讯**（703）— 可用 242 · 不兼容 129 · 待定 50 · 未测 3 · 监测 279 — [明细](PLUGINS-ALL.md#-消息通讯703)
- **🗂 文件数据**（660）— 可用 271 · 不兼容 93 · 待定 48 · 未测 9 · 监测 239 — [明细](PLUGINS-ALL.md#-文件数据660)
- **🎮 娱乐生活**（449）— 可用 177 · 不兼容 31 · 待定 30 · 未测 0 · 监测 211 — [明细](PLUGINS-ALL.md#-娱乐生活449)
- **🛠 基建部署**（1334）— 可用 442 · 不兼容 130 · 待定 119 · 未测 3 · 监测 640 — [明细](PLUGINS-ALL.md#-基建部署1334)
- **📚 学习研究**（151）— 可用 34 · 不兼容 9 · 待定 7 · 未测 2 · 监测 99 — [明细](PLUGINS-ALL.md#-学习研究151)
- **❓ 其他**（6998）— 可用 1824 · 不兼容 316 · 待定 249 · 未测 21 · 监测 4588 — [明细](PLUGINS-ALL.md#-其他6998)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260903T191501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

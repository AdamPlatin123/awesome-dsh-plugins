...
- **🎨 主题皮肤**（12）— 可用 3 · 不兼容 1 · 待定 0 · 未测 8 · 监测 0 — [明细](PLUGINS-ALL.md#-主题皮肤12)
- **🛒 市场与管理**（66）— 可用 26 · 不兼容 18 · 待定 3 · 未测 11 · 监测 8 — [明细](PLUGINS-ALL.md#-市场与管理66)
- **🔌 Web UI 增强**（498）— 可用 272 · 不兼容 123 · 待定 47 · 未测 34 · 监测 22 — [明细](PLUGINS-ALL.md#-web-ui-增强498)
- **💻 编码开发**（416）— 可用 192 · 不兼容 99 · 待定 48 · 未测 44 · 监测 33 — [明细](PLUGINS-ALL.md#-编码开发416)
- **🤖 Agent 能力**（351）— 可用 147 · 不兼容 108 · 待定 44 · 未测 23 · 监测 29 — [明细](PLUGINS-ALL.md#-agent-能力351)
...
- **🛠 基建部署**（276）— 可用 98 · 不兼容 112 · 待定 33 · 未测 7 · 监测 26 — [明细](PLUGINS-ALL.md#-基建部署276)
- **📚 学习研究**（20）— 可用 7 · 不兼容 7 · 待定 0 · 未测 2 · 监测 4 — [明细](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（733）— 可用 324 · 不兼容 192 · 待定 59 · 未测 52 · 监测 106 — [明细](PLUGINS-ALL.md#-其他733)

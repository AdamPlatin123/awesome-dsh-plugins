...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-17 01:13（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 66513 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1599 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1517 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
- **💻 编码开发**（253）— 可用 134 · 不兼容 38 · 待定 24 · 未测 28 · 监测 29 — [明细](PLUGINS-ALL.md#-编码开发253)
...
- **🗂 文件数据**（75）— 可用 40 · 不兼容 17 · 待定 8 · 未测 6 · 监测 4 — [明细](PLUGINS-ALL.md#-文件数据75)

...
- **🎨 主题皮肤**（12）— 可用 2 · 不兼容 1 · 待定 1 · 未测 8 · 监测 0 — [明细](PLUGINS-ALL.md#-主题皮肤12)
- **🛒 市场与管理**（64）— 可用 24 · 不兼容 13 · 待定 2 · 未测 11 · 监测 14 — [明细](PLUGINS-ALL.md#-市场与管理64)
- **🔌 Web UI 增强**（491）— 可用 254 · 不兼容 112 · 待定 44 · 未测 38 · 监测 43 — [明细](PLUGINS-ALL.md#-web-ui-增强491)
- **💻 编码开发**（414）— 可用 183 · 不兼容 88 · 待定 44 · 未测 51 · 监测 48 — [明细](PLUGINS-ALL.md#-编码开发414)
- **🤖 Agent 能力**（351）— 可用 144 · 不兼容 87 · 待定 39 · 未测 27 · 监测 54 — [明细](PLUGINS-ALL.md#-agent-能力351)
- **📡 消息通讯**（132）— 可用 59 · 不兼容 37 · 待定 16 · 未测 6 · 监测 14 — [明细](PLUGINS-ALL.md#-消息通讯132)
- **🗂 文件数据**（105）— 可用 48 · 不兼容 21 · 待定 16 · 未测 13 · 监测 7 — [明细](PLUGINS-ALL.md#-文件数据105)
- **🎮 娱乐生活**（61）— 可用 31 · 不兼容 13 · 待定 7 · 未测 2 · 监测 8 — [明细](PLUGINS-ALL.md#-娱乐生活61)
- **🛠 基建部署**（265）— 可用 94 · 不兼容 91 · 待定 25 · 未测 8 · 监测 47 — [明细](PLUGINS-ALL.md#-基建部署265)
- **📚 学习研究**（20）— 可用 5 · 不兼容 4 · 待定 0 · 未测 3 · 监测 8 — [明细](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（727）— 可用 285 · 不兼容 138 · 待定 47 · 未测 56 · 监测 201 — [明细](PLUGINS-ALL.md#-其他727)

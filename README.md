...
- **🧠 记忆增强**（19）— 可用 6 · 不兼容 4 · 待定 2 · 未测 6 · 监测 1 — [明细](PLUGINS-ALL.md#-记忆增强19)
- **🎨 主题皮肤**（13）— 可用 3 · 不兼容 1 · 待定 1 · 未测 8 · 监测 0 — [明细](PLUGINS-ALL.md#-主题皮肤13)
- **🛒 市场与管理**（66）— 可用 24 · 不兼容 14 · 待定 2 · 未测 11 · 监测 15 — [明细](PLUGINS-ALL.md#-市场与管理66)
- **🔌 Web UI 增强**（502）— 可用 258 · 不兼容 117 · 待定 46 · 未测 36 · 监测 45 — [明细](PLUGINS-ALL.md#-web-ui-增强502)
- **💻 编码开发**（414）— 可用 184 · 不兼容 92 · 待定 46 · 未测 44 · 监测 48 — [明细](PLUGINS-ALL.md#-编码开发414)
- **🤖 Agent 能力**（352）— 可用 140 · 不兼容 92 · 待定 40 · 未测 24 · 监测 56 — [明细](PLUGINS-ALL.md#-agent-能力352)
- **📡 消息通讯**（131）— 可用 59 · 不兼容 39 · 待定 15 · 未测 4 · 监测 14 — [明细](PLUGINS-ALL.md#-消息通讯131)
- **🗂 文件数据**（107）— 可用 48 · 不兼容 23 · 待定 16 · 未测 13 · 监测 7 — [明细](PLUGINS-ALL.md#-文件数据107)
- **🎮 娱乐生活**（61）— 可用 32 · 不兼容 13 · 待定 7 · 未测 1 · 监测 8 — [明细](PLUGINS-ALL.md#-娱乐生活61)
- **🛠 基建部署**（273）— 可用 94 · 不兼容 95 · 待定 25 · 未测 7 · 监测 52 — [明细](PLUGINS-ALL.md#-基建部署273)
- **📚 学习研究**（20）— 可用 5 · 不兼容 5 · 待定 0 · 未测 2 · 监测 8 — [明细](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（740）— 可用 288 · 不兼容 141 · 待定 46 · 未测 54 · 监测 211 — [明细](PLUGINS-ALL.md#-其他740)

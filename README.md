...
[![confirmed](https://img.shields.io/badge/confirmed-4059-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-4359-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-2871-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-960-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-528-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T050001Z`（2026-08-28 13:00:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15484 · 龄 237m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 4059"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 4359"}
    D1 -->|"2871 / 960"| E1["聚合 + README 分类统计"]
    D1 -->|"528 环境类重试"| C1
...
- **🛒 市场与管理**（131）— 可用 52 · 不兼容 18 · 待定 9 · 未测 9 · 监测 43 — [明细](PLUGINS-ALL.md#-市场与管理131)
- **🔌 Web UI 增强**（981）— 可用 526 · 不兼容 190 · 待定 100 · 未测 26 · 监测 139 — [明细](PLUGINS-ALL.md#-web-ui-增强981)
- **💻 编码开发**（766）— 可用 385 · 不兼容 144 · 待定 93 · 未测 24 · 监测 120 — [明细](PLUGINS-ALL.md#-编码开发766)
- **🤖 Agent 能力**（613）— 可用 282 · 不兼容 116 · 待定 82 · 未测 14 · 监测 119 — [明细](PLUGINS-ALL.md#-agent-能力613)
- **📡 消息通讯**（243）— 可用 104 · 不兼容 63 · 待定 31 · 未测 3 · 监测 42 — [明细](PLUGINS-ALL.md#-消息通讯243)
- **🗂 文件数据**（210）— 可用 92 · 不兼容 41 · 待定 29 · 未测 11 · 监测 37 — [明细](PLUGINS-ALL.md#-文件数据210)
- **🎮 娱乐生活**（125）— 可用 67 · 不兼容 10 · 待定 15 · 未测 1 · 监测 32 — [明细](PLUGINS-ALL.md#-娱乐生活125)
- **🛠 基建部署**（523）— 可用 214 · 不兼容 80 · 待定 78 · 未测 4 · 监测 147 — [明细](PLUGINS-ALL.md#-基建部署523)
- **📚 学习研究**（43）— 可用 12 · 不兼容 5 · 待定 3 · 未测 2 · 监测 21 — [明细](PLUGINS-ALL.md#-学习研究43)
- **❓ 其他**（1521）— 可用 508 · 不兼容 197 · 待定 125 · 未测 25 · 监测 666 — [明细](PLUGINS-ALL.md#-其他1521)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T050001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-4601-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-5134-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-3402-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1119-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-613-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T080001Z`（2026-08-28 16:00:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15576 · 龄 153m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    C1 --> D1{"判定 · 总 5134"}
    D1 -->|"3402 / 1119"| E1["聚合 + README 分类统计"]
    D1 -->|"613 环境类重试"| C1
...
- **🔌 Web UI 增强**（1133）— 可用 613 · 不兼容 219 · 待定 114 · 未测 25 · 监测 162 — [明细](PLUGINS-ALL.md#-web-ui-增强1133)
- **💻 编码开发**（871）— 可用 435 · 不兼容 169 · 待定 103 · 未测 22 · 监测 142 — [明细](PLUGINS-ALL.md#-编码开发871)
- **🤖 Agent 能力**（720）— 可用 326 · 不兼容 133 · 待定 94 · 未测 13 · 监测 154 — [明细](PLUGINS-ALL.md#-agent-能力720)
- **📡 消息通讯**（283）— 可用 118 · 不兼容 71 · 待定 31 · 未测 3 · 监测 60 — [明细](PLUGINS-ALL.md#-消息通讯283)
- **🗂 文件数据**（242）— 可用 105 · 不兼容 47 · 待定 33 · 未测 10 · 监测 47 — [明细](PLUGINS-ALL.md#-文件数据242)
- **🎮 娱乐生活**（146）— 可用 75 · 不兼容 12 · 待定 17 · 未测 1 · 监测 41 — [明细](PLUGINS-ALL.md#-娱乐生活146)
- **🛠 基建部署**（577）— 可用 234 · 不兼容 85 · 待定 85 · 未测 4 · 监测 169 — [明细](PLUGINS-ALL.md#-基建部署577)
- **📚 学习研究**（54）— 可用 17 · 不兼容 5 · 待定 3 · 未测 2 · 监测 27 — [明细](PLUGINS-ALL.md#-学习研究54)
- **❓ 其他**（1744）— 可用 561 · 不兼容 207 · 待定 132 · 未测 23 · 监测 821 — [明细](PLUGINS-ALL.md#-其他1744)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T080001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-569-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12960-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8808-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1718-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2543-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260904T050001Z`（2026-09-04 13:00:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17811 · 龄 232m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 569"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12960"}
    D1 -->|"8808 / 2543"| E1["聚合 + README 分类统计"]
    D1 -->|"1609 环境类重试"| C1
...
- **🎓 技能包**（29）— 可用 9 · 不兼容 2 · 待定 4 · 未测 11 · 监测 3 — [明细](PLUGINS-ALL.md#-技能包29)
- **🧠 记忆增强**（45）— 可用 13 · 不兼容 4 · 待定 5 · 未测 2 · 监测 21 — [明细](PLUGINS-ALL.md#-记忆增强45)
- **🎨 主题皮肤**（20）— 可用 11 · 不兼容 0 · 待定 1 · 未测 5 · 监测 3 — [明细](PLUGINS-ALL.md#-主题皮肤20)
- **🛒 市场与管理**（304）— 可用 98 · 不兼容 20 · 待定 18 · 未测 8 · 监测 160 — [明细](PLUGINS-ALL.md#-市场与管理304)
- **🔌 Web UI 增强**（2706）— 可用 1320 · 不兼容 383 · 待定 243 · 未测 16 · 监测 744 — [明细](PLUGINS-ALL.md#-web-ui-增强2706)
- **💻 编码开发**（2097）— 可用 917 · 不兼容 341 · 待定 176 · 未测 19 · 监测 644 — [明细](PLUGINS-ALL.md#-编码开发2097)
- **🤖 Agent 能力**（2196）— 可用 808 · 不兼容 262 · 待定 159 · 未测 10 · 监测 957 — [明细](PLUGINS-ALL.md#-agent-能力2196)
- **📡 消息通讯**（701）— 可用 251 · 不兼容 117 · 待定 51 · 未测 3 · 监测 279 — [明细](PLUGINS-ALL.md#-消息通讯701)
- **🗂 文件数据**（663）— 可用 272 · 不兼容 92 · 待定 51 · 未测 9 · 监测 239 — [明细](PLUGINS-ALL.md#-文件数据663)
- **🎮 娱乐生活**（450）— 可用 176 · 不兼容 30 · 待定 33 · 未测 0 · 监测 211 — [明细](PLUGINS-ALL.md#-娱乐生活450)
...
- **❓ 其他**（6999）— 可用 1818 · 不兼容 312 · 待定 260 · 未测 21 · 监测 4588 — [明细](PLUGINS-ALL.md#-其他6999)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260904T050001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

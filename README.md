...
[![运行级可用](https://img.shields.io/badge/运行级可用_7445-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1359-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2462-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
- **🛒 市场与管理**（226）— 可用 89 · 不兼容 19 · 待定 15 · 未测 7 · 监测 96 — [明细](PLUGINS-ALL.md#-市场与管理226)
- **🔌 Web UI 增强**（2107）— 可用 1158 · 不兼容 366 · 待定 199 · 未测 16 · 监测 368 — [明细](PLUGINS-ALL.md#-web-ui-增强2107)
- **💻 编码开发**（1584）— 可用 788 · 不兼容 297 · 待定 157 · 未测 18 · 监测 324 — [明细](PLUGINS-ALL.md#-编码开发1584)
- **🤖 Agent 能力**（1559）— 可用 704 · 不兼容 276 · 待定 146 · 未测 10 · 监测 423 — [明细](PLUGINS-ALL.md#-agent-能力1559)
- **📡 消息通讯**（535）— 可用 218 · 不兼容 119 · 待定 43 · 未测 3 · 监测 152 — [明细](PLUGINS-ALL.md#-消息通讯535)
- **🗂 文件数据**（474）— 可用 222 · 不兼容 77 · 待定 47 · 未测 9 · 监测 119 — [明细](PLUGINS-ALL.md#-文件数据474)
- **🎮 娱乐生活**（305）— 可用 145 · 不兼容 27 · 待定 29 · 未测 0 · 监测 104 — [明细](PLUGINS-ALL.md#-娱乐生活305)
- **🛠 基建部署**（991）— 可用 390 · 不兼容 115 · 待定 129 · 未测 3 · 监测 354 — [明细](PLUGINS-ALL.md#-基建部署991)
- **📚 学习研究**（104）— 可用 28 · 不兼容 9 · 待定 8 · 未测 2 · 监测 57 — [明细](PLUGINS-ALL.md#-学习研究104)
- **❓ 其他**（4035）— 可用 1437 · 不兼容 276 · 待定 220 · 未测 20 · 监测 2082 — [明细](PLUGINS-ALL.md#-其他4035)

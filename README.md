...
[![confirmed](https://img.shields.io/badge/confirmed-8659-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12162-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8171-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1499-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2600-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260902T010001Z`（2026-09-02 09:00:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17411 · 龄 224m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8659"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12162"}
    D1 -->|"8171 / 2600"| E1["聚合 + README 分类统计"]
    D1 -->|"1391 环境类重试"| C1
    E1 --> E2["cadence 交付<br/>本周期增量 —/100<br/>双仓 bot PR（幂等 supersede）"]
    M["radar-probe 每 15 分钟 自愈<br/>7 指标流 × 60s · 完成累计 57"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🔌 Web UI 增强**（2260）— 可用 1245 · 不兼容 375 · 待定 220 · 未测 16 · 监测 404 — [明细](PLUGINS-ALL.md#-web-ui-增强2260)
- **💻 编码开发**（1730）— 可用 850 · 不兼容 325 · 待定 171 · 未测 19 · 监测 365 — [明细](PLUGINS-ALL.md#-编码开发1730)
- **🤖 Agent 能力**（1686）— 可用 758 · 不兼容 291 · 待定 160 · 未测 10 · 监测 467 — [明细](PLUGINS-ALL.md#-agent-能力1686)
- **📡 消息通讯**（561）— 可用 233 · 不兼容 119 · 待定 49 · 未测 3 · 监测 157 — [明细](PLUGINS-ALL.md#-消息通讯561)
- **🗂 文件数据**（509）— 可用 242 · 不兼容 81 · 待定 48 · 未测 9 · 监测 129 — [明细](PLUGINS-ALL.md#-文件数据509)
- **🎮 娱乐生活**（339）— 可用 160 · 不兼容 25 · 待定 28 · 未测 0 · 监测 126 — [明细](PLUGINS-ALL.md#-娱乐生活339)
- **🛠 基建部署**（1053）— 可用 415 · 不兼容 126 · 待定 132 · 未测 3 · 监测 377 — [明细](PLUGINS-ALL.md#-基建部署1053)
- **📚 学习研究**（113）— 可用 31 · 不兼容 9 · 待定 8 · 未测 2 · 监测 63 — [明细](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4654）— 可用 1675 · 不兼容 293 · 待定 236 · 未测 21 · 监测 2429 — [明细](PLUGINS-ALL.md#-其他4654)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260902T010001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

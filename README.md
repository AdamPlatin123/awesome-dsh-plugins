...
[![confirmed](https://img.shields.io/badge/confirmed-7784-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-11160-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_7443-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1807-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2016-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260829T211501Z`（2026-08-30 05:15:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 16357 · 龄 6m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 7784"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 11160"}
    D1 -->|"7443 / 2016"| E1["聚合 + README 分类统计"]
    D1 -->|"1701 环境类重试"| C1
...
- **🎓 技能包**（25）— 可用 6 · 不兼容 2 · 待定 3 · 未测 11 · 监测 3 — [明细](catalog/all/技能包.md)
- **🧠 记忆增强**（32）— 可用 13 · 不兼容 4 · 待定 5 · 未测 2 · 监测 8 — [明细](catalog/all/记忆增强.md)
- **🎨 主题皮肤**（17）— 可用 7 · 不兼容 0 · 待定 2 · 未测 5 · 监测 3 — [明细](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（226）— 可用 89 · 不兼容 12 · 待定 22 · 未测 7 · 监测 96 — [明细](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2107）— 可用 1157 · 不兼容 299 · 待定 267 · 未测 16 · 监测 368 — [明细](catalog/all/Web UI 增强.md)
- **💻 编码开发**（1584）— 可用 788 · 不兼容 260 · 待定 194 · 未测 18 · 监测 324 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（1559）— 可用 706 · 不兼容 229 · 待定 191 · 未测 10 · 监测 423 — [明细](catalog/all/Agent 能力.md)
- **📡 消息通讯**（535）— 可用 224 · 不兼容 99 · 待定 57 · 未测 3 · 监测 152 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（474）— 可用 225 · 不兼容 65 · 待定 56 · 未测 9 · 监测 119 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（305）— 可用 144 · 不兼容 27 · 待定 30 · 未测 0 · 监测 104 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（991）— 可用 391 · 不兼容 104 · 待定 139 · 未测 3 · 监测 354 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（104）— 可用 28 · 不兼容 7 · 待定 10 · 未测 2 · 监测 57 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（4035）— 可用 1438 · 不兼容 247 · 待定 248 · 未测 20 · 监测 2082 — [明细](catalog/all/其他.md)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260829T211501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

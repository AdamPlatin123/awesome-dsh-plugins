...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-recall（风神）](https://github.com/fengshenx/dsh-recall) | 1 | ✅ | recall 工具：模型可搜索并读取自己会话的完整事件日志，包括被 compaction 压缩遮蔽的内容 |
...
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 34 | ✅ | 对话节点导航条：右缘节点串快速跳转（官方 bundle 插件） |
...
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 198 | 待定 | 自研 ANSI 渲染的极简终端 UI |

### 👁 视觉与多模态（3）

| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [modlens](https://github.com/liustack/modlens) | 2674 | ✅ | 生态第一个视觉插件，视觉工作流的基准方案 |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 588 | 需适配 | 带意图图片问答、长截图 OCR、UI 还原 |
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 563 | ✅ | 内置免费视觉模型路由，给文本 agent 装眼睛 |
...
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 472 | 待定 | 多代理团队编排 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 316 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 143 | — | 五轨记忆 + git 分支托管 + 后台自我进化 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 233 | — | Chrome 侧栏扩展，让 DSH 直接操作浏览器 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-market](https://github.com/dsh-market/dsh-market) | 780 | ✅ | 持续收录 1000+ 插件的市场：中文搜索 + 五维评分 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [petdex](https://github.com/crafter-station/petdex) | 3866 | ✅ | 生态最高星桌宠图鉴 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1205 | 待定 | 深海鲸鱼养成 |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 476 | ✅ | 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗 |

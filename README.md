...
[![运行级可用](https://img.shields.io/badge/运行级可用_7987-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1359-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2695-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
- **🛒 市场与管理**（239）— 可用 93 · 不兼容 19 · 待定 15 · 未测 7 · 监测 105 — [明细](PLUGINS-ALL.md#-市场与管理239)
- **🔌 Web UI 增强**（2229）— 可用 1225 · 不兼容 396 · 待定 198 · 未测 16 · 监测 394 — [明细](PLUGINS-ALL.md#-web-ui-增强2229)
- **💻 编码开发**（1693）— 可用 842 · 不兼容 326 · 待定 154 · 未测 18 · 监测 353 — [明细](PLUGINS-ALL.md#-编码开发1693)
- **🤖 Agent 能力**（1659）— 可用 744 · 不兼容 306 · 待定 144 · 未测 10 · 监测 455 — [明细](PLUGINS-ALL.md#-agent-能力1659)
- **📡 消息通讯**（555）— 可用 226 · 不兼容 125 · 待定 45 · 未测 3 · 监测 156 — [明细](PLUGINS-ALL.md#-消息通讯555)
- **🗂 文件数据**（502）— 可用 237 · 不兼容 88 · 待定 46 · 未测 9 · 监测 122 — [明细](PLUGINS-ALL.md#-文件数据502)
- **🎮 娱乐生活**（333）— 可用 156 · 不兼容 28 · 待定 29 · 未测 0 · 监测 120 — [明细](PLUGINS-ALL.md#-娱乐生活333)
- **🛠 基建部署**（1044）— 可用 410 · 不兼容 128 · 待定 127 · 未测 3 · 监测 376 — [明细](PLUGINS-ALL.md#-基建部署1044)
- **📚 学习研究**（109）— 可用 30 · 不兼容 9 · 待定 8 · 未测 2 · 监测 60 — [明细](PLUGINS-ALL.md#-学习研究109)
- **❓ 其他**（4444）— 可用 1605 · 不兼容 296 · 待定 224 · 未测 20 · 监测 2299 — [明细](PLUGINS-ALL.md#-其他4444)

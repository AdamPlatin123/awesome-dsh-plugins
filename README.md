...
[![confirmed](https://img.shields.io/badge/confirmed-5529-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-6658-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-4427-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1471-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-760-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T113001Z`（2026-08-28 19:30:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15618 · 龄 147m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 5529"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 6658"}
    D1 -->|"4427 / 1471"| E1["聚合 + README 分类统计"]
    D1 -->|"760 环境类重试"| C1
...
- **🔌 Web UI 增强**（1401）— 可用 781 · 不兼容 246 · 待定 135 · 未测 22 · 监测 217 — [明细](PLUGINS-ALL.md#-web-ui-增强1401)
- **💻 编码开发**（1048）— 可用 545 · 不兼容 191 · 待定 115 · 未测 20 · 监测 177 — [明细](PLUGINS-ALL.md#-编码开发1048)
- **🤖 Agent 能力**（889）— 可用 412 · 不兼容 147 · 待定 101 · 未测 12 · 监测 217 — [明细](PLUGINS-ALL.md#-agent-能力889)
- **📡 消息通讯**（361）— 可用 154 · 不兼容 78 · 待定 35 · 未测 3 · 监测 91 — [明细](PLUGINS-ALL.md#-消息通讯361)
- **🗂 文件数据**（298）— 可用 136 · 不兼容 56 · 待定 36 · 未测 9 · 监测 61 — [明细](PLUGINS-ALL.md#-文件数据298)
- **🎮 娱乐生活**（183）— 可用 94 · 不兼容 14 · 待定 20 · 未测 0 · 监测 55 — [明细](PLUGINS-ALL.md#-娱乐生活183)
- **🛠 基建部署**（706）— 可用 288 · 不兼容 91 · 待定 100 · 未测 3 · 监测 224 — [明细](PLUGINS-ALL.md#-基建部署706)
- **📚 学习研究**（65）— 可用 20 · 不兼容 5 · 待定 3 · 未测 2 · 监测 35 — [明细](PLUGINS-ALL.md#-学习研究65)
- **❓ 其他**（2177）— 可用 699 · 不兼容 197 · 待定 150 · 未测 21 · 监测 1110 — [明细](PLUGINS-ALL.md#-其他2177)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T113001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

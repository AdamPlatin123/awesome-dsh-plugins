...
- **🔌 Web UI 增强**（502）— 可用 272 · 不兼容 124 · 待定 49 · 未测 33 · 监测 24 — [明细](PLUGINS-ALL.md#-web-ui-增强502)
- **💻 编码开发**（419）— 可用 192 · 不兼容 99 · 待定 50 · 未测 44 · 监测 34 — [明细](PLUGINS-ALL.md#-编码开发419)
- **🤖 Agent 能力**（354）— 可用 147 · 不兼容 108 · 待定 47 · 未测 23 · 监测 29 — [明细](PLUGINS-ALL.md#-agent-能力354)
...
- **❓ 其他**（735）— 可用 324 · 不兼容 192 · 待定 59 · 未测 51 · 监测 109 — [明细](PLUGINS-ALL.md#-其他735)

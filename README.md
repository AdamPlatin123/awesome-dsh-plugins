...
[![confirmed](https://img.shields.io/badge/confirmed-3024-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2968-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1927-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-668-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-373-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T004502Z`（2026-08-28 08:45:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15459 · 龄 217m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 3024"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 2968"}
    D1 -->|"1927 / 668"| E1["聚合 + README 分类统计"]
    D1 -->|"373 环境类重试"| C1
...
- **🛒 市场与管理**（102）— 可用 44 · 不兼容 14 · 待定 7 · 未测 10 · 监测 27 — [明细](PLUGINS-ALL.md#-市场与管理102)
- **🔌 Web UI 增强**（705）— 可用 392 · 不兼容 144 · 待定 79 · 未测 27 · 监测 63 — [明细](PLUGINS-ALL.md#-web-ui-增强705)
- **💻 编码开发**（562）— 可用 285 · 不兼容 104 · 待定 79 · 未测 27 · 监测 67 — [明细](PLUGINS-ALL.md#-编码开发562)
- **🤖 Agent 能力**（454）— 可用 208 · 不兼容 102 · 待定 69 · 未测 15 · 监测 60 — [明细](PLUGINS-ALL.md#-agent-能力454)
- **📡 消息通讯**（183）— 可用 80 · 不兼容 51 · 待定 27 · 未测 3 · 监测 22 — [明细](PLUGINS-ALL.md#-消息通讯183)
- **🗂 文件数据**（152）— 可用 64 · 不兼容 27 · 待定 28 · 未测 12 · 监测 21 — [明细](PLUGINS-ALL.md#-文件数据152)
- **🎮 娱乐生活**（88）— 可用 51 · 不兼容 8 · 待定 10 · 未测 1 · 监测 18 — [明细](PLUGINS-ALL.md#-娱乐生活88)
- **🛠 基建部署**（401）— 可用 168 · 不兼容 73 · 待定 68 · 未测 4 · 监测 88 — [明细](PLUGINS-ALL.md#-基建部署401)
- **📚 学习研究**（30）— 可用 10 · 不兼容 4 · 待定 2 · 未测 2 · 监测 12 — [明细](PLUGINS-ALL.md#-学习研究30)
- **❓ 其他**（1099）— 可用 427 · 不兼容 170 · 待定 114 · 未测 26 · 监测 362 — [明细](PLUGINS-ALL.md#-其他1099)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T004502Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

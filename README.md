...
[![confirmed](https://img.shields.io/badge/confirmed-4601-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-5119-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-3390-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1116-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-613-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T071501Z`（2026-08-28 15:15:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15576 · 龄 108m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 4601"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 5119"}
    D1 -->|"3390 / 1116"| E1["聚合 + README 分类统计"]
    D1 -->|"613 环境类重试"| C1
...
- **🧠 记忆增强**（25）— 可用 12 · 不兼容 2 · 待定 3 · 未测 4 · 监测 4 — [明细](PLUGINS-ALL.md#-记忆增强25)
- **🎨 主题皮肤**（16）— 可用 5 · 不兼容 0 · 待定 2 · 未测 7 · 监测 2 — [明细](PLUGINS-ALL.md#-主题皮肤16)
- **🛒 市场与管理**（152）— 可用 59 · 不兼容 20 · 待定 11 · 未测 9 · 监测 53 — [明细](PLUGINS-ALL.md#-市场与管理152)
- **🔌 Web UI 增强**（1130）— 可用 613 · 不兼容 219 · 待定 113 · 未测 25 · 监测 160 — [明细](PLUGINS-ALL.md#-web-ui-增强1130)
- **💻 编码开发**（870）— 可用 435 · 不兼容 169 · 待定 103 · 未测 22 · 监测 141 — [明细](PLUGINS-ALL.md#-编码开发870)
- **🤖 Agent 能力**（716）— 可用 326 · 不兼容 132 · 待定 94 · 未测 12 · 监测 152 — [明细](PLUGINS-ALL.md#-agent-能力716)
- **📡 消息通讯**（281）— 可用 117 · 不兼容 71 · 待定 31 · 未测 3 · 监测 59 — [明细](PLUGINS-ALL.md#-消息通讯281)
- **🗂 文件数据**（243）— 可用 105 · 不兼容 47 · 待定 33 · 未测 11 · 监测 47 — [明细](PLUGINS-ALL.md#-文件数据243)
- **🎮 娱乐生活**（146）— 可用 75 · 不兼容 12 · 待定 17 · 未测 1 · 监测 41 — [明细](PLUGINS-ALL.md#-娱乐生活146)
- **🛠 基建部署**（576）— 可用 233 · 不兼容 85 · 待定 85 · 未测 4 · 监测 169 — [明细](PLUGINS-ALL.md#-基建部署576)
- **📚 学习研究**（54）— 可用 17 · 不兼容 5 · 待定 3 · 未测 2 · 监测 27 — [明细](PLUGINS-ALL.md#-学习研究54)
- **❓ 其他**（1739）— 可用 560 · 不兼容 207 · 待定 132 · 未测 23 · 监测 817 — [明细](PLUGINS-ALL.md#-其他1739)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T071501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

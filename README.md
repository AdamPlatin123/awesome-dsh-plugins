...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-20 02:57（UTC+8）。

### 🚀 智力增强 Booster（6）

| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 6285 | — | 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测） |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 63 | ✅ | TDD/调试/计划等开发技能集 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4866 | ✅ | Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2328 | ✅ | 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页 |
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 249 | ✅ | GenUI 内联组件：图表/表单/测验/3D 场景 + action 事件环 |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 79 | ✅ | 划选文字→批注→随消息发送，回复逐条对照 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2075 | ✅ | Claude Code 风全屏 TUI：鲸鱼顶栏/流式思考/双击 Esc 回滚 |
| [deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) | 600 | ✅ | Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [modlens](https://github.com/liustack/modlens) | 3268 | ✅ | 生态第一个视觉插件，视觉工作流的基准方案 |
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 841 | ✅ | 内置免费视觉模型路由，给文本 agent 装眼睛 |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 749 | 需适配 | 带意图图片问答、长截图 OCR、UI 还原 |
...
| [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 624 | ✅ | CMA 兼容开源 agent 运行时，任意模型可驱动 |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 608 | 待定 | 多代理团队编排 |
| [rea](https://github.com/morluto/rea) | 357 | ✅ | 用 agent 逆向工程任何东西：从应用行为到原生二进制 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1367 | 未测 | 本地优先的 31 种编码工具 token 用量与成本追踪 |
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 418 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 195 | ✅ | 五轨记忆 + git 分支托管 + 后台自我进化 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 323 | 需适配 | Chrome 侧栏扩展让 DSH 直接操控浏览器；双件套需专用 install.sh + Chrome 手动装载（非一行安装，判定待新契约重测） |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-market](https://github.com/dsh-market/dsh-market) | 1237 | ✅ | 持续收录 1000+ 插件的市场：中文搜索 + 五维评分 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [petdex](https://github.com/crafter-station/petdex) | 3920 | ✅ | 生态最高星桌宠图鉴 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1456 | 待定 | 深海鲸鱼养成 |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 511 | ✅ | 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗 |
| [whale-girl](https://github.com/vlln/whale-girl) | 247 | ✅ | QQ 宠物形态桌宠：可拖拽/投喂/玩耍 |

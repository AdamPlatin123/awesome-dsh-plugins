...
| 你的目标 | 跳转入口 |
|---|---|
| 看精选插件 | [精选 Top 50](#精选插件-top-50) — 人工策展 · 11 类 |
...
> 人工策展 50 个高价值插件，全量按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-17 20:23（UTC+8）。

| # | 插件 | ⭐ | 类别 | 实测 | 说明 |
|---:|---|---:|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3982 | 🖥 界面与工作台 | ✅ | Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心 |
| 2 | [petdex](https://github.com/crafter-station/petdex) | 3868 | 🎮 娱乐生活 | ✅ | 生态最高星桌宠图鉴 |
| 3 | [dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 3305 | 🚀 智力增强 Booster | — | 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测） |
| 4 | [modlens](https://github.com/liustack/modlens) | 2696 | 👁 视觉与多模态 | ✅ | 生态第一个视觉插件，视觉工作流的基准方案 |
| 5 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1887 | 🖥 界面与工作台 | ✅ | 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页 |
| 6 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1773 | ⌨️ 终端与桌面端 | ✅ | Claude Code 风全屏 TUI：鲸鱼顶栏/流式思考/双击 Esc 回滚 |
| 7 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1345 | 💻 编码与生产力 | 未测 | 本地优先的 31 种编码工具 token 用量与成本追踪 |
| 8 | [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1219 | 🎮 娱乐生活 | 待定 | 深海鲸鱼养成 |
| 9 | [dsh-market](https://github.com/dsh-market/dsh-market) | 791 | 🛒 市场与管理 | ✅ | 持续收录 1000+ 插件的市场：中文搜索 + 五维评分 |
| 10 | [helloagents](https://github.com/hellowind777/helloagents) | 688 | 🤖 Agent 能力与编排 | ✅ | agent 能力合集 |
| 11 | [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 613 | 🤖 Agent 能力与编排 | ✅ | CMA 兼容开源 agent 运行时，任意模型可驱动 |
| 12 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 595 | 👁 视觉与多模态 | 需适配 | 带意图图片问答、长截图 OCR、UI 还原 |
| 13 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 578 | 👁 视觉与多模态 | ✅ | 内置免费视觉模型路由，给文本 agent 装眼睛 |
| 14 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 478 | 🎮 娱乐生活 | ✅ | 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗 |
| 15 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 476 | 🤖 Agent 能力与编排 | 待定 | 多代理团队编排 |
| 16 | [mnemon](https://github.com/mnemon-dev/mnemon) | 468 | 🧠 记忆与上下文 | ✅ | 跨 agent、本地优先的持久记忆 |
| 17 | [deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) | 411 | ⌨️ 终端与桌面端 | ✅ | Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux |
| 18 | [rea](https://github.com/morluto/rea) | 346 | 🤖 Agent 能力与编排 | ✅ | 用 agent 逆向工程任何东西：从应用行为到原生二进制 |
| 19 | [harmony-next.skills](https://github.com/linhay/harmony-next.skills) | 326 | 🚀 智力增强 Booster | ✅ | 技能驱动的工作流增强 |
| 20 | [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 318 | 💻 编码与生产力 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
| 21 | [claude-paper](https://github.com/alaliqing/claude-paper) | 317 | 💻 编码与生产力 | ✅ | 跨 agent 论文工具箱：速读摘要/深度研读材料/代码演示 + 本地 Web 阅读器 |
| 22 | [mobius](https://github.com/nutshellai-tech/mobius) | 284 | 💻 编码与生产力 | ✅ | 编码增强 |
| 23 | [Bigfish](https://github.com/turtle2209/Bigfish) | 249 | ⌨️ 终端与桌面端 | — | 第三方桌面端：内置 Node 运行时，双击即用 |
| 24 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 237 | ⌨️ 终端与桌面端 | ✅ | 社区发行版：桌面/Web/TUI 三形态统一体验 |
| 25 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 237 | 🗂 文件、数据与浏览 | — | Chrome 侧栏扩展，让 DSH 直接操作浏览器 |
| 26 | [whale-girl](https://github.com/vlln/whale-girl) | 216 | 🎮 娱乐生活 | ✅ | QQ 宠物形态桌宠：可拖拽/投喂/玩耍 |
| 27 | [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 199 | ⌨️ 终端与桌面端 | 待定 | 自研 ANSI 渲染的极简终端 UI |
| 28 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 174 | 🖥 界面与工作台 | ✅ | GenUI 内联组件：图表/表单/测验/3D 场景 + action 事件环 |
| 29 | [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 164 | 🖥 界面与工作台 | ✅ | 对话中生成交互式可视化卡片 |
| 30 | [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 144 | 🧠 记忆与上下文 | — | 五轨记忆 + git 分支托管 + 后台自我进化 |
| 31 | [open-record-replay](https://github.com/humblebanana/open-record-replay) | 138 | 🤖 Agent 能力与编排 | ✅ | macOS 录制回放：把鼠标/键盘/UI 事件存为结构化轨迹供 agent 学习重放 |
| 32 | [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 104 | 🗂 文件、数据与浏览 | ✅ | OpenPencil 设计稿预览与编辑 |
| 33 | [Liang-Saint-Slider](https://github.com/BruzWJ/Liang-Saint-Slider) | 83 | 🖥 界面与工作台 | ✅ | 模型与思考力度选择滑条 |
| 34 | [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 69 | 🖥 界面与工作台 | ✅ | 划选文字→批注→随消息发送，回复逐条对照 |
| 35 | [forkprobe](https://github.com/Jayden-X-L/forkprobe) | 66 | 🚀 智力增强 Booster | ✅ | 同一任务跑多个技能对比，自动选优 |
| 36 | [axern](https://github.com/cofy-x/axern) | 56 | 🤖 Agent 能力与编排 | ✅ | AI agent 开源沙箱：不可信代码执行与持久服务 |
| 37 | [dsh-web-plugin-manager](https://github.com/LX2000WASD/dsh-web-plugin-manager) | 54 | 🛒 市场与管理 | ✅ | Web UI 一键管理插件：启停/装卸/环境管理 |
| 38 | [dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) | 51 | 🎮 娱乐生活 | ✅ | 小坤桌宠：随 Agent 工作状态切换 9 种动作 |
| 39 | [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 48 | 🚀 智力增强 Booster | ✅ | TDD/调试/计划等开发技能集 |
| 40 | [dsh-navbar](https://github.com/vlln/dsh-navbar) | 35 | 🖥 界面与工作台 | ✅ | 对话节点导航条：右缘节点串快速跳转（官方 bundle 插件） |
| 41 | [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) | 32 | 🗂 文件、数据与浏览 | 待定 | PDF/图片/Office 转结构化 Markdown |
| 42 | [dsh-interconnect](https://github.com/Chinesezjc/dsh-interconnect) | 30 | 📡 消息通讯与 IM | 待定 | 跨 DSH 实例消息/事件交接 |
| 43 | [dsh-lark](https://github.com/omdsh-dev/dsh-lark) | 30 | 📡 消息通讯与 IM | ✅ | 飞书 IM bot 频道（官方渠道插件） |
| 44 | [dsh-message-edit](https://github.com/Moeblack/dsh-message-edit) | 26 | 📡 消息通讯与 IM | ✅ | 分支式消息编辑、reroll、重试、多版本 |
| 45 | [dsh-plugin-check](https://github.com/omdsh-dev/dsh-plugin-check) | 24 | 🛒 市场与管理 | ✅ | 插件健康检查：清单协议/patch 格式/构建陷阱 |
| 46 | [dsh-web-search-pro](https://github.com/anweat/dsh-web-search-pro) | 21 | 🗂 文件、数据与浏览 | ✅ | 增强型持久网页搜索 |
| 47 | [deepseek-plugin-store](https://github.com/Ericwong5021/deepseek-plugin-store) | 20 | 🛒 市场与管理 | ✅ | 独立社区插件商店：发现/安装/提交经验证的插件 |
| 48 | [ChatCCC](https://github.com/wzj998/ChatCCC) | 20 | 📡 消息通讯与 IM | ✅ | 飞书/微信聊天控制 DSH / Claude Code |
| 49 | [dsh-reasoning-settings](https://github.com/JuneLearn/dsh-reasoning-settings) | 5 | 🚀 智力增强 Booster | ✅ | 推理设置控制：让模型按任务切换思考档位 |
| 50 | [dsh-tool-turbo](https://github.com/Electricitysheep/dsh-tool-turbo) | 4 | 🚀 智力增强 Booster | ✅ | 按轮次自动优化 reasoning_effort（推理力度） |

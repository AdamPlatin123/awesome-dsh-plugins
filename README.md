...
[![confirmed](https://img.shields.io/badge/confirmed-976-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13184-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_9019-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1700-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2574-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260905T181502Z`（2026-09-06 02:15:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 18450 · 龄 40m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 976"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13184"}
    D1 -->|"9019 / 2574"| E1["聚合 + README 分类统计"]
    D1 -->|"1591 环境类重试"| C1
...
- **🔌 Web UI 增强**（2753）— 可用 1349 · 不兼容 387 · 待定 248 · 未测 16 · 监测 753 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2135）— 可用 936 · 不兼容 342 · 待定 180 · 未测 19 · 监测 658 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2227）— 可用 823 · 不兼容 259 · 待定 158 · 未测 10 · 监测 977 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（710）— 可用 260 · 不兼容 110 · 待定 55 · 未测 3 · 监测 282 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（672）— 可用 272 · 不兼容 92 · 待定 55 · 未测 9 · 监测 244 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（450）— 可用 175 · 不兼容 32 · 待定 30 · 未测 0 · 监测 213 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1348）— 可用 444 · 不兼容 129 · 待定 124 · 未测 3 · 监测 648 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（154）— 可用 35 · 不兼容 8 · 待定 8 · 未测 2 · 监测 101 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7128）— 可用 1850 · 不兼容 334 · 待定 244 · 未测 21 · 监测 4679 — [明细](catalog/all/其他.md)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260905T181502Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
| 13 | [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 236 | Codex-style @file mentions for DeepSeek Harness: search… |
| 14 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 229 | Eyes for text-only DeepSeek Harness agents: built-in fr… |

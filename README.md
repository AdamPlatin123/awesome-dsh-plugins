...
[![confirmed](https://img.shields.io/badge/confirmed-543-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12687-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8605-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1527-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2665-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260903T180002Z`（2026-09-04 02:00:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17870 · 龄 31m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 543"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12687"}
    D1 -->|"8605 / 2665"| E1["聚合 + README 分类统计"]
    D1 -->|"1417 环境类重试"| C1
...
- **🛒 市场与管理**（298）— 可用 97 · 不兼容 20 · 待定 15 · 未测 8 · 监测 158 — [明细](PLUGINS-ALL.md#-市场与管理298)
- **🔌 Web UI 增强**（2673）— 可用 1305 · 不兼容 394 · 待定 224 · 未测 16 · 监测 734 — [明细](PLUGINS-ALL.md#-web-ui-增强2673)
- **💻 编码开发**（2073）— 可用 907 · 不兼容 348 · 待定 161 · 未测 19 · 监测 638 — [明细](PLUGINS-ALL.md#-编码开发2073)
- **🤖 Agent 能力**（2156）— 可用 784 · 不兼容 265 · 待定 153 · 未测 10 · 监测 944 — [明细](PLUGINS-ALL.md#-agent-能力2156)
- **📡 消息通讯**（692）— 可用 237 · 不兼容 125 · 待定 51 · 未测 3 · 监测 276 — [明细](PLUGINS-ALL.md#-消息通讯692)
- **🗂 文件数据**（651）— 可用 269 · 不兼容 90 · 待定 46 · 未测 9 · 监测 237 — [明细](PLUGINS-ALL.md#-文件数据651)
- **🎮 娱乐生活**（441）— 可用 173 · 不兼容 30 · 待定 29 · 未测 0 · 监测 209 — [明细](PLUGINS-ALL.md#-娱乐生活441)
- **🛠 基建部署**（1323）— 可用 437 · 不兼容 130 · 待定 118 · 未测 3 · 监测 635 — [明细](PLUGINS-ALL.md#-基建部署1323)
- **📚 学习研究**（149）— 可用 33 · 不兼容 9 · 待定 7 · 未测 2 · 监测 98 — [明细](PLUGINS-ALL.md#-学习研究149)
- **❓ 其他**（6879）— 可用 1766 · 不兼容 310 · 待定 240 · 未测 21 · 监测 4542 — [明细](PLUGINS-ALL.md#-其他6879)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260903T180002Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

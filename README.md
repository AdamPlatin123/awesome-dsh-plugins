...
- **🔌 Web UI 增强**（2752）— 可用 1346 · 不兼容 376 · 待定 262 · 未测 16 · 监测 752 — [明细](PLUGINS-ALL.md#-web-ui-增强2752)
- **💻 编码开发**（2134）— 可用 930 · 不兼容 336 · 待定 192 · 未测 19 · 监测 657 — [明细](PLUGINS-ALL.md#-编码开发2134)
- **🤖 Agent 能力**（2228）— 可用 821 · 不兼容 252 · 待定 168 · 未测 10 · 监测 977 — [明细](PLUGINS-ALL.md#-agent-能力2228)

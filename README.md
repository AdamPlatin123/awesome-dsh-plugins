...
> 人工策展 50 个高价值插件，按 11 类分组；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-17 17:30（UTC+8）。

### 🖥 界面与工作台（7）

| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3879 | ✅ | Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1854 | ✅ | 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页 |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 165 | ✅ | 对话中生成交互式可视化卡片 |
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 165 | ✅ | GenUI 内联组件：图表/表单/测验/3D 场景 + action 事件环 |
| [Liang-Saint-Slider](https://github.com/BruzWJ/Liang-Saint-Slider) | 81 | ✅ | 模型与思考力度选择滑条 |
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 68 | ✅ | 划选文字→批注→随消息发送，回复逐条对照 |
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 32 | ✅ | 对话节点导航条：右缘节点串快速跳转（官方 bundle 插件） |

### ⌨️ 终端与桌面端（5）

| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1744 | ✅ | Claude Code 风全屏 TUI：鲸鱼顶栏/流式思考/双击 Esc 回滚 |
| [deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) | 403 | ✅ | Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [modlens](https://github.com/liustack/modlens) | 2644 | ✅ | 生态第一个视觉插件，视觉工作流的基准方案 |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 585 | 需适配 | 带意图图片问答、长截图 OCR、UI 还原 |
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 555 | ✅ | 内置免费视觉模型路由，给文本 agent 装眼睛 |
...
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 467 | 待定 | 多代理团队编排 |
| [rea](https://github.com/morluto/rea) | 343 | ✅ | 用 agent 逆向工程任何东西：从应用行为到原生二进制 |
...
| [claude-paper](https://github.com/alaliqing/claude-paper) | 316 | ✅ | 跨 agent 论文工具箱：速读摘要/深度研读材料/代码演示 + 本地 Web 阅读器 |
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 310 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
...
| [dsh-lark](https://github.com/omdsh-dev/dsh-lark) | 29 | ✅ | 飞书 IM bot 频道（官方渠道插件） |
...
| [dsh-lark-bot](https://github.com/PlutoKeating/dsh-lark-bot) | 20 | ✅ | 完整的飞书/Lark bot 桥接 |
...
| [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) | 31 | 待定 | PDF/图片/Office 转结构化 Markdown |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-market](https://github.com/dsh-market/dsh-market) | 760 | ✅ | 持续收录 1000+ 插件的市场：中文搜索 + 五维评分 |
...
| [deepseek-plugin-store](https://github.com/Ericwong5021/deepseek-plugin-store) | 19 | ✅ | 独立社区插件商店：发现/安装/提交经验证的插件 |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1190 | 待定 | 深海鲸鱼养成 |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 477 | ✅ | 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗 |
| [whale-girl](https://github.com/vlln/whale-girl) | 215 | ✅ | QQ 宠物形态桌宠：可拖拽/投喂/玩耍 |
| [dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) | 50 | ✅ | 小坤桌宠：随 Agent 工作状态切换 9 种动作 |
| [dsh-stock-watch](https://github.com/Awu12277/dsh-stock-watch) | 38 | ✅ | 股票盯盘小组件 |

...
[![confirmed](https://img.shields.io/badge/confirmed-8385-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-11846-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_7928-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1359-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2665-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260831T034501Z`（2026-08-31 11:45:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 16796 · 龄 162m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8385"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 11846"}
    D1 -->|"7928 / 2665"| E1["聚合 + README 分类统计"]
    D1 -->|"1253 环境类重试"| C1
...
- **🛒 市场与管理**（240）— 可用 93 · 不兼容 20 · 待定 15 · 未测 7 · 监测 105 — [明细](PLUGINS-ALL.md#-市场与管理240)
- **🔌 Web UI 增强**（2207）— 可用 1213 · 不兼容 390 · 待定 198 · 未测 16 · 监测 390 — [明细](PLUGINS-ALL.md#-web-ui-增强2207)
- **💻 编码开发**（1686）— 可用 838 · 不兼容 325 · 待定 154 · 未测 18 · 监测 351 — [明细](PLUGINS-ALL.md#-编码开发1686)
- **🤖 Agent 能力**（1639）— 可用 734 · 不兼容 303 · 待定 145 · 未测 10 · 监测 447 — [明细](PLUGINS-ALL.md#-agent-能力1639)
- **📡 消息通讯**（553）— 可用 225 · 不兼容 124 · 待定 45 · 未测 3 · 监测 156 — [明细](PLUGINS-ALL.md#-消息通讯553)
- **🗂 文件数据**（497）— 可用 235 · 不兼容 85 · 待定 46 · 未测 9 · 监测 122 — [明细](PLUGINS-ALL.md#-文件数据497)
- **🎮 娱乐生活**（332）— 可用 156 · 不兼容 28 · 待定 29 · 未测 0 · 监测 119 — [明细](PLUGINS-ALL.md#-娱乐生活332)
- **🛠 基建部署**（1041）— 可用 410 · 不兼容 127 · 待定 126 · 未测 3 · 监测 375 — [明细](PLUGINS-ALL.md#-基建部署1041)
- **📚 学习研究**（108）— 可用 30 · 不兼容 9 · 待定 8 · 未测 2 · 监测 59 — [明细](PLUGINS-ALL.md#-学习研究108)
- **❓ 其他**（4362）— 可用 1571 · 不兼容 293 · 待定 223 · 未测 20 · 监测 2255 — [明细](PLUGINS-ALL.md#-其他4362)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260831T034501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

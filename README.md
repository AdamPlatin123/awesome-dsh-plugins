...
[![confirmed](https://img.shields.io/badge/confirmed-8894-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12392-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8335-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1525-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2640-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260902T051501Z`（2026-09-02 13:15:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17519 · 龄 248m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8894"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12392"}
    D1 -->|"8335 / 2640"| E1["聚合 + README 分类统计"]
    D1 -->|"1417 环境类重试"| C1
    E1 --> E2["cadence 交付<br/>本周期增量 —/100<br/>双仓 bot PR（幂等 supersede）"]
    M["radar-probe 每 15 分钟 自愈<br/>7 指标流 × 60s · 完成累计 39"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🛒 市场与管理**（244）— 可用 95 · 不兼容 19 · 待定 16 · 未测 7 · 监测 107 — [明细](PLUGINS-ALL.md#-市场与管理244)
- **🔌 Web UI 增强**（2300）— 可用 1265 · 不兼容 379 · 待定 225 · 未测 16 · 监测 415 — [明细](PLUGINS-ALL.md#-web-ui-增强2300)
- **💻 编码开发**（1766）— 可用 873 · 不兼容 330 · 待定 172 · 未测 19 · 监测 372 — [明细](PLUGINS-ALL.md#-编码开发1766)
- **🤖 Agent 能力**（1714）— 可用 770 · 不兼容 293 · 待定 164 · 未测 10 · 监测 477 — [明细](PLUGINS-ALL.md#-agent-能力1714)
- **📡 消息通讯**（566）— 可用 234 · 不兼容 120 · 待定 50 · 未测 3 · 监测 159 — [明细](PLUGINS-ALL.md#-消息通讯566)
- **🗂 文件数据**（519）— 可用 246 · 不兼容 83 · 待定 49 · 未测 9 · 监测 132 — [明细](PLUGINS-ALL.md#-文件数据519)
- **🎮 娱乐生活**（342）— 可用 160 · 不兼容 25 · 待定 28 · 未测 0 · 监测 129 — [明细](PLUGINS-ALL.md#-娱乐生活342)
- **🛠 基建部署**（1063）— 可用 418 · 不兼容 126 · 待定 133 · 未测 3 · 监测 383 — [明细](PLUGINS-ALL.md#-基建部署1063)
- **📚 学习研究**（113）— 可用 32 · 不兼容 9 · 待定 7 · 未测 2 · 监测 63 — [明细](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4750）— 可用 1714 · 不兼容 296 · 待定 236 · 未测 21 · 监测 2483 — [明细](PLUGINS-ALL.md#-其他4750)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260902T051501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

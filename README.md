...
[![confirmed](https://img.shields.io/badge/confirmed-8911-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12417-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8355-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1528-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2642-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260902T054501Z`（2026-09-02 13:45:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17572 · 龄 21m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8911"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12417"}
    D1 -->|"8355 / 2642"| E1["聚合 + README 分类统计"]
    D1 -->|"1420 环境类重试"| C1
...
- **🔌 Web UI 增强**（2303）— 可用 1268 · 不兼容 378 · 待定 225 · 未测 16 · 监测 416 — [明细](PLUGINS-ALL.md#-web-ui-增强2303)
- **💻 编码开发**（1770）— 可用 877 · 不兼容 330 · 待定 172 · 未测 19 · 监测 372 — [明细](PLUGINS-ALL.md#-编码开发1770)
- **🤖 Agent 能力**（1719）— 可用 772 · 不兼容 295 · 待定 165 · 未测 10 · 监测 477 — [明细](PLUGINS-ALL.md#-agent-能力1719)
...
- **🎮 娱乐生活**（343）— 可用 161 · 不兼容 25 · 待定 28 · 未测 0 · 监测 129 — [明细](PLUGINS-ALL.md#-娱乐生活343)
- **🛠 基建部署**（1066）— 可用 417 · 不兼容 126 · 待定 134 · 未测 3 · 监测 386 — [明细](PLUGINS-ALL.md#-基建部署1066)
- **📚 学习研究**（113）— 可用 32 · 不兼容 9 · 待定 7 · 未测 2 · 监测 63 — [明细](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4771）— 可用 1723 · 不兼容 298 · 待定 237 · 未测 21 · 监测 2492 — [明细](PLUGINS-ALL.md#-其他4771)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260902T054501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

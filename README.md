...
[![confirmed](https://img.shields.io/badge/confirmed-2996-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2222-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1448-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-513-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-261-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260827T223001Z`（2026-08-28 06:30:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15459 · 龄 82m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🎓 技能包**（28）— 可用 6 · 不兼容 1 · 待定 3 · 未测 15 · 监测 3 — [明细](PLUGINS-ALL.md#-技能包28)
- **🧠 记忆增强**（22）— 可用 11 · 不兼容 2 · 待定 2 · 未测 5 · 监测 2 — [明细](PLUGINS-ALL.md#-记忆增强22)
- **🎨 主题皮肤**（15）— 可用 4 · 不兼容 0 · 待定 2 · 未测 8 · 监测 1 — [明细](PLUGINS-ALL.md#-主题皮肤15)
- **🛒 市场与管理**（75）— 可用 32 · 不兼容 14 · 待定 7 · 未测 11 · 监测 11 — [明细](PLUGINS-ALL.md#-市场与管理75)
- **🔌 Web UI 增强**（569）— 可用 316 · 不兼容 118 · 待定 67 · 未测 29 · 监测 39 — [明细](PLUGINS-ALL.md#-web-ui-增强569)
- **💻 编码开发**（469）— 可用 235 · 不兼容 84 · 待定 72 · 未测 31 · 监测 47 — [明细](PLUGINS-ALL.md#-编码开发469)
- **🤖 Agent 能力**（384）— 可用 179 · 不兼容 87 · 待定 63 · 未测 15 · 监测 40 — [明细](PLUGINS-ALL.md#-agent-能力384)
- **📡 消息通讯**（148）— 可用 70 · 不兼容 41 · 待定 20 · 未测 3 · 监测 14 — [明细](PLUGINS-ALL.md#-消息通讯148)
- **🗂 文件数据**（130）— 可用 55 · 不兼容 23 · 待定 26 · 未测 12 · 监测 14 — [明细](PLUGINS-ALL.md#-文件数据130)
- **🎮 娱乐生活**（69）— 可用 41 · 不兼容 8 · 待定 9 · 未测 1 · 监测 10 — [明细](PLUGINS-ALL.md#-娱乐生活69)
- **🛠 基建部署**（320）— 可用 139 · 不兼容 65 · 待定 60 · 未测 4 · 监测 52 — [明细](PLUGINS-ALL.md#-基建部署320)
- **📚 学习研究**（25）— 可用 10 · 不兼容 4 · 待定 1 · 未测 2 · 监测 8 — [明细](PLUGINS-ALL.md#-学习研究25)
- **❓ 其他**（850）— 可用 374 · 不兼容 150 · 待定 99 · 未测 27 · 监测 200 — [明细](PLUGINS-ALL.md#-其他850)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260827T223001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-899-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13233-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_9041-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1702-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2599-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260905T183001Z`（2026-09-06 02:30:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 18450 · 龄 55m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 899"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13233"}
    D1 -->|"9041 / 2599"| E1["聚合 + README 分类统计"]
    D1 -->|"1593 环境类重试"| C1
...
- **🔌 Web UI 增强**（2758）— 可用 1352 · 不兼容 388 · 待定 248 · 未测 16 · 监测 754 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2144）— 可用 939 · 不兼容 346 · 待定 179 · 未测 19 · 监测 661 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2231）— 可用 824 · 不兼容 260 · 待定 158 · 未测 10 · 监测 979 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（713）— 可用 260 · 不兼容 113 · 待定 54 · 未测 3 · 监测 283 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（674）— 可用 272 · 不兼容 92 · 待定 55 · 未测 9 · 监测 246 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（450）— 可用 175 · 不兼容 32 · 待定 30 · 未测 0 · 监测 213 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1353）— 可用 446 · 不兼容 129 · 待定 124 · 未测 3 · 监测 651 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（155）— 可用 36 · 不兼容 8 · 待定 8 · 未测 2 · 监测 101 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7147）— 可用 1852 · 不兼容 337 · 待定 244 · 未测 21 · 监测 4693 — [明细](catalog/all/其他.md)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260905T183001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

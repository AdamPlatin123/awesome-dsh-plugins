...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-18 22:12（UTC+8）。

### 🚀 智力增强 Booster（6）

| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 5921 | — | 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测） |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4502 | ✅ | Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2133 | ✅ | 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页 |
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 220 | ✅ | GenUI 内联组件：图表/表单/测验/3D 场景 + action 事件环 |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 176 | ✅ | 对话中生成交互式可视化卡片 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1945 | ✅ | Claude Code 风全屏 TUI：鲸鱼顶栏/流式思考/双击 Esc 回滚 |
| [deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) | 521 | ✅ | Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux |
| [Bigfish](https://github.com/turtle2209/Bigfish) | 265 | 未测 | 第三方桌面端：内置 Node 运行时，双击即用 |
| [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 249 | ✅ | 社区发行版：桌面/Web/TUI 三形态统一体验 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [modlens](https://github.com/liustack/modlens) | 3047 | ✅ | 生态第一个视觉插件，视觉工作流的基准方案 |
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 732 | ✅ | 内置免费视觉模型路由，给文本 agent 装眼睛 |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 690 | 需适配 | 带意图图片问答、长截图 OCR、UI 还原 |
...
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 539 | 待定 | 多代理团队编排 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 370 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [mnemon](https://github.com/mnemon-dev/mnemon) | 478 | ✅ | 跨 agent、本地优先的持久记忆 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-interconnect](https://github.com/Chinesezjc/dsh-interconnect) | 33 | 待定 | 跨 DSH 实例消息/事件交接 |
| [dsh-lark](https://github.com/omdsh-dev/dsh-lark) | 32 | ✅ | 飞书 IM bot 频道（官方渠道插件） |
| [dsh-message-edit](https://github.com/Moeblack/dsh-message-edit) | 31 | ✅ | 分支式消息编辑、reroll、重试、多版本 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 292 | 需适配 | Chrome 侧栏扩展让 DSH 直接操控浏览器；双件套需专用 install.sh + Chrome 手动装载（非一行安装，判定待新契约重测） |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-market](https://github.com/dsh-market/dsh-market) | 988 | ✅ | 持续收录 1000+ 插件的市场：中文搜索 + 五维评分 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [petdex](https://github.com/crafter-station/petdex) | 3890 | ✅ | 生态最高星桌宠图鉴 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1346 | 待定 | 深海鲸鱼养成 |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 497 | ✅ | 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗 |
| [whale-girl](https://github.com/vlln/whale-girl) | 233 | ✅ | QQ 宠物形态桌宠：可拖拽/投喂/玩耍 |
...
- **🎓 技能包**（29）— 可用 14 · 不兼容 3 · 待定 1 · 未测 11 · 监测 0 — [明细](PLUGINS-ALL.md#-技能包29)
- **🧠 记忆增强**（23）— 可用 10 · 不兼容 7 · 待定 3 · 未测 3 · 监测 0 — [明细](PLUGINS-ALL.md#-记忆增强23)
- **🎨 主题皮肤**（14）— 可用 4 · 不兼容 0 · 待定 3 · 未测 7 · 监测 0 — [明细](PLUGINS-ALL.md#-主题皮肤14)
- **🛒 市场与管理**（45）— 可用 28 · 不兼容 9 · 待定 2 · 未测 5 · 监测 1 — [明细](PLUGINS-ALL.md#-市场与管理45)
- **🔌 Web UI 增强**（248）— 可用 148 · 不兼容 37 · 待定 19 · 未测 30 · 监测 14 — [明细](PLUGINS-ALL.md#-web-ui-增强248)
- **💻 编码开发**（268）— 可用 133 · 不兼容 39 · 待定 26 · 未测 41 · 监测 29 — [明细](PLUGINS-ALL.md#-编码开发268)
- **🤖 Agent 能力**（254）— 可用 134 · 不兼容 44 · 待定 24 · 未测 31 · 监测 21 — [明细](PLUGINS-ALL.md#-agent-能力254)
- **📡 消息通讯**（95）— 可用 49 · 不兼容 17 · 待定 14 · 未测 10 · 监测 5 — [明细](PLUGINS-ALL.md#-消息通讯95)
- **🗂 文件数据**（83）— 可用 39 · 不兼容 19 · 待定 10 · 未测 10 · 监测 5 — [明细](PLUGINS-ALL.md#-文件数据83)
- **🎮 娱乐生活**（51）— 可用 31 · 不兼容 6 · 待定 6 · 未测 3 · 监测 5 — [明细](PLUGINS-ALL.md#-娱乐生活51)
- **🛠 基建部署**（216）— 可用 103 · 不兼容 71 · 待定 17 · 未测 9 · 监测 16 — [明细](PLUGINS-ALL.md#-基建部署216)
- **📚 学习研究**（18）— 可用 7 · 不兼容 5 · 待定 1 · 未测 3 · 监测 2 — [明细](PLUGINS-ALL.md#-学习研究18)
- **❓ 其他**（639）— 可用 334 · 不兼容 131 · 待定 40 · 未测 59 · 监测 75 — [明细](PLUGINS-ALL.md#-其他639)

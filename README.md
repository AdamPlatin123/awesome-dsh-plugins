...
[![confirmed](https://img.shields.io/badge/confirmed-8356-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-11788-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_7879-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1359-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2656-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260831T014501Z`（2026-08-31 09:45:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 16796 · 龄 42m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8356"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 11788"}
    D1 -->|"7879 / 2656"| E1["聚合 + README 分类统计"]
    D1 -->|"1253 环境类重试"| C1
...
- **💻 编码开发**（1684）— 可用 837 · 不兼容 324 · 待定 154 · 未测 18 · 监测 351 — [明细](PLUGINS-ALL.md#-编码开发1684)
...
- **🗂 文件数据**（494）— 可用 233 · 不兼容 85 · 待定 46 · 未测 9 · 监测 121 — [明细](PLUGINS-ALL.md#-文件数据494)
- **🎮 娱乐生活**（329）— 可用 154 · 不兼容 28 · 待定 29 · 未测 0 · 监测 118 — [明细](PLUGINS-ALL.md#-娱乐生活329)
- **🛠 基建部署**（1037）— 可用 408 · 不兼容 127 · 待定 126 · 未测 3 · 监测 373 — [明细](PLUGINS-ALL.md#-基建部署1037)
- **📚 学习研究**（107）— 可用 29 · 不兼容 9 · 待定 8 · 未测 2 · 监测 59 — [明细](PLUGINS-ALL.md#-学习研究107)
- **❓ 其他**（4331）— 可用 1549 · 不兼容 292 · 待定 223 · 未测 20 · 监测 2247 — [明细](PLUGINS-ALL.md#-其他4331)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260831T014501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

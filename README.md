...
[![confirmed](https://img.shields.io/badge/confirmed-639-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12960-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8812-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1784-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2473-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260904T130001Z`（2026-09-04 21:00:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 18084 · 龄 233m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 639"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12960"}
    D1 -->|"8812 / 2473"| E1["聚合 + README 分类统计"]
    D1 -->|"1675 环境类重试"| C1
...
- **🔌 Web UI 增强**（2718）— 可用 1326 · 不兼容 380 · 待定 253 · 未测 16 · 监测 743 — [明细](PLUGINS-ALL.md#-web-ui-增强2718)
...
- **🗂 文件数据**（662）— 可用 268 · 不兼容 91 · 待定 54 · 未测 9 · 监测 240 — [明细](PLUGINS-ALL.md#-文件数据662)
- **🎮 娱乐生活**（448）— 可用 174 · 不兼容 28 · 待定 35 · 未测 0 · 监测 211 — [明细](PLUGINS-ALL.md#-娱乐生活448)
...
- **❓ 其他**（7014）— 可用 1817 · 不兼容 311 · 待定 264 · 未测 21 · 监测 4601 — [明细](PLUGINS-ALL.md#-其他7014)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260904T130001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2275-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1560-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-493-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-222-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260827T193001Z`（2026-08-28 03:30:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15312 · 龄 362m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🔌 Web UI 增强**（514）— 可用 302 · 不兼容 102 · 待定 53 · 未测 31 · 监测 26 — [明细](PLUGINS-ALL.md#-web-ui-增强514)
- **💻 编码开发**（434）— 可用 228 · 不兼容 81 · 待定 56 · 未测 33 · 监测 36 — [明细](PLUGINS-ALL.md#-编码开发434)
- **🤖 Agent 能力**（356）— 可用 174 · 不兼容 87 · 待定 50 · 未测 15 · 监测 30 — [明细](PLUGINS-ALL.md#-agent-能力356)
- **📡 消息通讯**（135）— 可用 68 · 不兼容 37 · 待定 18 · 未测 4 · 监测 8 — [明细](PLUGINS-ALL.md#-消息通讯135)
- **🗂 文件数据**（116）— 可用 52 · 不兼容 23 · 待定 21 · 未测 12 · 监测 8 — [明细](PLUGINS-ALL.md#-文件数据116)
- **🎮 娱乐生活**（64）— 可用 39 · 不兼容 11 · 待定 6 · 未测 1 · 监测 7 — [明细](PLUGINS-ALL.md#-娱乐生活64)
- **🛠 基建部署**（279）— 可用 134 · 不兼容 62 · 待定 51 · 未测 4 · 监测 28 — [明细](PLUGINS-ALL.md#-基建部署279)
- **📚 学习研究**（20）— 可用 11 · 不兼容 4 · 待定 0 · 未测 2 · 监测 3 — [明细](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（750）— 可用 368 · 不兼容 150 · 待定 68 · 未测 31 · 监测 133 — [明细](PLUGINS-ALL.md#-其他750)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260827T193001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-8368-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-11690-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_7815-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1350-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2631-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260830T193001Z`（2026-08-31 03:30:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 16737 · 龄 126m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8368"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 11690"}
    D1 -->|"7815 / 2631"| E1["聚合 + README 分类统计"]
    D1 -->|"1244 环境类重试"| C1
...
- **🔌 Web UI 增强**（2192）— 可用 1204 · 不兼容 390 · 待定 197 · 未测 16 · 监测 385 — [明细](PLUGINS-ALL.md#-web-ui-增强2192)
- **💻 编码开发**（1664）— 可用 830 · 不兼容 319 · 待定 155 · 未测 18 · 监测 342 — [明细](PLUGINS-ALL.md#-编码开发1664)
- **🤖 Agent 能力**（1620）— 可用 724 · 不兼容 296 · 待定 145 · 未测 10 · 监测 445 — [明细](PLUGINS-ALL.md#-agent-能力1620)
- **📡 消息通讯**（547）— 可用 222 · 不兼容 123 · 待定 43 · 未测 3 · 监测 156 — [明细](PLUGINS-ALL.md#-消息通讯547)
- **🗂 文件数据**（489）— 可用 230 · 不兼容 84 · 待定 45 · 未测 9 · 监测 121 — [明细](PLUGINS-ALL.md#-文件数据489)
- **🎮 娱乐生活**（325）— 可用 153 · 不兼容 28 · 待定 29 · 未测 0 · 监测 115 — [明细](PLUGINS-ALL.md#-娱乐生活325)
- **🛠 基建部署**（1030）— 可用 408 · 不兼容 124 · 待定 125 · 未测 3 · 监测 370 — [明细](PLUGINS-ALL.md#-基建部署1030)
- **📚 学习研究**（107）— 可用 29 · 不兼容 9 · 待定 8 · 未测 2 · 监测 59 — [明细](PLUGINS-ALL.md#-学习研究107)
- **❓ 其他**（4279）— 可用 1534 · 不兼容 294 · 待定 222 · 未测 20 · 监测 2209 — [明细](PLUGINS-ALL.md#-其他4279)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260830T193001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。
...
> 渲染于快照 20260830T193001Z（2026-08-31 03:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 7815 可用 · 2631 不兼容 · 1244 待定（共 11690 个，k8s agent 口径）|

...
- **🔌 Web UI 增强**（498）— 可用 271 · 不兼容 124 · 待定 46 · 未测 35 · 监测 22 — [明细](PLUGINS-ALL.md#-web-ui-增强498)
- **💻 编码开发**（413）— 可用 191 · 不兼容 99 · 待定 46 · 未测 44 · 监测 33 — [明细](PLUGINS-ALL.md#-编码开发413)
...
- **🗂 文件数据**（107）— 可用 50 · 不兼容 23 · 待定 16 · 未测 13 · 监测 5 — [明细](PLUGINS-ALL.md#-文件数据107)
- **🎮 娱乐生活**（61）— 可用 34 · 不兼容 14 · 待定 7 · 未测 1 · 监测 5 — [明细](PLUGINS-ALL.md#-娱乐生活61)
- **🛠 基建部署**（273）— 可用 98 · 不兼容 112 · 待定 31 · 未测 7 · 监测 25 — [明细](PLUGINS-ALL.md#-基建部署273)
- **📚 学习研究**（20）— 可用 7 · 不兼容 7 · 待定 0 · 未测 2 · 监测 4 — [明细](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（731）— 可用 325 · 不兼容 192 · 待定 58 · 未测 54 · 监测 102 — [明细](PLUGINS-ALL.md#-其他731)

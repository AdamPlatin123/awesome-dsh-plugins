...
[![运行级可用](https://img.shields.io/badge/运行级可用-1146-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-806-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-141-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260826T130001Z`（2026-08-26 21:00:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 14541 · 龄 965m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🔌 Web UI 增强**（486）— 可用 254 · 不兼容 107 · 待定 44 · 未测 38 · 监测 43 — [明细](PLUGINS-ALL.md#-web-ui-增强486)
- **💻 编码开发**（410）— 可用 184 · 不兼容 86 · 待定 41 · 未测 52 · 监测 47 — [明细](PLUGINS-ALL.md#-编码开发410)
- **🤖 Agent 能力**（347）— 可用 141 · 不兼容 84 · 待定 39 · 未测 29 · 监测 54 — [明细](PLUGINS-ALL.md#-agent-能力347)
- **📡 消息通讯**（133）— 可用 61 · 不兼容 36 · 待定 14 · 未测 8 · 监测 14 — [明细](PLUGINS-ALL.md#-消息通讯133)
- **🗂 文件数据**（108）— 可用 48 · 不兼容 23 · 待定 15 · 未测 15 · 监测 7 — [明细](PLUGINS-ALL.md#-文件数据108)
- **🎮 娱乐生活**（61）— 可用 31 · 不兼容 13 · 待定 7 · 未测 2 · 监测 8 — [明细](PLUGINS-ALL.md#-娱乐生活61)
- **🛠 基建部署**（262）— 可用 95 · 不兼容 90 · 待定 24 · 未测 8 · 监测 45 — [明细](PLUGINS-ALL.md#-基建部署262)
- **📚 学习研究**（19）— 可用 5 · 不兼容 4 · 待定 0 · 未测 3 · 监测 7 — [明细](PLUGINS-ALL.md#-学习研究19)
- **❓ 其他**（723）— 可用 283 · 不兼容 136 · 待定 45 · 未测 60 · 监测 199 — [明细](PLUGINS-ALL.md#-其他723)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260826T130001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

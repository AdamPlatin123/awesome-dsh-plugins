...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2220-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1515-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-482-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-223-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260827T191501Z`（2026-08-28 03:15:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15312 · 龄 347m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🔌 Web UI 增强**（513）— 可用 298 · 不兼容 103 · 待定 54 · 未测 32 · 监测 26 — [明细](PLUGINS-ALL.md#-web-ui-增强513)
- **💻 编码开发**（427）— 可用 223 · 不兼容 81 · 待定 54 · 未测 34 · 监测 35 — [明细](PLUGINS-ALL.md#-编码开发427)
- **🤖 Agent 能力**（357）— 可用 176 · 不兼容 89 · 待定 46 · 未测 17 · 监测 29 — [明细](PLUGINS-ALL.md#-agent-能力357)
- **📡 消息通讯**（135）— 可用 71 · 不兼容 36 · 待定 16 · 未测 4 · 监测 8 — [明细](PLUGINS-ALL.md#-消息通讯135)
- **🗂 文件数据**（113）— 可用 51 · 不兼容 23 · 待定 21 · 未测 12 · 监测 6 — [明细](PLUGINS-ALL.md#-文件数据113)
- **🎮 娱乐生活**（64）— 可用 39 · 不兼容 11 · 待定 6 · 未测 1 · 监测 7 — [明细](PLUGINS-ALL.md#-娱乐生活64)
- **🛠 基建部署**（278）— 可用 134 · 不兼容 61 · 待定 50 · 未测 5 · 监测 28 — [明细](PLUGINS-ALL.md#-基建部署278)
- **📚 学习研究**（20）— 可用 11 · 不兼容 4 · 待定 0 · 未测 2 · 监测 3 — [明细](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（737）— 可用 364 · 不兼容 149 · 待定 66 · 未测 37 · 监测 121 — [明细](PLUGINS-ALL.md#-其他737)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260827T191501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

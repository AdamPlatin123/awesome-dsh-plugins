...
> 数据截至快照 `20260902T083001Z`（2026-09-02 16:30:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17572 · 龄 186m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 9039"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
...
- **🔌 Web UI 增强**（2329）— 可用 1285 · 不兼容 382 · 待定 227 · 未测 16 · 监测 419 — [明细](PLUGINS-ALL.md#-web-ui-增强2329)
- **💻 编码开发**（1786）— 可用 882 · 不兼容 333 · 待定 174 · 未测 19 · 监测 378 — [明细](PLUGINS-ALL.md#-编码开发1786)
- **🤖 Agent 能力**（1736）— 可用 777 · 不兼容 298 · 待定 167 · 未测 10 · 监测 484 — [明细](PLUGINS-ALL.md#-agent-能力1736)
- **📡 消息通讯**（569）— 可用 236 · 不兼容 120 · 待定 51 · 未测 3 · 监测 159 — [明细](PLUGINS-ALL.md#-消息通讯569)
- **🗂 文件数据**（526）— 可用 250 · 不兼容 85 · 待定 49 · 未测 9 · 监测 133 — [明细](PLUGINS-ALL.md#-文件数据526)
- **🎮 娱乐生活**（346）— 可用 164 · 不兼容 25 · 待定 28 · 未测 0 · 监测 129 — [明细](PLUGINS-ALL.md#-娱乐生活346)
- **🛠 基建部署**（1075）— 可用 420 · 不兼容 126 · 待定 136 · 未测 3 · 监测 390 — [明细](PLUGINS-ALL.md#-基建部署1075)
- **📚 学习研究**（114）— 可用 32 · 不兼容 9 · 待定 7 · 未测 2 · 监测 64 — [明细](PLUGINS-ALL.md#-学习研究114)
- **❓ 其他**（4825）— 可用 1750 · 不兼容 302 · 待定 238 · 未测 21 · 监测 2514 — [明细](PLUGINS-ALL.md#-其他4825)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260902T083001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

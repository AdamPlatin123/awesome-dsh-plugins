...
[![confirmed](https://img.shields.io/badge/confirmed-4601-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-5251-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-3478-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1145-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-628-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T081501Z`（2026-08-28 16:15:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15576 · 龄 168m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    C1 --> D1{"判定 · 总 5251"}
    D1 -->|"3478 / 1145"| E1["聚合 + README 分类统计"]
    D1 -->|"628 环境类重试"| C1
...
- **🛒 市场与管理**（154）— 可用 59 · 不兼容 20 · 待定 11 · 未测 8 · 监测 56 — [明细](PLUGINS-ALL.md#-市场与管理154)
- **🔌 Web UI 增强**（1157）— 可用 630 · 不兼容 221 · 待定 114 · 未测 25 · 监测 167 — [明细](PLUGINS-ALL.md#-web-ui-增强1157)
- **💻 编码开发**（881）— 可用 438 · 不兼容 172 · 待定 106 · 未测 22 · 监测 143 — [明细](PLUGINS-ALL.md#-编码开发881)
- **🤖 Agent 能力**（736）— 可用 331 · 不兼容 140 · 待定 94 · 未测 13 · 监测 158 — [明细](PLUGINS-ALL.md#-agent-能力736)
- **📡 消息通讯**（287）— 可用 120 · 不兼容 71 · 待定 31 · 未测 3 · 监测 62 — [明细](PLUGINS-ALL.md#-消息通讯287)
- **🗂 文件数据**（245）— 可用 107 · 不兼容 49 · 待定 33 · 未测 9 · 监测 47 — [明细](PLUGINS-ALL.md#-文件数据245)
- **🎮 娱乐生活**（149）— 可用 78 · 不兼容 12 · 待定 17 · 未测 1 · 监测 41 — [明细](PLUGINS-ALL.md#-娱乐生活149)
- **🛠 基建部署**（590）— 可用 238 · 不兼容 86 · 待定 87 · 未测 4 · 监测 175 — [明细](PLUGINS-ALL.md#-基建部署590)
- **📚 学习研究**（55）— 可用 17 · 不兼容 5 · 待定 3 · 未测 2 · 监测 28 — [明细](PLUGINS-ALL.md#-学习研究55)
- **❓ 其他**（1783）— 可用 571 · 不兼容 209 · 待定 132 · 未测 23 · 监测 848 — [明细](PLUGINS-ALL.md#-其他1783)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T081501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

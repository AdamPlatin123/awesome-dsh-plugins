...
[![confirmed](https://img.shields.io/badge/confirmed-3022-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2803-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1828-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-631-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-344-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T001501Z`（2026-08-28 08:15:01 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15459 · 龄 187m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 3022"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 2803"}
    D1 -->|"1828 / 631"| E1["聚合 + README 分类统计"]
    D1 -->|"344 环境类重试"| C1
...
- **🎓 技能包**（27）— 可用 6 · 不兼容 1 · 待定 3 · 未测 14 · 监测 3 — [明细](PLUGINS-ALL.md#-技能包27)
- **🧠 记忆增强**（22）— 可用 11 · 不兼容 2 · 待定 3 · 未测 4 · 监测 2 — [明细](PLUGINS-ALL.md#-记忆增强22)
- **🎨 主题皮肤**（14）— 可用 4 · 不兼容 0 · 待定 2 · 未测 7 · 监测 1 — [明细](PLUGINS-ALL.md#-主题皮肤14)
- **🛒 市场与管理**（99）— 可用 43 · 不兼容 14 · 待定 7 · 未测 10 · 监测 25 — [明细](PLUGINS-ALL.md#-市场与管理99)
- **🔌 Web UI 增强**（679）— 可用 376 · 不兼容 140 · 待定 76 · 未测 28 · 监测 59 — [明细](PLUGINS-ALL.md#-web-ui-增强679)
- **💻 编码开发**（541）— 可用 276 · 不兼容 100 · 待定 77 · 未测 27 · 监测 61 — [明细](PLUGINS-ALL.md#-编码开发541)
- **🤖 Agent 能力**（437）— 可用 202 · 不兼容 97 · 待定 68 · 未测 15 · 监测 55 — [明细](PLUGINS-ALL.md#-agent-能力437)
- **📡 消息通讯**（175）— 可用 77 · 不兼容 50 · 待定 27 · 未测 3 · 监测 18 — [明细](PLUGINS-ALL.md#-消息通讯175)
- **🗂 文件数据**（143）— 可用 61 · 不兼容 25 · 待定 27 · 未测 12 · 监测 18 — [明细](PLUGINS-ALL.md#-文件数据143)
- **🎮 娱乐生活**（87）— 可用 51 · 不兼容 8 · 待定 10 · 未测 1 · 监测 17 — [明细](PLUGINS-ALL.md#-娱乐生活87)
- **🛠 基建部署**（375）— 可用 163 · 不兼容 70 · 待定 64 · 未测 4 · 监测 74 — [明细](PLUGINS-ALL.md#-基建部署375)
- **📚 学习研究**（27）— 可用 10 · 不兼容 4 · 待定 1 · 未测 2 · 监测 10 — [明细](PLUGINS-ALL.md#-学习研究27)
- **❓ 其他**（1049）— 可用 420 · 不兼容 163 · 待定 112 · 未测 26 · 监测 328 — [明细](PLUGINS-ALL.md#-其他1049)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T001501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

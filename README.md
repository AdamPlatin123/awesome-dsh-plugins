...
[![confirmed](https://img.shields.io/badge/confirmed-8940-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12448-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8373-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1534-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2649-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260902T063002Z`（2026-09-02 14:30:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17572 · 龄 66m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8940"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12448"}
    D1 -->|"8373 / 2649"| E1["聚合 + README 分类统计"]
    D1 -->|"1426 环境类重试"| C1
...
- **🔌 Web UI 增强**（2307）— 可用 1271 · 不兼容 378 · 待定 225 · 未测 16 · 监测 417 — [明细](PLUGINS-ALL.md#-web-ui-增强2307)
- **💻 编码开发**（1774）— 可用 878 · 不兼容 332 · 待定 172 · 未测 19 · 监测 373 — [明细](PLUGINS-ALL.md#-编码开发1774)
- **🤖 Agent 能力**（1725）— 可用 774 · 不兼容 295 · 待定 166 · 未测 10 · 监测 480 — [明细](PLUGINS-ALL.md#-agent-能力1725)
- **📡 消息通讯**（567）— 可用 234 · 不兼容 120 · 待定 51 · 未测 3 · 监测 159 — [明细](PLUGINS-ALL.md#-消息通讯567)
...
- **🛠 基建部署**（1070）— 可用 417 · 不兼容 127 · 待定 135 · 未测 3 · 监测 388 — [明细](PLUGINS-ALL.md#-基建部署1070)
- **📚 学习研究**（113）— 可用 32 · 不兼容 9 · 待定 7 · 未测 2 · 监测 63 — [明细](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4781）— 可用 1724 · 不兼容 299 · 待定 237 · 未测 21 · 监测 2500 — [明细](PLUGINS-ALL.md#-其他4781)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260902T063002Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![运行级可用](https://img.shields.io/badge/运行级可用-1517-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-460-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-220-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260827T174501Z`（2026-08-28 01:45:01 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15312 · 龄 256m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🔌 Web UI 增强**（510）— 可用 300 · 不兼容 102 · 待定 50 · 未测 32 · 监测 26 — [明细](PLUGINS-ALL.md#-web-ui-增强510)
- **💻 编码开发**（426）— 可用 222 · 不兼容 79 · 待定 52 · 未测 38 · 监测 35 — [明细](PLUGINS-ALL.md#-编码开发426)
- **🤖 Agent 能力**（355）— 可用 174 · 不兼容 87 · 待定 47 · 未测 18 · 监测 29 — [明细](PLUGINS-ALL.md#-agent-能力355)
- **📡 消息通讯**（135）— 可用 72 · 不兼容 36 · 待定 15 · 未测 4 · 监测 8 — [明细](PLUGINS-ALL.md#-消息通讯135)
- **🗂 文件数据**（112）— 可用 51 · 不兼容 22 · 待定 21 · 未测 12 · 监测 6 — [明细](PLUGINS-ALL.md#-文件数据112)
- **🎮 娱乐生活**（64）— 可用 39 · 不兼容 11 · 待定 6 · 未测 1 · 监测 7 — [明细](PLUGINS-ALL.md#-娱乐生活64)
- **🛠 基建部署**（277）— 可用 136 · 不兼容 60 · 待定 48 · 未测 5 · 监测 28 — [明细](PLUGINS-ALL.md#-基建部署277)
- **📚 学习研究**（20）— 可用 11 · 不兼容 4 · 待定 0 · 未测 2 · 监测 3 — [明细](PLUGINS-ALL.md#-学习研究20)
- **❓ 其他**（742）— 可用 368 · 不兼容 148 · 待定 63 · 未测 44 · 监测 119 — [明细](PLUGINS-ALL.md#-其他742)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260827T174501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

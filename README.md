...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-17 20:29（UTC+8）。

### 🚀 智力增强 Booster（6）

| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | 3307 | — | 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测） |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3986 | ✅ | Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1890 | ✅ | 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页 |
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 175 | ✅ | GenUI 内联组件：图表/表单/测验/3D 场景 + action 事件环 |
...
| [deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) | 411 | ✅ | Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux |
| [Bigfish](https://github.com/turtle2209/Bigfish) | 249 | — | 第三方桌面端：内置 Node 运行时，双击即用 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [modlens](https://github.com/liustack/modlens) | 2700 | ✅ | 生态第一个视觉插件，视觉工作流的基准方案 |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 596 | 需适配 | 带意图图片问答、长截图 OCR、UI 还原 |
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 578 | ✅ | 内置免费视觉模型路由，给文本 agent 装眼睛 |
...
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 476 | 待定 | 多代理团队编排 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 318 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 144 | — | 五轨记忆 + git 分支托管 + 后台自我进化 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 237 | — | Chrome 侧栏扩展，让 DSH 直接操作浏览器 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-market](https://github.com/dsh-market/dsh-market) | 791 | ✅ | 持续收录 1000+ 插件的市场：中文搜索 + 五维评分 |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 478 | ✅ | 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗 |
| [whale-girl](https://github.com/vlln/whale-girl) | 216 | ✅ | QQ 宠物形态桌宠：可拖拽/投喂/玩耍 |
| [dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) | 51 | ✅ | 小坤桌宠：随 Agent 工作状态切换 9 种动作 |

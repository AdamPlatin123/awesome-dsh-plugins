...
[![confirmed](https://img.shields.io/badge/confirmed-209-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12603-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8516-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1570-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2625-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260903T000003Z`（2026-09-03 08:00:04 UTC+8 · 分类器 unified-v2-bridge）
...
flowchart TB
    ...
    B1 -->|"插件 209"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12603"}
    D1 -->|"8516 / 2625"| E1["聚合 + README 分类统计"]
    D1 -->|"1462 环境类重试"| C1
...
- **🎓 技能包**（115）— 可用 62 · 不兼容 19 · 待定 20 · 未测 11 · 监测 3 — [明细](PLUGINS-ALL.md#-技能包115)
- **🧠 记忆增强**（98）— 可用 47 · 不兼容 20 · 待定 9 · 未测 2 · 监测 20 — [明细](PLUGINS-ALL.md#-记忆增强98)
- **🎨 主题皮肤**（51）— 可用 32 · 不兼容 5 · 待定 6 · 未测 5 · 监测 3 — [明细](PLUGINS-ALL.md#-主题皮肤51)
- **🛒 市场与管理**（365）— 可用 143 · 不兼容 35 · 待定 22 · 未测 7 · 监测 158 — [明细](PLUGINS-ALL.md#-市场与管理365)
- **🔌 Web UI 增强**（2210）— 可用 1012 · 不兼容 308 · 待定 150 · 未测 16 · 监测 724 — [明细](PLUGINS-ALL.md#-web-ui-增强2210)
- **💻 编码开发**（1904）— 可用 792 · 不兼容 310 · 待定 147 · 未测 19 · 监测 636 — [明细](PLUGINS-ALL.md#-编码开发1904)
- **🤖 Agent 能力**（2176）— 可用 766 · 不兼容 291 · 待定 169 · 未测 10 · 监测 940 — [明细](PLUGINS-ALL.md#-agent-能力2176)
- **📡 消息通讯**（667）— 可用 228 · 不兼容 116 · 待定 44 · 未测 3 · 监测 276 — [明细](PLUGINS-ALL.md#-消息通讯667)
- **🗂 文件数据**（647）— 可用 263 · 不兼容 92 · 待定 46 · 未测 9 · 监测 237 — [明细](PLUGINS-ALL.md#-文件数据647)
- **🎮 娱乐生活**（448）— 可用 179 · 不兼容 34 · 待定 27 · 未测 0 · 监测 208 — [明细](PLUGINS-ALL.md#-娱乐生活448)
- **🛠 基建部署**（1393）— 可用 477 · 不兼容 134 · 待定 144 · 未测 3 · 监测 635 — [明细](PLUGINS-ALL.md#-基建部署1393)
- **📚 学习研究**（164）— 可用 40 · 不兼容 15 · 待定 11 · 未测 2 · 监测 96 — [明细](PLUGINS-ALL.md#-学习研究164)
- **❓ 其他**（7091）— 可用 1907 · 不兼容 361 · 待定 275 · 未测 21 · 监测 4527 — [明细](PLUGINS-ALL.md#-其他7091)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260903T000003Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

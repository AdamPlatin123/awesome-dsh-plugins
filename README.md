...
[![confirmed](https://img.shields.io/badge/confirmed-5945-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-7227-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-4799-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1603-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-825-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T124501Z`（2026-08-28 20:45:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15618 · 龄 222m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 5945"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 7227"}
    D1 -->|"4799 / 1603"| E1["聚合 + README 分类统计"]
    D1 -->|"825 环境类重试"| C1
...
- **🛒 市场与管理**（173）— 可用 73 · 不兼容 15 · 待定 12 · 未测 7 · 监测 66 — [明细](PLUGINS-ALL.md#-市场与管理173)
- **🔌 Web UI 增强**（1495）— 可用 831 · 不兼容 259 · 待定 142 · 未测 21 · 监测 242 — [明细](PLUGINS-ALL.md#-web-ui-增强1495)
- **💻 编码开发**（1137）— 可用 590 · 不兼容 206 · 待定 124 · 未测 20 · 监测 197 — [明细](PLUGINS-ALL.md#-编码开发1137)
- **🤖 Agent 能力**（959）— 可用 436 · 不兼容 163 · 待定 106 · 未测 12 · 监测 242 — [明细](PLUGINS-ALL.md#-agent-能力959)
- **📡 消息通讯**（382）— 可用 160 · 不兼容 83 · 待定 35 · 未测 3 · 监测 101 — [明细](PLUGINS-ALL.md#-消息通讯382)
- **🗂 文件数据**（320）— 可用 147 · 不兼容 58 · 待定 37 · 未测 9 · 监测 69 — [明细](PLUGINS-ALL.md#-文件数据320)
- **🎮 娱乐生活**（202）— 可用 98 · 不兼容 16 · 待定 22 · 未测 0 · 监测 66 — [明细](PLUGINS-ALL.md#-娱乐生活202)
- **🛠 基建部署**（749）— 可用 304 · 不兼容 92 · 待定 105 · 未测 3 · 监测 245 — [明细](PLUGINS-ALL.md#-基建部署749)
- **📚 学习研究**（71）— 可用 21 · 不兼容 5 · 待定 3 · 未测 2 · 监测 40 — [明细](PLUGINS-ALL.md#-学习研究71)
- **❓ 其他**（2368）— 可用 742 · 不兼容 211 · 待定 153 · 未测 21 · 监测 1241 — [明细](PLUGINS-ALL.md#-其他2368)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T124501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-7827-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-11160-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_7444-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1617-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2205-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260829T224501Z`（2026-08-30 06:45:04 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 16357 · 龄 95m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 7827"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 11160"}
    D1 -->|"7444 / 2205"| E1["聚合 + README 分类统计"]
    D1 -->|"1511 环境类重试"| C1
...
- **🔌 Web UI 增强**（2107）— 可用 1158 · 不兼容 319 · 待定 246 · 未测 16 · 监测 368 — [明细](PLUGINS-ALL.md#-web-ui-增强2107)
- **💻 编码开发**（1584）— 可用 789 · 不兼容 277 · 待定 176 · 未测 18 · 监测 324 — [明细](PLUGINS-ALL.md#-编码开发1584)
- **🤖 Agent 能力**（1559）— 可用 704 · 不兼容 247 · 待定 175 · 未测 10 · 监测 423 — [明细](PLUGINS-ALL.md#-agent-能力1559)
- **📡 消息通讯**（535）— 可用 219 · 不兼容 111 · 待定 50 · 未测 3 · 监测 152 — [明细](PLUGINS-ALL.md#-消息通讯535)
- **🗂 文件数据**（474）— 可用 222 · 不兼容 70 · 待定 54 · 未测 9 · 监测 119 — [明细](PLUGINS-ALL.md#-文件数据474)
- **🎮 娱乐生活**（305）— 可用 145 · 不兼容 27 · 待定 29 · 未测 0 · 监测 104 — [明细](PLUGINS-ALL.md#-娱乐生活305)
- **🛠 基建部署**（991）— 可用 390 · 不兼容 107 · 待定 137 · 未测 3 · 监测 354 — [明细](PLUGINS-ALL.md#-基建部署991)
- **📚 学习研究**（104）— 可用 28 · 不兼容 8 · 待定 9 · 未测 2 · 监测 57 — [明细](PLUGINS-ALL.md#-学习研究104)
- **❓ 其他**（4035）— 可用 1438 · 不兼容 263 · 待定 232 · 未测 20 · 监测 2082 — [明细](PLUGINS-ALL.md#-其他4035)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260829T224501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

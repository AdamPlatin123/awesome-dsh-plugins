...
[![confirmed](https://img.shields.io/badge/confirmed-3034-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-3169-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-2075-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-697-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-397-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T011501Z`（2026-08-28 09:15:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15484 · 龄 13m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 3034"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 3169"}
    D1 -->|"2075 / 697"| E1["聚合 + README 分类统计"]
    D1 -->|"397 环境类重试"| C1
...
- **🛒 市场与管理**（107）— 可用 45 · 不兼容 16 · 待定 8 · 未测 10 · 监测 28 — [明细](PLUGINS-ALL.md#-市场与管理107)
- **🔌 Web UI 增强**（742）— 可用 412 · 不兼容 146 · 待定 81 · 未测 26 · 监测 77 — [明细](PLUGINS-ALL.md#-web-ui-增强742)
- **💻 编码开发**（588）— 可用 297 · 不兼容 109 · 待定 80 · 未测 27 · 监测 75 — [明细](PLUGINS-ALL.md#-编码开发588)
- **🤖 Agent 能力**（475）— 可用 221 · 不兼容 103 · 待定 73 · 未测 14 · 监测 64 — [明细](PLUGINS-ALL.md#-agent-能力475)
- **📡 消息通讯**（193）— 可用 85 · 不兼容 52 · 待定 28 · 未测 3 · 监测 25 — [明细](PLUGINS-ALL.md#-消息通讯193)
- **🗂 文件数据**（162）— 可用 69 · 不兼容 31 · 待定 28 · 未测 12 · 监测 22 — [明细](PLUGINS-ALL.md#-文件数据162)
- **🎮 娱乐生活**（99）— 可用 55 · 不兼容 9 · 待定 13 · 未测 1 · 监测 21 — [明细](PLUGINS-ALL.md#-娱乐生活99)
- **🛠 基建部署**（425）— 可用 180 · 不兼容 73 · 待定 70 · 未测 4 · 监测 98 — [明细](PLUGINS-ALL.md#-基建部署425)
- **📚 学习研究**（34）— 可用 12 · 不兼容 4 · 待定 2 · 未测 2 · 监测 14 — [明细](PLUGINS-ALL.md#-学习研究34)
- **❓ 其他**（1150）— 可用 433 · 不兼容 172 · 待定 115 · 未测 26 · 监测 404 — [明细](PLUGINS-ALL.md#-其他1150)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T011501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

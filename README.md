...
[![confirmed](https://img.shields.io/badge/confirmed-4793-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-5695-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-3767-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1256-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-672-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T091501Z`（2026-08-28 17:15:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15618 · 龄 13m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 4793"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 5695"}
    D1 -->|"3767 / 1256"| E1["聚合 + README 分类统计"]
    D1 -->|"672 环境类重试"| C1
...
- **🧠 记忆增强**（26）— 可用 13 · 不兼容 2 · 待定 3 · 未测 4 · 监测 4 — [明细](PLUGINS-ALL.md#-记忆增强26)
- **🎨 主题皮肤**（17）— 可用 6 · 不兼容 0 · 待定 2 · 未测 7 · 监测 2 — [明细](PLUGINS-ALL.md#-主题皮肤17)
- **🛒 市场与管理**（161）— 可用 62 · 不兼容 20 · 待定 11 · 未测 8 · 监测 60 — [明细](PLUGINS-ALL.md#-市场与管理161)
- **🔌 Web UI 增强**（1233）— 可用 675 · 不兼容 235 · 待定 121 · 未测 22 · 监测 180 — [明细](PLUGINS-ALL.md#-web-ui-增强1233)
- **💻 编码开发**（932）— 可用 462 · 不兼容 187 · 待定 109 · 未测 22 · 监测 152 — [明细](PLUGINS-ALL.md#-编码开发932)
- **🤖 Agent 能力**（795）— 可用 349 · 不兼容 150 · 待定 98 · 未测 13 · 监测 185 — [明细](PLUGINS-ALL.md#-agent-能力795)
- **📡 消息通讯**（311）— 可用 129 · 不兼容 74 · 待定 32 · 未测 3 · 监测 73 — [明细](PLUGINS-ALL.md#-消息通讯311)
- **🗂 文件数据**（272）— 可用 117 · 不兼容 54 · 待定 36 · 未测 9 · 监测 56 — [明细](PLUGINS-ALL.md#-文件数据272)
- **🎮 娱乐生活**（159）— 可用 82 · 不兼容 15 · 待定 17 · 未测 0 · 监测 45 — [明细](PLUGINS-ALL.md#-娱乐生活159)
- **🛠 基建部署**（638）— 可用 256 · 不兼容 92 · 待定 91 · 未测 4 · 监测 195 — [明细](PLUGINS-ALL.md#-基建部署638)
- **📚 学习研究**（59）— 可用 18 · 不兼容 5 · 待定 3 · 未测 2 · 监测 31 — [明细](PLUGINS-ALL.md#-学习研究59)
- **❓ 其他**（1914）— 可用 607 · 不兼容 218 · 待定 134 · 未测 21 · 监测 934 — [明细](PLUGINS-ALL.md#-其他1914)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T091501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

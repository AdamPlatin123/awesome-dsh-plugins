...
[![confirmed](https://img.shields.io/badge/confirmed-4758-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-5598-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-3699-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1232-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-667-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T090001Z`（2026-08-28 17:00:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15576 · 龄 213m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 4758"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 5598"}
    D1 -->|"3699 / 1232"| E1["聚合 + README 分类统计"]
    D1 -->|"667 环境类重试"| C1
...
- **🛒 市场与管理**（160）— 可用 62 · 不兼容 20 · 待定 11 · 未测 8 · 监测 59 — [明细](PLUGINS-ALL.md#-市场与管理160)
- **🔌 Web UI 增强**（1219）— 可用 666 · 不兼容 231 · 待定 121 · 未测 23 · 监测 178 — [明细](PLUGINS-ALL.md#-web-ui-增强1219)
- **💻 编码开发**（924）— 可用 459 · 不兼容 185 · 待定 108 · 未测 22 · 监测 150 — [明细](PLUGINS-ALL.md#-编码开发924)
- **🤖 Agent 能力**（778）— 可用 344 · 不兼容 147 · 待定 95 · 未测 13 · 监测 179 — [明细](PLUGINS-ALL.md#-agent-能力778)
- **📡 消息通讯**（308）— 可用 127 · 不兼容 75 · 待定 32 · 未测 3 · 监测 71 — [明细](PLUGINS-ALL.md#-消息通讯308)
- **🗂 文件数据**（265）— 可用 116 · 不兼容 54 · 待定 35 · 未测 9 · 监测 51 — [明细](PLUGINS-ALL.md#-文件数据265)
- **🎮 娱乐生活**（158）— 可用 81 · 不兼容 15 · 待定 18 · 未测 0 · 监测 44 — [明细](PLUGINS-ALL.md#-娱乐生活158)
- **🛠 基建部署**（626）— 可用 248 · 不兼容 92 · 待定 89 · 未测 4 · 监测 193 — [明细](PLUGINS-ALL.md#-基建部署626)
- **📚 学习研究**（58）— 可用 18 · 不兼容 5 · 待定 3 · 未测 2 · 监测 30 — [明细](PLUGINS-ALL.md#-学习研究58)
- **❓ 其他**（1883）— 可用 597 · 不兼容 215 · 待定 135 · 未测 21 · 监测 915 — [明细](PLUGINS-ALL.md#-其他1883)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T090001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

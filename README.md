...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2325-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1590-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-508-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-227-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260827T194501Z`（2026-08-28 03:45:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15312 · 龄 377m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🔌 Web UI 增强**（522）— 可用 305 · 不兼容 105 · 待定 53 · 未测 30 · 监测 29 — [明细](PLUGINS-ALL.md#-web-ui-增强522)
- **💻 编码开发**（436）— 可用 229 · 不兼容 81 · 待定 56 · 未测 32 · 监测 38 — [明细](PLUGINS-ALL.md#-编码开发436)
- **🤖 Agent 能力**（360）— 可用 176 · 不兼容 87 · 待定 50 · 未测 15 · 监测 32 — [明细](PLUGINS-ALL.md#-agent-能力360)
- **📡 消息通讯**（138）— 可用 68 · 不兼容 38 · 待定 18 · 未测 4 · 监测 10 — [明细](PLUGINS-ALL.md#-消息通讯138)
- **🗂 文件数据**（117）— 可用 53 · 不兼容 23 · 待定 21 · 未测 12 · 监测 8 — [明细](PLUGINS-ALL.md#-文件数据117)
- **🎮 娱乐生活**（64）— 可用 39 · 不兼容 11 · 待定 6 · 未测 1 · 监测 7 — [明细](PLUGINS-ALL.md#-娱乐生活64)
- **🛠 基建部署**（285）— 可用 136 · 不兼容 63 · 待定 51 · 未测 4 · 监测 31 — [明细](PLUGINS-ALL.md#-基建部署285)
- **📚 学习研究**（21）— 可用 11 · 不兼容 4 · 待定 0 · 未测 2 · 监测 4 — [明细](PLUGINS-ALL.md#-学习研究21)
- **❓ 其他**（770）— 可用 371 · 不兼容 151 · 待定 69 · 未测 31 · 监测 148 — [明细](PLUGINS-ALL.md#-其他770)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260827T194501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

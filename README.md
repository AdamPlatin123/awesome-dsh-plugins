...
[![confirmed](https://img.shields.io/badge/confirmed-774-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13181-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8993-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1741-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2556-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260904T184501Z`（2026-09-05 02:45:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 18184 · 龄 301m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 774"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13181"}
    D1 -->|"8993 / 2556"| E1["聚合 + README 分类统计"]
    D1 -->|"1632 环境类重试"| C1
...
- **🛒 市场与管理**（306）— 可用 99 · 不兼容 21 · 待定 17 · 未测 8 · 监测 161 — [明细](PLUGINS-ALL.md#-市场与管理306)
- **🔌 Web UI 增强**（2752）— 可用 1350 · 不兼容 389 · 待定 248 · 未测 16 · 监测 749 — [明细](PLUGINS-ALL.md#-web-ui-增强2752)
- **💻 编码开发**（2129）— 可用 932 · 不兼容 340 · 待定 184 · 未测 19 · 监测 654 — [明细](PLUGINS-ALL.md#-编码开发2129)
- **🤖 Agent 能力**（2227）— 可用 819 · 不兼容 264 · 待定 160 · 未测 10 · 监测 974 — [明细](PLUGINS-ALL.md#-agent-能力2227)
- **📡 消息通讯**（709）— 可用 257 · 不兼容 118 · 待定 49 · 未测 3 · 监测 282 — [明细](PLUGINS-ALL.md#-消息通讯709)
- **🗂 文件数据**（669）— 可用 270 · 不兼容 93 · 待定 55 · 未测 9 · 监测 242 — [明细](PLUGINS-ALL.md#-文件数据669)
- **🎮 娱乐生活**（450）— 可用 175 · 不兼容 31 · 待定 32 · 未测 0 · 监测 212 — [明细](PLUGINS-ALL.md#-娱乐生活450)
- **🛠 基建部署**（1344）— 可用 446 · 不兼容 129 · 待定 121 · 未测 3 · 监测 645 — [明细](PLUGINS-ALL.md#-基建部署1344)
- **📚 学习研究**（153）— 可用 35 · 不兼容 8 · 待定 8 · 未测 2 · 监测 100 — [明细](PLUGINS-ALL.md#-学习研究153)
- **❓ 其他**（7102）— 可用 1847 · 不兼容 319 · 待定 257 · 未测 21 · 监测 4658 — [明细](PLUGINS-ALL.md#-其他7102)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260904T184501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-5782-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-6991-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-4640-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1548-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-803-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T121501Z`（2026-08-28 20:15:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15618 · 龄 193m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 5782"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 6991"}
    D1 -->|"4640 / 1548"| E1["聚合 + README 分类统计"]
    D1 -->|"803 环境类重试"| C1
...
- **🛒 市场与管理**（172）— 可用 73 · 不兼容 15 · 待定 12 · 未测 8 · 监测 64 — [明细](PLUGINS-ALL.md#-市场与管理172)
- **🔌 Web UI 增强**（1452）— 可用 810 · 不兼容 251 · 待定 139 · 未测 21 · 监测 231 — [明细](PLUGINS-ALL.md#-web-ui-增强1452)
- **💻 编码开发**（1102）— 可用 572 · 不兼容 201 · 待定 120 · 未测 20 · 监测 189 — [明细](PLUGINS-ALL.md#-编码开发1102)
- **🤖 Agent 能力**（929）— 可用 427 · 不兼容 157 · 待定 104 · 未测 12 · 监测 229 — [明细](PLUGINS-ALL.md#-agent-能力929)
- **📡 消息通讯**（380）— 可用 159 · 不兼容 83 · 待定 35 · 未测 3 · 监测 100 — [明细](PLUGINS-ALL.md#-消息通讯380)
- **🗂 文件数据**（308）— 可用 141 · 不兼容 56 · 待定 37 · 未测 9 · 监测 65 — [明细](PLUGINS-ALL.md#-文件数据308)
- **🎮 娱乐生活**（193）— 可用 95 · 不兼容 15 · 待定 21 · 未测 0 · 监测 62 — [明细](PLUGINS-ALL.md#-娱乐生活193)
- **🛠 基建部署**（730）— 可用 297 · 不兼容 91 · 待定 104 · 未测 3 · 监测 235 — [明细](PLUGINS-ALL.md#-基建部署730)
- **📚 学习研究**（68）— 可用 20 · 不兼容 5 · 待定 3 · 未测 2 · 监测 38 — [明细](PLUGINS-ALL.md#-学习研究68)
- **❓ 其他**（2287）— 可用 726 · 不兼容 205 · 待定 153 · 未测 21 · 监测 1182 — [明细](PLUGINS-ALL.md#-其他2287)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T121501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-8364-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-11757-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_7857-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1356-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2650-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260830T223001Z`（2026-08-31 06:30:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 16768 · 龄 82m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8364"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 11757"}
    D1 -->|"7857 / 2650"| E1["聚合 + README 分类统计"]
    D1 -->|"1250 环境类重试"| C1
...
- **🔌 Web UI 增强**（2204）— 可用 1212 · 不兼容 390 · 待定 198 · 未测 16 · 监测 388 — [明细](PLUGINS-ALL.md#-web-ui-增强2204)
- **💻 编码开发**（1677）— 可用 832 · 不兼容 323 · 待定 154 · 未测 18 · 监测 350 — [明细](PLUGINS-ALL.md#-编码开发1677)
- **🤖 Agent 能力**（1628）— 可用 726 · 不兼容 302 · 待定 145 · 未测 10 · 监测 445 — [明细](PLUGINS-ALL.md#-agent-能力1628)
- **📡 消息通讯**（549）— 可用 223 · 不兼容 123 · 待定 44 · 未测 3 · 监测 156 — [明细](PLUGINS-ALL.md#-消息通讯549)
...
- **❓ 其他**（4315）— 可用 1545 · 不兼容 291 · 待定 223 · 未测 20 · 监测 2236 — [明细](PLUGINS-ALL.md#-其他4315)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260830T223001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

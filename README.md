...
[![confirmed](https://img.shields.io/badge/confirmed-8758-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12263-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8251-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1507-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2613-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260902T024501Z`（2026-09-02 10:45:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17519 · 龄 98m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8758"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12263"}
    D1 -->|"8251 / 2613"| E1["聚合 + README 分类统计"]
    D1 -->|"1399 环境类重试"| C1
...
- **🔌 Web UI 增强**（2280）— 可用 1259 · 不兼容 376 · 待定 221 · 未测 16 · 监测 408 — [明细](PLUGINS-ALL.md#-web-ui-增强2280)
- **💻 编码开发**（1747）— 可用 860 · 不兼容 329 · 待定 170 · 未测 19 · 监测 369 — [明细](PLUGINS-ALL.md#-编码开发1747)
- **🤖 Agent 能力**（1697）— 可用 764 · 不兼容 290 · 待定 162 · 未测 10 · 监测 471 — [明细](PLUGINS-ALL.md#-agent-能力1697)
- **📡 消息通讯**（564）— 可用 233 · 不兼容 119 · 待定 50 · 未测 3 · 监测 159 — [明细](PLUGINS-ALL.md#-消息通讯564)
- **🗂 文件数据**（514）— 可用 242 · 不兼容 82 · 待定 49 · 未测 9 · 监测 132 — [明细](PLUGINS-ALL.md#-文件数据514)
- **🎮 娱乐生活**（340）— 可用 160 · 不兼容 25 · 待定 28 · 未测 0 · 监测 127 — [明细](PLUGINS-ALL.md#-娱乐生活340)
- **🛠 基建部署**（1058）— 可用 416 · 不兼容 125 · 待定 133 · 未测 3 · 监测 381 — [明细](PLUGINS-ALL.md#-基建部署1058)
- **📚 学习研究**（113）— 可用 32 · 不兼容 9 · 待定 7 · 未测 2 · 监测 63 — [明细](PLUGINS-ALL.md#-学习研究113)
- **❓ 其他**（4692）— 可用 1698 · 不兼容 292 · 待定 233 · 未测 21 · 监测 2448 — [明细](PLUGINS-ALL.md#-其他4692)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260902T024501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

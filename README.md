...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2393-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1631-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-526-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-236-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260827T201501Z`（2026-08-28 04:15:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15443 · 龄 29m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🔌 Web UI 增强**（535）— 可用 308 · 不兼容 108 · 待定 56 · 未测 30 · 监测 33 — [明细](PLUGINS-ALL.md#-web-ui-增强535)
- **💻 编码开发**（441）— 可用 231 · 不兼容 82 · 待定 56 · 未测 32 · 监测 40 — [明细](PLUGINS-ALL.md#-编码开发441)
- **🤖 Agent 能力**（367）— 可用 178 · 不兼容 88 · 待定 51 · 未测 15 · 监测 35 — [明细](PLUGINS-ALL.md#-agent-能力367)
- **📡 消息通讯**（139）— 可用 68 · 不兼容 39 · 待定 18 · 未测 3 · 监测 11 — [明细](PLUGINS-ALL.md#-消息通讯139)
- **🗂 文件数据**（123）— 可用 55 · 不兼容 23 · 待定 22 · 未测 12 · 监测 11 — [明细](PLUGINS-ALL.md#-文件数据123)
- **🎮 娱乐生活**（64）— 可用 39 · 不兼容 11 · 待定 6 · 未测 1 · 监测 7 — [明细](PLUGINS-ALL.md#-娱乐生活64)
- **🛠 基建部署**（292）— 可用 140 · 不兼容 63 · 待定 48 · 未测 4 · 监测 37 — [明细](PLUGINS-ALL.md#-基建部署292)
- **📚 学习研究**（21）— 可用 11 · 不兼容 4 · 待定 0 · 未测 2 · 监测 4 — [明细](PLUGINS-ALL.md#-学习研究21)
- **❓ 其他**（794）— 可用 376 · 不兼容 155 · 待定 71 · 未测 30 · 监测 162 — [明细](PLUGINS-ALL.md#-其他794)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260827T201501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

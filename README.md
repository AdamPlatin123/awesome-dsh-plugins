...
[![confirmed](https://img.shields.io/badge/confirmed-3028-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-3066-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1997-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-685-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-384-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T010001Z`（2026-08-28 09:00:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15459 · 龄 232m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 3028"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 3066"}
    D1 -->|"1997 / 685"| E1["聚合 + README 分类统计"]
    D1 -->|"384 环境类重试"| C1
...
- **🛒 市场与管理**（106）— 可用 44 · 不兼容 16 · 待定 8 · 未测 10 · 监测 28 — [明细](PLUGINS-ALL.md#-市场与管理106)
- **🔌 Web UI 增强**（719）— 可用 401 · 不兼容 146 · 待定 80 · 未测 26 · 监测 66 — [明细](PLUGINS-ALL.md#-web-ui-增强719)
- **💻 编码开发**（579）— 可用 293 · 不兼容 108 · 待定 80 · 未测 27 · 监测 71 — [明细](PLUGINS-ALL.md#-编码开发579)
- **🤖 Agent 能力**（470）— 可用 216 · 不兼容 103 · 待定 72 · 未测 15 · 监测 64 — [明细](PLUGINS-ALL.md#-agent-能力470)
- **📡 消息通讯**（185）— 可用 81 · 不兼容 51 · 待定 27 · 未测 3 · 监测 23 — [明细](PLUGINS-ALL.md#-消息通讯185)
- **🗂 文件数据**（155）— 可用 65 · 不兼容 29 · 待定 28 · 未测 12 · 监测 21 — [明细](PLUGINS-ALL.md#-文件数据155)
- **🎮 娱乐生活**（92）— 可用 53 · 不兼容 8 · 待定 12 · 未测 1 · 监测 18 — [明细](PLUGINS-ALL.md#-娱乐生活92)
- **🛠 基建部署**（414）— 可用 175 · 不兼容 73 · 待定 69 · 未测 4 · 监测 93 — [明细](PLUGINS-ALL.md#-基建部署414)
- **📚 学习研究**（32）— 可用 11 · 不兼容 4 · 待定 2 · 未测 2 · 监测 13 — [明细](PLUGINS-ALL.md#-学习研究32)
- **❓ 其他**（1121）— 可用 430 · 不兼容 172 · 待定 114 · 未测 26 · 监测 379 — [明细](PLUGINS-ALL.md#-其他1121)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T010001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

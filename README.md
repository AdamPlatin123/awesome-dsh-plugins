...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-1814-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1064-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-623-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-127-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260819T010001Z`（2026-08-19 09:00:01 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 9322 · 龄 22m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🎓 技能包**（27）— 可用 7 · 不兼容 1 · 待定 1 · 未测 18 · 监测 0 — [明细](PLUGINS-ALL.md#-技能包27)
- **🧠 记忆增强**（19）— 可用 7 · 不兼容 4 · 待定 2 · 未测 6 · 监测 0 — [明细](PLUGINS-ALL.md#-记忆增强19)
- **🎨 主题皮肤**（13）— 可用 2 · 不兼容 1 · 待定 2 · 未测 8 · 监测 0 — [明细](PLUGINS-ALL.md#-主题皮肤13)
- **🛒 市场与管理**（56）— 可用 22 · 不兼容 13 · 待定 2 · 未测 11 · 监测 8 — [明细](PLUGINS-ALL.md#-市场与管理56)
- **🔌 Web UI 增强**（444）— 可用 243 · 不兼容 89 · 待定 45 · 未测 38 · 监测 29 — [明细](PLUGINS-ALL.md#-web-ui-增强444)
- **💻 编码开发**（387）— 可用 180 · 不兼容 73 · 待定 38 · 未测 55 · 监测 41 — [明细](PLUGINS-ALL.md#-编码开发387)
- **🤖 Agent 能力**（327）— 可用 139 · 不兼容 77 · 待定 31 · 未测 32 · 监测 48 — [明细](PLUGINS-ALL.md#-agent-能力327)
- **📡 消息通讯**（117）— 可用 61 · 不兼容 26 · 待定 13 · 未测 8 · 监测 9 — [明细](PLUGINS-ALL.md#-消息通讯117)
- **🗂 文件数据**（102）— 可用 48 · 不兼容 18 · 待定 15 · 未测 15 · 监测 6 — [明细](PLUGINS-ALL.md#-文件数据102)
- **🎮 娱乐生活**（56）— 可用 31 · 不兼容 10 · 待定 7 · 未测 2 · 监测 6 — [明细](PLUGINS-ALL.md#-娱乐生活56)
- **🛠 基建部署**（228）— 可用 90 · 不兼容 77 · 待定 24 · 未测 8 · 监测 29 — [明细](PLUGINS-ALL.md#-基建部署228)
- **📚 学习研究**（18）— 可用 6 · 不兼容 4 · 待定 1 · 未测 3 · 监测 4 — [明细](PLUGINS-ALL.md#-学习研究18)
- **❓ 其他**（657）— 可用 277 · 不兼容 124 · 待定 43 · 未测 64 · 监测 149 — [明细](PLUGINS-ALL.md#-其他657)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260819T010001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

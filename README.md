...
[![confirmed](https://img.shields.io/badge/confirmed-817-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13181-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_9002-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1782-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2506-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260905T003001Z`（2026-09-05 08:30:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17801 · 龄 199m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 817"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13181"}
    D1 -->|"9002 / 2506"| E1["聚合 + README 分类统计"]
    D1 -->|"1673 环境类重试"| C1
    E1 --> E2["cadence 交付<br/>本周期增量 —/100<br/>双仓 bot PR（幂等 supersede）"]
    M["radar-probe 每 15 分钟 自愈<br/>7 指标流 × 60s · 完成累计 44"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🎓 技能包**（33）— 可用 12 · 不兼容 2 · 待定 5 · 未测 11 · 监测 3 — [明细](PLUGINS-ALL.md#-技能包33)
- **🧠 记忆增强**（48）— 可用 14 · 不兼容 5 · 待定 6 · 未测 2 · 监测 21 — [明细](PLUGINS-ALL.md#-记忆增强48)
- **🎨 主题皮肤**（23）— 可用 14 · 不兼容 0 · 待定 1 · 未测 5 · 监测 3 — [明细](PLUGINS-ALL.md#-主题皮肤23)
- **🛒 市场与管理**（307）— 可用 99 · 不兼容 21 · 待定 18 · 未测 8 · 监测 161 — [明细](PLUGINS-ALL.md#-市场与管理307)
- **🔌 Web UI 增强**（2726）— 可用 1327 · 不兼容 381 · 待定 250 · 未测 16 · 监测 752 — [明细](PLUGINS-ALL.md#-web-ui-增强2726)
- **💻 编码开发**（2132）— 可用 930 · 不兼容 339 · 待定 187 · 未测 19 · 监测 657 — [明细](PLUGINS-ALL.md#-编码开发2132)
- **🤖 Agent 能力**（2237）— 可用 830 · 不兼容 254 · 待定 166 · 未测 10 · 监测 977 — [明细](PLUGINS-ALL.md#-agent-能力2237)
- **📡 消息通讯**（704）— 可用 253 · 不兼容 114 · 待定 51 · 未测 3 · 监测 283 — [明细](PLUGINS-ALL.md#-消息通讯704)
- **🗂 文件数据**（669）— 可用 273 · 不兼容 89 · 待定 55 · 未测 9 · 监测 243 — [明细](PLUGINS-ALL.md#-文件数据669)
- **🎮 娱乐生活**（454）— 可用 176 · 不兼容 33 · 待定 32 · 未测 0 · 监测 213 — [明细](PLUGINS-ALL.md#-娱乐生活454)
- **🛠 基建部署**（1353）— 可用 446 · 不兼容 130 · 待定 127 · 未测 3 · 监测 647 — [明细](PLUGINS-ALL.md#-基建部署1353)
- **📚 学习研究**（155）— 可用 35 · 不兼容 9 · 待定 8 · 未测 2 · 监测 101 — [明细](PLUGINS-ALL.md#-学习研究155)
- **❓ 其他**（7130）— 可用 1846 · 不兼容 322 · 待定 261 · 未测 21 · 监测 4680 — [明细](PLUGINS-ALL.md#-其他7130)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260905T003001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-1258-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2295-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1179-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-874-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-242-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260827T074501Z`（2026-08-27 15:45:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15158 · 龄 26m"]
        A2["本地库补全 · 去重 repo id"]
...
- **💻 编码开发**（420）— 可用 191 · 不兼容 99 · 待定 54 · 未测 42 · 监测 34 — [明细](PLUGINS-ALL.md#-编码开发420)
- **🤖 Agent 能力**（353）— 可用 147 · 不兼容 108 · 待定 47 · 未测 22 · 监测 29 — [明细](PLUGINS-ALL.md#-agent-能力353)
- **📡 消息通讯**（130）— 可用 61 · 不兼容 44 · 待定 15 · 未测 4 · 监测 6 — [明细](PLUGINS-ALL.md#-消息通讯130)
- **🗂 文件数据**（110）— 可用 51 · 不兼容 23 · 待定 18 · 未测 12 · 监测 6 — [明细](PLUGINS-ALL.md#-文件数据110)
- **🎮 娱乐生活**（62）— 可用 33 · 不兼容 14 · 待定 7 · 未测 1 · 监测 7 — [明细](PLUGINS-ALL.md#-娱乐生活62)
...
- **❓ 其他**（740）— 可用 325 · 不兼容 192 · 待定 61 · 未测 51 · 监测 111 — [明细](PLUGINS-ALL.md#-其他740)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260827T074501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-8144-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-11401-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_7609-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1328-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2570-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260830T003001Z`（2026-08-30 08:30:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 16357 · 龄 201m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8144"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 11401"}
    D1 -->|"7609 / 2570"| E1["聚合 + README 分类统计"]
    D1 -->|"1222 环境类重试"| C1
...
- **🛒 市场与管理**（230）— 可用 92 · 不兼容 20 · 待定 14 · 未测 7 · 监测 97 — [明细](PLUGINS-ALL.md#-市场与管理230)
- **🔌 Web UI 增强**（2140）— 可用 1177 · 不兼容 381 · 待定 192 · 未测 16 · 监测 374 — [明细](PLUGINS-ALL.md#-web-ui-增强2140)
- **💻 编码开发**（1625）— 可用 810 · 不兼容 313 · 待定 151 · 未测 18 · 监测 333 — [明细](PLUGINS-ALL.md#-编码开发1625)
- **🤖 Agent 能力**（1582）— 可用 712 · 不兼容 290 · 待定 140 · 未测 10 · 监测 430 — [明细](PLUGINS-ALL.md#-agent-能力1582)
- **📡 消息通讯**（543）— 可用 221 · 不兼容 122 · 待定 43 · 未测 3 · 监测 154 — [明细](PLUGINS-ALL.md#-消息通讯543)
- **🗂 文件数据**（482）— 可用 227 · 不兼容 81 · 待定 45 · 未测 9 · 监测 120 — [明细](PLUGINS-ALL.md#-文件数据482)
- **🎮 娱乐生活**（314）— 可用 147 · 不兼容 28 · 待定 28 · 未测 0 · 监测 111 — [明细](PLUGINS-ALL.md#-娱乐生活314)
- **🛠 基建部署**（1011）— 可用 399 · 不兼容 119 · 待定 128 · 未测 3 · 监测 362 — [明细](PLUGINS-ALL.md#-基建部署1011)
- **📚 学习研究**（106）— 可用 29 · 不兼容 9 · 待定 8 · 未测 2 · 监测 58 — [明细](PLUGINS-ALL.md#-学习研究106)
- **❓ 其他**（4121）— 可用 1478 · 不兼容 288 · 待定 221 · 未测 20 · 监测 2114 — [明细](PLUGINS-ALL.md#-其他4121)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260830T003001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

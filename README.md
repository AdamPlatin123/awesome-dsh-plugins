...
[![confirmed](https://img.shields.io/badge/confirmed-4574-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-5089-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-3368-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1109-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-612-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T070001Z`（2026-08-28 15:00:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15576 · 龄 94m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 4574"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 5089"}
    D1 -->|"3368 / 1109"| E1["聚合 + README 分类统计"]
    D1 -->|"612 环境类重试"| C1
...
- **🛒 市场与管理**（149）— 可用 57 · 不兼容 20 · 待定 11 · 未测 9 · 监测 52 — [明细](PLUGINS-ALL.md#-市场与管理149)
- **🔌 Web UI 增强**（1128）— 可用 611 · 不兼容 219 · 待定 113 · 未测 25 · 监测 160 — [明细](PLUGINS-ALL.md#-web-ui-增强1128)
- **💻 编码开发**（864）— 可用 434 · 不兼容 167 · 待定 102 · 未测 22 · 监测 139 — [明细](PLUGINS-ALL.md#-编码开发864)
- **🤖 Agent 能力**（715）— 可用 325 · 不兼容 132 · 待定 94 · 未测 12 · 监测 152 — [明细](PLUGINS-ALL.md#-agent-能力715)
- **📡 消息通讯**（278）— 可用 116 · 不兼容 71 · 待定 31 · 未测 3 · 监测 57 — [明细](PLUGINS-ALL.md#-消息通讯278)
...
- **🛠 基建部署**（574）— 可用 233 · 不兼容 85 · 待定 85 · 未测 4 · 监测 167 — [明细](PLUGINS-ALL.md#-基建部署574)
- **📚 学习研究**（54）— 可用 17 · 不兼容 5 · 待定 3 · 未测 2 · 监测 27 — [明细](PLUGINS-ALL.md#-学习研究54)
- **❓ 其他**（1726）— 可用 559 · 不兼容 206 · 待定 132 · 未测 23 · 监测 806 — [明细](PLUGINS-ALL.md#-其他1726)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T070001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

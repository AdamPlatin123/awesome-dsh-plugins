...
[![confirmed](https://img.shields.io/badge/confirmed-4279-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-4663-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-3079-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-1024-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-560-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T054501Z`（2026-08-28 13:45:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15576 · 龄 18m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 4279"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 4663"}
    D1 -->|"3079 / 1024"| E1["聚合 + README 分类统计"]
    D1 -->|"560 环境类重试"| C1
...
- **🛒 市场与管理**（140）— 可用 54 · 不兼容 19 · 待定 10 · 未测 9 · 监测 48 — [明细](PLUGINS-ALL.md#-市场与管理140)
- **🔌 Web UI 增强**（1049）— 可用 565 · 不兼容 206 · 待定 105 · 未测 25 · 监测 148 — [明细](PLUGINS-ALL.md#-web-ui-增强1049)
- **💻 编码开发**（806）— 可用 405 · 不兼容 152 · 待定 100 · 未测 22 · 监测 127 — [明细](PLUGINS-ALL.md#-编码开发806)
- **🤖 Agent 能力**（651）— 可用 299 · 不兼容 122 · 待定 85 · 未测 14 · 监测 131 — [明细](PLUGINS-ALL.md#-agent-能力651)
- **📡 消息通讯**（257）— 可用 110 · 不兼容 66 · 待定 31 · 未测 3 · 监测 47 — [明细](PLUGINS-ALL.md#-消息通讯257)
- **🗂 文件数据**（228）— 可用 98 · 不兼容 45 · 待定 31 · 未测 11 · 监测 43 — [明细](PLUGINS-ALL.md#-文件数据228)
- **🎮 娱乐生活**（135）— 可用 70 · 不兼容 11 · 待定 17 · 未测 1 · 监测 36 — [明细](PLUGINS-ALL.md#-娱乐生活135)
- **🛠 基建部署**（544）— 可用 223 · 不兼容 83 · 待定 80 · 未测 4 · 监测 154 — [明细](PLUGINS-ALL.md#-基建部署544)
- **📚 学习研究**（48）— 可用 13 · 不兼容 5 · 待定 3 · 未测 2 · 监测 25 — [明细](PLUGINS-ALL.md#-学习研究48)
- **❓ 其他**（1599）— 可用 526 · 不兼容 200 · 待定 127 · 未测 25 · 监测 721 — [明细](PLUGINS-ALL.md#-其他1599)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T054501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

...
[![confirmed](https://img.shields.io/badge/confirmed-481-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12615-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8548-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1534-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2643-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260903T174501Z`（2026-09-04 01:45:05 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 17870 · 龄 16m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 481"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12615"}
    D1 -->|"8548 / 2643"| E1["聚合 + README 分类统计"]
    D1 -->|"1424 环境类重试"| C1
...
- **🛒 市场与管理**（297）— 可用 97 · 不兼容 20 · 待定 14 · 未测 8 · 监测 158 — [明细](PLUGINS-ALL.md#-市场与管理297)
- **🔌 Web UI 增强**（2654）— 可用 1296 · 不兼容 390 · 待定 227 · 未测 16 · 监测 725 — [明细](PLUGINS-ALL.md#-web-ui-增强2654)
- **💻 编码开发**（2062）— 可用 901 · 不兼容 344 · 待定 162 · 未测 19 · 监测 636 — [明细](PLUGINS-ALL.md#-编码开发2062)
- **🤖 Agent 能力**（2145）— 可用 777 · 不兼容 262 · 待定 155 · 未测 10 · 监测 941 — [明细](PLUGINS-ALL.md#-agent-能力2145)
- **📡 消息通讯**（690）— 可用 234 · 不兼容 125 · 待定 52 · 未测 3 · 监测 276 — [明细](PLUGINS-ALL.md#-消息通讯690)
- **🗂 文件数据**（649）— 可用 266 · 不兼容 90 · 待定 47 · 未测 9 · 监测 237 — [明细](PLUGINS-ALL.md#-文件数据649)
- **🎮 娱乐生活**（439）— 可用 173 · 不兼容 29 · 待定 29 · 未测 0 · 监测 208 — [明细](PLUGINS-ALL.md#-娱乐生活439)
- **🛠 基建部署**（1320）— 可用 436 · 不兼容 129 · 待定 117 · 未测 3 · 监测 635 — [明细](PLUGINS-ALL.md#-基建部署1320)
- **📚 学习研究**（148）— 可用 33 · 不兼容 9 · 待定 7 · 未测 2 · 监测 97 — [明细](PLUGINS-ALL.md#-学习研究148)
- **❓ 其他**（6861）— 可用 1760 · 不兼容 310 · 待定 240 · 未测 21 · 监测 4530 — [明细](PLUGINS-ALL.md#-其他6861)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260903T174501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

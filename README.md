...
[![confirmed](https://img.shields.io/badge/confirmed-3024-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-2900-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-1886-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-654-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-360-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T003002Z`（2026-08-28 08:30:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15459 · 龄 202m"]
        A2["本地库补全 · 去重 repo id"]
...
- **🛒 市场与管理**（101）— 可用 44 · 不兼容 14 · 待定 7 · 未测 10 · 监测 26 — [明细](PLUGINS-ALL.md#-市场与管理101)
- **🔌 Web UI 增强**（696）— 可用 387 · 不兼容 143 · 待定 77 · 未测 27 · 监测 62 — [明细](PLUGINS-ALL.md#-web-ui-增强696)
- **💻 编码开发**（547）— 可用 280 · 不兼容 101 · 待定 78 · 未测 27 · 监测 61 — [明细](PLUGINS-ALL.md#-编码开发547)
- **🤖 Agent 能力**（447）— 可用 203 · 不兼容 100 · 待定 69 · 未测 15 · 监测 60 — [明细](PLUGINS-ALL.md#-agent-能力447)
- **📡 消息通讯**（181）— 可用 80 · 不兼容 51 · 待定 27 · 未测 3 · 监测 20 — [明细](PLUGINS-ALL.md#-消息通讯181)
- **🗂 文件数据**（149）— 可用 63 · 不兼容 26 · 待定 27 · 未测 12 · 监测 21 — [明细](PLUGINS-ALL.md#-文件数据149)
- **🎮 娱乐生活**（88）— 可用 51 · 不兼容 8 · 待定 10 · 未测 1 · 监测 18 — [明细](PLUGINS-ALL.md#-娱乐生活88)
- **🛠 基建部署**（391）— 可用 164 · 不兼容 73 · 待定 66 · 未测 4 · 监测 84 — [明细](PLUGINS-ALL.md#-基建部署391)
- **📚 学习研究**（27）— 可用 10 · 不兼容 4 · 待定 1 · 未测 2 · 监测 10 — [明细](PLUGINS-ALL.md#-学习研究27)
- **❓ 其他**（1081）— 可用 424 · 不兼容 167 · 待定 114 · 未测 26 · 监测 350 — [明细](PLUGINS-ALL.md#-其他1081)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T003002Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

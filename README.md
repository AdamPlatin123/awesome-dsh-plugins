...
[![confirmed](https://img.shields.io/badge/confirmed-4005-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-4303-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/awesome-dsh-plugins?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/awesome-dsh-plugins?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用-2835-brightgreen)](#2-看懂状态统一四档口径) [![运行级不兼容](https://img.shields.io/badge/运行级不兼容-945-red)](#2-看懂状态统一四档口径) [![待定](https://img.shields.io/badge/待定-523-yellow)](#2-看懂状态统一四档口径) [![未测](https://img.shields.io/badge/·_未测-0-lightgrey)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260828T044501Z`（2026-08-28 12:45:02 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 15484 · 龄 222m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 4005"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 4303"}
    D1 -->|"2835 / 945"| E1["聚合 + README 分类统计"]
    D1 -->|"523 环境类重试"| C1
...
- **🛒 市场与管理**（130）— 可用 51 · 不兼容 18 · 待定 9 · 未测 9 · 监测 43 — [明细](PLUGINS-ALL.md#-市场与管理130)
- **🔌 Web UI 增强**（971）— 可用 520 · 不兼容 190 · 待定 100 · 未测 26 · 监测 135 — [明细](PLUGINS-ALL.md#-web-ui-增强971)
- **💻 编码开发**（762）— 可用 384 · 不兼容 142 · 待定 92 · 未测 24 · 监测 120 — [明细](PLUGINS-ALL.md#-编码开发762)
- **🤖 Agent 能力**（601）— 可用 276 · 不兼容 116 · 待定 81 · 未测 14 · 监测 114 — [明细](PLUGINS-ALL.md#-agent-能力601)
- **📡 消息通讯**（237）— 可用 104 · 不兼容 61 · 待定 31 · 未测 3 · 监测 38 — [明细](PLUGINS-ALL.md#-消息通讯237)
- **🗂 文件数据**（206）— 可用 90 · 不兼容 40 · 待定 29 · 未测 11 · 监测 36 — [明细](PLUGINS-ALL.md#-文件数据206)
- **🎮 娱乐生活**（124）— 可用 66 · 不兼容 10 · 待定 15 · 未测 1 · 监测 32 — [明细](PLUGINS-ALL.md#-娱乐生活124)
- **🛠 基建部署**（520）— 可用 214 · 不兼容 79 · 待定 78 · 未测 4 · 监测 145 — [明细](PLUGINS-ALL.md#-基建部署520)
- **📚 学习研究**（42）— 可用 12 · 不兼容 5 · 待定 2 · 未测 2 · 监测 21 — [明细](PLUGINS-ALL.md#-学习研究42)
- **❓ 其他**（1507）— 可用 506 · 不兼容 196 · 待定 125 · 未测 25 · 监测 655 — [明细](PLUGINS-ALL.md#-其他1507)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260828T044501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

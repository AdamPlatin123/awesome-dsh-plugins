...
[![confirmed](https://img.shields.io/badge/confirmed-8555-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-12076-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8098-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1365-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2721-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260831T180001Z`（2026-09-01 02:00:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 16959 · 龄 529m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 8555"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 1064）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 12076"}
    D1 -->|"8098 / 2721"| E1["聚合 + README 分类统计"]
    D1 -->|"1257 环境类重试"| C1
    E1 --> E2["cadence 交付<br/>本周期增量 —/100<br/>双仓 bot PR（幂等 supersede）"]
    M["radar-probe 每 15 分钟 自愈<br/>7 指标流 × 60s · 完成累计 32"]
    M -.-> A1
    M -.-> C1
```
<!-- AUTO:pipeline:END -->
...
- **🛒 市场与管理**（241）— 可用 93 · 不兼容 19 · 待定 15 · 未测 7 · 监测 107 — [明细](PLUGINS-ALL.md#-市场与管理241)
- **🔌 Web UI 增强**（2244）— 可用 1236 · 不兼容 399 · 待定 199 · 未测 16 · 监测 394 — [明细](PLUGINS-ALL.md#-web-ui-增强2244)
- **💻 编码开发**（1711）— 可用 850 · 不兼容 329 · 待定 154 · 未测 19 · 监测 359 — [明细](PLUGINS-ALL.md#-编码开发1711)
- **🤖 Agent 能力**（1668）— 可用 746 · 不兼容 308 · 待定 144 · 未测 10 · 监测 460 — [明细](PLUGINS-ALL.md#-agent-能力1668)
- **📡 消息通讯**（561）— 可用 229 · 不兼容 127 · 待定 46 · 未测 3 · 监测 156 — [明细](PLUGINS-ALL.md#-消息通讯561)
...
- **📚 学习研究**（112）— 可用 31 · 不兼容 9 · 待定 8 · 未测 2 · 监测 62 — [明细](PLUGINS-ALL.md#-学习研究112)
- **❓ 其他**（4519）— 可用 1657 · 不兼容 297 · 待定 225 · 未测 21 · 监测 2319 — [明细](PLUGINS-ALL.md#-其他4519)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260831T180001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

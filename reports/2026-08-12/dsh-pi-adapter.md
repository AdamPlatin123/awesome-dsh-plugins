# dsh-pi-adapter — 与 mainline 兼容性对比（2026-08-12）> [打开仓库](https://github.com/dsh-external/dsh-pi-adapter) · 调研摘要（只读资产，本报告不复制其正文）：[research/dsh-pi-adapter.md](../../research/dsh-pi-adapter.md)\n\n
## 克隆证据

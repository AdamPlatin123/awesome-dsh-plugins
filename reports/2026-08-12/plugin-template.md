# plugin-template — 与 mainline 兼容性对比（2026-08-12）> [打开仓库](https://github.com/dsh-external/plugin-template) · 深度摘要待调研（当前为引擎自动判定）\n\n
## 克隆证据
...
| 维度 | 结果 |
|---|---|
| 锚定 vs 当日 mainline | 未知（非 commit 锚定: README） |

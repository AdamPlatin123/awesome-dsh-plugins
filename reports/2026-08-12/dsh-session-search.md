# dsh-session-search — 与 mainline 兼容性对比（2026-08-12）> [打开仓库](https://github.com/dsh-external/dsh-session-search) · 调研摘要（只读资产，本报告不复制其正文）：[research/dsh-session-search.md](../../research/dsh-session-search.md)\n\n
## 克隆证据

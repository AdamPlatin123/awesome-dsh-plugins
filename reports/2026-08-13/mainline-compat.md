...
- 兼容性：91/275 无需适配，6 需适配（dsh-subagent-tree dsh-working-activity turtle-ui dsh-tps dsh-split-panes dsh-ohos-patch）；其中关注 25、占位 15、不适用 2、已删除 0、未知 178

## 兼容性矩阵

| 仓库 | 锚定 | 补丁 | seam | peerDeps | 综合判定 |
|---|---|---|---|---|---|
| chat-width | 未知 | 无补丁 | 缺: tuiPrompt | 3 项中 3 不匹配: @deepseek-ai/dsh-client-locale=>=0.0.1-0↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=>=0.0.1-0↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=>=0.0.1-0↔0.0.1-rc.1 | 关注 |
...
| dsh-tool-calculator | 未知（不同谱系） | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 兼容 |
| dsh-tool-encoding | 未知 | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 兼容 |
| dsh-tool-json | 未知（不同谱系） | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 兼容 |
...
| dsh-web-ui | 未知 | 无补丁 | 缺: tuiPrompt | 65 项匹配 | 兼容 |
...
| session-persistence-rdb | 未知 | 无补丁 | 缺: tuiPrompt | 6 项中 6 不匹配: @deepseek-ai/dsh-invariants=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-scope=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session-persistence=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-settings=^0.0.1-rc.2↔0.0.1-rc.1 | 关注 |
...
| turtle-ui | 未知（不同谱系） | CONFLICT（1 个补丁中 0 个 OK） | 缺: tuiPrompt | 22 项中 22 不匹配: @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-agent-loop=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-cmdline=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-commands=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-compact=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-goal=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm-retry=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-persistence=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-projection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-projection-cache=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-query=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-reference=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-title=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-skill=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-subprocess=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-system-prompt=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-token-meter=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-user-interaction=^0.0.1↔0.0.1-rc.1 | 需适配 |
...
| dsh-grok-tui | 未知 | 无补丁 | 缺: tuiPrompt | 5 项中 5 不匹配: @deepseek-ai/dsh-agent=>=0.0.1-0↔0.0.1-rc.1 @deepseek-ai/dsh-llm=>=0.0.1-0↔0.0.1-rc.1 @deepseek-ai/dsh-session=>=0.0.1-0↔0.0.1-rc.1 @deepseek-ai/dsh-tools=>=0.0.1-0↔0.0.1-rc.1 @deepseek-ai/dsh-user-interaction=>=0.0.1-0↔0.0.1-rc.1 | 未知（待调研） |
| ds_web_craw | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| fabric | 未知 | OK（1 个补丁全部干净应用） | 缺: tuiPrompt | 1 项匹配 | 兼容 |
...
| dsh-a2a | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 20 项中 19 不匹配: @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-locale=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-primitives=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-host-apiproxy=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-brand=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-commands=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-credentials=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-settings=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tasks=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
...
| dsh-tool-csv | 未知 | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 未知（待调研） |
| dsh-tool-regex | 未知 | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 未知（待调研） |
...
| dsh-advisor | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 18 项匹配 | 未知（待调研） |
| dsh-llm-fallbacks | 未知 | 无补丁 | 缺: tuiPrompt | 14 项中 14 不匹配: @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-api-gateway=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-api-remotes=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-locale=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-plugin-config=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-settings=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-commands=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-settings=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-type-meta=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
...
| oh-my-dsh | 未知 | 无补丁 | 缺: tuiPrompt | 1465 项匹配 | 未知（待调研） |
...
| dsh-toolkit | 未知 | 无补丁 | 缺: tuiPrompt | 22 项匹配 | 未知（待调研） |
| dsh-tool-markdown | 未知 | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 未知（待调研） |
| dsh-session-health | 未知 | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 未知（待调研） |
...
| dsh-plugin-check | 未知 | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 未知（待调研） |
...
| dsh-tool-diff | 未知 | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 未知（待调研） |
| dsh-mobileweb-adapter | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| dsh-desktop-electron | 未知（不同谱系） | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 兼容 |
...
| dsh-agent-budget | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 10 项中 10 不匹配: @deepseek-ai/dsh-agent=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-brand=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-commands=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-goal=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-token-meter=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-tools=0.0.1-rc.2↔0.0.1-rc.1 | 未知（待调研） |
...
| dsh-engram-relay | 未知 | 无补丁 | 缺: tuiPrompt | 5 项中 5 不匹配: @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-system-prompt=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
...
| dsh-voice-chat | 未知 | 无补丁 | 缺: tuiPrompt | 2 项中 2 不匹配: @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
| dsh-ads | 未知 | 无补丁 | 缺: tuiPrompt | 1 项匹配 | 未知（待调研） |
...
| dsh-browser-bridge | 未知 | 无补丁 | 缺: tuiPrompt | 6 项中 4 不匹配: @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-attachment=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
...
| oh-dsh-desktop | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| dsh-plugin-skills | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| dsh-deep-whale | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| dsh-tool-search | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 5 项中 5 不匹配: @deepseek-ai/dsh-agent=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-tools=0.0.1-rc.2↔0.0.1-rc.1 | 未知（待调研） |
...
| dsh-trace | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 4 项中 4 不匹配: @deepseek-ai/dsh-invariants=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session-telemetry=0.0.1-rc.2↔0.0.1-rc.1 | 未知（待调研） |
...
| dsh-agent-rp | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
...
| ui-status-label | 未知 | 无补丁 | 缺: tuiPrompt | 8 项中 8 不匹配: @deepseek-ai/dsh-client-connection=>=0.0.0↔0.0.1-rc.1 @deepseek-ai/dsh-client-locale=>=0.0.0↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=>=0.0.0↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=>=0.0.0↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-settings=>=0.0.0↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=>=0.0.0↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=>=0.0.0↔0.0.1-rc.1 @deepseek-ai/dsh-settings=>=0.0.0↔0.0.1-rc.1 | 未知（待调研） |
| dsh-easy-ctx-manager | 未知 | 无补丁 | 缺: tuiPrompt | 10 项匹配 | 未知（待调研） |
| browser4-dsh | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| show-bash-command | 未知 | 无补丁 | 缺: tuiPrompt | 6 项匹配 | 未知（待调研） |
| dsh-chat-thumb | 未知（非 commit 锚定: README） | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 兼容 |
| dsh-super-injector | 未知 | 无补丁 | 缺: tuiPrompt | 1 项中 1 不匹配: @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
| dsh-hmz | 未知 | 不适用（空仓库） | 不适用（空仓库） | 不适用 | 占位 |
| dsh-better-sidebar-plugin-office | 未知 | 无补丁 | 缺: tuiPrompt | 2 项中 1 不匹配: @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
| dsh-explain | 未知 | 无补丁 | 缺: tuiPrompt | 15 项匹配 | 未知（待调研） |
| dsh-interpreters | 未知 | 无补丁 | 缺: tuiPrompt | 10 项中 9 不匹配: @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-locale=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-plugin-config=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-primitives=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-web-react=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-settings=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
| dsh-stock-market | 未知 | 无补丁 | 缺: tuiPrompt | 7 项中 7 不匹配: @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-primitives=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-settings=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
| dsh-scout | 未知 | 无补丁 | 缺: tuiPrompt | 4 项匹配 | 未知（待调研） |
| dsh-diff-viewer | 未知 | OK（1 个补丁全部干净应用） | 缺: tuiPrompt | 2 项匹配 | 兼容 |
| dsh-turn-navigator | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 5 项中 5 不匹配: @deepseek-ai/dsh-client-locale=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=0.0.1-rc.2↔0.0.1-rc.1 | 未知（待调研） |
| dsh-mobile | 未知 | 无补丁 | 缺: tuiPrompt | 2 项匹配 | 未知（待调研） |
| dsh-share | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| dsh-travel-plugin | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| dsh-suggested-replies | 未知（catalog ref，非 mainline 锚定） | 无补丁 | 缺: tuiPrompt | 13 项中 13 不匹配: @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-locale=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-settings=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-host-apiproxy=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-projection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-settings=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
| dsh-aigc-canvas | 未知 | 无补丁 | 缺: tuiPrompt | 11 项中 10 不匹配: @deepseek-ai/dsh-client-locale=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-primitives=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-settings=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-host-webserver=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-invariants=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 | 未知（待调研） |
| dsh-sonar | 未知 | 无补丁 | 缺: tuiPrompt | 4 项匹配 | 未知（待调研） |
| dsh-ultra-ui | 未知 | 无补丁 | 缺: tuiPrompt | 4 项匹配 | 未知（待调研） |
| dsh-deepresearch | 未知 | 无补丁 | 缺: tuiPrompt | 9 项匹配 | 未知（待调研） |
| dsh-notebooks | 未知 | 无补丁 | 缺: tuiPrompt | 8 项匹配 | 未知（待调研） |
| context-doctor | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| dsh-openpencil | 未知 | 无补丁 | 缺: tuiPrompt | 7 项匹配 | 未知（待调研） |
| dsh-deeplink | 未知 | 无补丁 | 缺: tuiPrompt | 无 dsh-* 依赖 | 未知（待调研） |
| dsh-cot-summary | 未知 | OK（1 个补丁全部干净应用） | 缺: tuiPrompt | 17 项中 15 不匹配: @deepseek-ai/dsh-llm=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session-projection=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm-retry=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session-projection=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-primitives=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-primitives=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1-rc.2↔0.0.1-rc.1 | 关注 |
| dsh-emoji | 未知 | 无补丁 | 缺: tuiPrompt | 11 项匹配 | 未知（待调研） |

## mainline 变更分析（340d23a3aa833f4d5a66489297a6c6820ff049fc → 340d23a）
...
### chat-width
- 关注：seam 或 peerDeps 存在不匹配（seam: 缺: tuiPrompt；peer: 3 项中 3 不匹配: @deepseek-ai/dsh-client-locale=>=0.0.1-0↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=>=0.0.1-0↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=>=0.0.1-0↔0.0.1-rc.1），建议确认所依赖的宿主面当日是否仍满足。
...
- 兼容：锚定 未知（未知）、补丁「无补丁」，当日 mainline 可干净集成。
### dsh-my-rsi
- 关注：seam 或 peerDeps 存在不匹配（seam: 缺: tuiPrompt；peer: 95 项中 48 不匹配: @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-fs=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-workflow=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-credentials=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-fs=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-persistence=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-reference=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-timeout=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-command-feedback=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-persistence=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-reference=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-fs=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-skill=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-reference=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-sandbox-policy=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-user-approval=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-storage-domain=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-bash=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-host-apiproxy=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-host-apiproxy=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-agent=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-system-prompt=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.1），建议确认所依赖的宿主面当日是否仍满足。
### dsh-opencode-server
- 兼容：锚定 未知（未知）、补丁「无补丁」，当日 mainline 可干净集成。
### dsh-pi-adapter
- 兼容：锚定 未知（未知）、补丁「无补丁」，当日 mainline 可干净集成。
...
- 关注：seam 或 peerDeps 存在不匹配（seam: 缺: tuiPrompt；peer: 6 项中 6 不匹配: @deepseek-ai/dsh-invariants=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-scope=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session-persistence=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-settings=^0.0.1-rc.2↔0.0.1-rc.1），建议确认所依赖的宿主面当日是否仍满足。
### telegram
...
- 兼容：锚定 未知（未知（catalog ref，非 mainline 锚定））、补丁「无补丁」，当日 mainline 可干净集成。
### turtle-ui
- 需适配：锚定 a6fedc9e3b36d066e34860d040db6df47d88c432（未知（不同谱系））、补丁状态「CONFLICT（1 个补丁中 0 个 OK）」；建议以当日 snapshot HEAD（340d23a）为新基线重新锚定/rebuild 补丁。
- 补丁冲突/缺文件点集中在 mainline 变更分析节列出的破坏面，优先把集成改到稳定 seam（slots/sessionProjections/ThemeService）上。
### web-components
...
### dsh-cot-summary
- 关注：seam 或 peerDeps 存在不匹配（seam: 缺: tuiPrompt；peer: 17 项中 15 不匹配: @deepseek-ai/dsh-llm=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session-projection=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-llm-retry=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-session-projection=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-primitives=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-runtime=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-primitives=^0.0.1-rc.2↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1-rc.2↔0.0.1-rc.1），建议确认所依赖的宿主面当日是否仍满足。
### dsh-emoji

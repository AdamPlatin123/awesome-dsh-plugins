# deepseek-harness-desktop — 与 mainline 兼容性对比（2026-08-13）> [打开仓库](https://github.com/dsh-external/deepseek-harness-desktop) · 调研摘要（只读资产，本报告不复制其正文）：[research/deepseek-harness-desktop.md](../../research/deepseek-harness-desktop.md)\n\n
## 克隆证据

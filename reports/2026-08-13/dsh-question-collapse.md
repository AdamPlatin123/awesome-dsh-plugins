# dsh-question-collapse — 与 mainline 兼容性对比（2026-08-13）> [打开仓库](https://github.com/dsh-external/dsh-question-collapse) · 深度摘要待调研（当前为引擎自动判定）\n\n
## 克隆证据

- 克隆 HEAD：824114b
- 锚定：348409b1（commit，未知（不同谱系））

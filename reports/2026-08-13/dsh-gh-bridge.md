# dsh-gh-bridge — 与 mainline 兼容性对比（2026-08-13）> [打开仓库](https://github.com/dsh-external/dsh-gh-bridge) · 调研摘要（只读资产，本报告不复制其正文）：[research/dsh-gh-bridge.md](../../research/dsh-gh-bridge.md)\n\n
## 克隆证据

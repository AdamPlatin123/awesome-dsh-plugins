# dsh-longbridge — 与 mainline 兼容性对比（2026-08-13）> [打开仓库](https://github.com/dsh-external/dsh-longbridge) · 深度摘要待调研（当前为引擎自动判定）\n\n
## 克隆证据
...
| peerDeps 范围 vs mainline 实际 | 11 项中 11 不匹配: @deepseek-ai/dsh-credentials=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-host-apiproxy=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-settings=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-tools=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-client-connection=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-client-ui-primitives=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-client-ui-settings=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.2 @deepseek-ai/dsh-user-approval=^0.0.1↔0.0.1-rc.2 |
| **综合判定** | **未知（待调研）** |

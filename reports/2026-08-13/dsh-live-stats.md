# dsh-live-stats — 与 mainline 兼容性对比（2026-08-13）> [打开仓库](https://github.com/dsh-external/dsh-live-stats) · 调研摘要（只读资产，本报告不复制其正文）：[research/dsh-live-stats.md](../../research/dsh-live-stats.md)\n\n
## 克隆证据
...
| peerDeps 范围 vs mainline 实际 | 7 项中 7 不匹配: @deepseek-ai/dsh-client-runtime=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-conversation=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-client-ui-slots=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-llm=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-session-projection=^0.0.1↔0.0.1-rc.1 @deepseek-ai/dsh-token-meter=^0.0.1↔0.0.1-rc.1 |
| **综合判定** | **关注** |

# dsh-win-port — 与 mainline 兼容性对比（2026-08-13）> [打开仓库](https://github.com/dsh-external/dsh-win-port) · 调研摘要（只读资产，本报告不复制其正文）：[research/dsh-win-port.md](../../research/dsh-win-port.md)\n\n
## 克隆证据

# session-persistence-rdb — 与 mainline 兼容性对比（2026-08-07）
...
- 已删除：当日 mainline（9d84ab4，snapshots/20260806T160212Z）对比结论见上表；详细建议汇总于 [mainline-compat.md](mainline-compat.md)。

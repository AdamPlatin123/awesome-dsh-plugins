# dsh-shell-windows — 与 mainline 兼容性对比（2026-08-11）> [打开仓库](https://github.com/dsh-external/dsh-shell-windows) · 调研摘要（只读资产，本报告不复制其正文）：[research/dsh-shell-windows.md](../../research/dsh-shell-windows.md)\n\n
## 克隆证据

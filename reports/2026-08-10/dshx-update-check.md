# dshx-update-check — 与 mainline 兼容性对比（2026-08-10）> [打开仓库](https://github.com/dsh-external/dshx-update-check) · 调研摘要（只读资产，本报告不复制其正文）：[research/dshx-update-check.md](../../research/dshx-update-check.md)\n\n
## 克隆证据

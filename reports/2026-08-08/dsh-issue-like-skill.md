# dsh-issue-like-skill — 与 mainline 兼容性对比（2026-08-08）
> 调研摘要（只读资产，本报告不复制其正文）：[research/dsh-issue-like-skill.md](../../research/dsh-issue-like-skill.md)——集成点与调研全文以 research 为准。
